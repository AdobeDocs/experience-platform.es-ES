...
| --- | --- |
| [!UICONTROL Ubicación geográfica] | Determina si se producen búsquedas de geolocalización basadas en la dirección IP del usuario. La configuración predeterminada **[!UICONTROL Ninguno]** deshabilita las búsquedas de geolocalización, mientras que la variable **[!UICONTROL Ciudad]** proporciona coordenadas GPS con dos decimales. La geolocalización ocurre antes de [!UICONTROL Confusión de IP] y no se ve afectado por  [!UICONTROL Confusión de IP] configuración. |
