...
| [!UICONTROL Personalization Destinations] | Habilita [Personalization personalizado](../destinations/catalog/personalization/custom-personalization.md) para este conjunto de datos. Cuando [Web SDK](../web-sdk/home.md) o [Edge Network API](https://developer.adobe.com/data-collection-apis/docs/api/) envían datos a través de una secuencia de datos con destinos de personalización habilitados, las suscripciones a audiencias y los atributos de perfil asignados (solo para solicitudes autenticadas de [Edge Network API](https://developer.adobe.com/data-collection-apis/docs/api/)) para el perfil en cuestión se devuelven en la respuesta. |
