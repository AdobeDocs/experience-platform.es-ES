...
La pestaña **[!UICONTROL Secuencias de datos]** muestra una lista de las secuencias de datos existentes, incluidos su nombre descriptivo, ID y fecha de la última modificación. Hasta [ver sus detalles y configurar servicios](#view-details), seleccione el nombre de una secuencia de datos.

Para mostrar más opciones para una secuencia de datos determinada, seleccione el icono &quot;más&quot; (**...**). Para actualizar el [configuración básica](#configure) para la secuencia de datos, seleccione **[!UICONTROL Editar]**. Para eliminar la secuencia de datos, seleccione **[!UICONTROL Eliminar]**.
...
Si configura una secuencia de datos para utilizarla en Experience Platform y también utiliza el SDK web, también debe seleccionar una [Esquema del modelo de datos de experiencia (XDM) basado en eventos](../xdm/classes/experienceevent.md) para representar los datos que planea introducir.
...
Si habilita cualquiera de los campos anteriores para la recopilación de datos, asegúrese de establecer correctamente la variable [`context`](/help/web-sdk/commands/configure/context.md) propiedad de matriz al configurar el SDK web.
...
>[!IMPORTANT]
>
>Los ajustes que se muestran en la tabla siguiente son mutuamente excluyentes. No puede seleccionar la información de agente de usuario a la vez *y* datos de búsqueda de dispositivos al mismo tiempo.
...
Ese servicio controla si los datos se envían a Adobe Audience Manager y cómo. Consulte [Envío de datos a Adobe Analytics](/help/web-sdk/use-cases/adobe-analytics.md).
...
| [!UICONTROL Toma de decisiones sobre ofertas] | Habilita el Offer decisioning para implementaciones de SDK web. Consulte la guía de [uso de Offer Decisioning con SDK web](../web-sdk/personalization/offer-decisioning/offer-decisioning-overview.md) para obtener más información sobre la implementación.<br><br>Para obtener más información sobre las capacidades de la toma de decisiones sobre ofertas, consulte la [Documentación de Adobe Journey Optimizer](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioning/get-started-decision/starting-offer-decisioning.html?lang=es). |
| [!UICONTROL Segmentación de Edge] | Habilita [segmentación de borde](../segmentation/ui/edge-segmentation.md) para este conjunto de datos. Si la variable [SDK web](../web-sdk/home.md) o [API de Edge Network Server](../server-api/overview.md) envía datos a través de un flujo de datos con la segmentación de Edge habilitada, las suscripciones de audiencia actualizadas para el perfil en cuestión se envían de vuelta en la respuesta.<br><br>Puede utilizar esta opción en combinación con **[!UICONTROL Destinos de personalización]** para casos de uso de personalización de la misma página y de la siguiente página mediante [destinos de Edge](../destinations/ui/activate-edge-personalization-destinations.md) o [!DNL Offer Decisioning]. |
