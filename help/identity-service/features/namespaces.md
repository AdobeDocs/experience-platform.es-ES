...
Ahora que comprende los conceptos clave de las áreas de nombres de identidad, puede empezar a aprender a trabajar con el gráfico de identidades mediante [visor de gráficos de identidad](../features/identity-graph-viewer.md).
