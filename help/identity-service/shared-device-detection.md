...
* [[!DNL Identity Service]](./home.md): obtenga una mejor vista de los clientes individuales y su comportamiento uniendo identidades entre dispositivos y sistemas.
   * [Visualizador de gráficos de identidad](./features/identity-graph-viewer.md): Visualice e interactúe con el visualizador de gráficos de identidad para comprender mejor cómo se vinculan las identidades de los clientes y de qué formas.
   * [Áreas de nombres de identidad](./features/namespaces.md): consulte los componentes de una identidad completa y cómo las áreas de nombres de identidad le permiten distinguir el contexto y el tipo de una identidad.
