...
![Diagrama de capas de gráficos](../images/namespace-priority/graph-layers.png)
...
La prioridad del área de nombres se puede configurar mediante [!UICONTROL Configuración de identidad]. En el [!UICONTROL Configuración de identidad] , puede arrastrar y soltar un área de nombres para determinar su importancia relativa.
...
Actualmente, la prioridad del área de nombres influye en el comportamiento del sistema de Perfil del cliente en tiempo real. El diagrama siguiente ilustra este concepto. Para obtener más información, lea la guía de [Diagramas de arquitectura de aplicaciones y Adobe Experience Platform](https://experienceleague.adobe.com/en/docs/blueprints-learn/architecture/architecture-overview/platform-applications).

![Diagrama del ámbito de aplicación de prioridad de espacio de nombres](../images/namespace-priority/application-scope.png)

### Servicio de identidad: algoritmo de optimización de identidad

Para estructuras de gráficos relativamente complejas, la prioridad del área de nombres desempeña un papel importante a la hora de garantizar que se eliminen los vínculos correctos cuando se producen escenarios de colapso de gráficos. Para obtener más información, lea la [[!DNL Identity Optimization Algorithm] descripción general](../identity-graph-linking-rules/identity-optimization-algorithm.md).
...
* Como resultado, las siguientes configuraciones **ya no se utilizará en el perfil del cliente en tiempo real**:
...
* Por otro lado, **la prioridad del área de nombres no determina la identidad principal para los registros de perfil**.
   * Para los registros de perfil, puede utilizar el espacio de trabajo de esquemas de la interfaz de usuario de Experience Platform para definir los campos de identidad, incluida la identidad principal. Lea la guía de [definición de campos de identidad en la IU](../../xdm/ui/fields/identity.md) para obtener más información.
...
![Diagrama del almacenamiento de pertenencia a segmentos](../images/namespace-priority/segment-membership-storage.png)
...
* Perfil del cliente en tiempo real: elimina cualquier fragmento de perfil con la identidad especificada como identidad principal. **La identidad principal en Perfil ahora se determinará en función de la prioridad del área de nombres.**
* Repositorio de datos: elimina cualquier registro con la identidad especificada como identidad principal.

Para obtener más información, lea la [información general sobre administración avanzada del ciclo vital](../../hygiene/home.md).

### Lago de datos

La ingesta de datos al lago de datos seguirá cumpliendo la configuración de identidad principal configurada en [SDK web](../../tags/extensions/client/web-sdk/data-element-types.md#identity-map) y esquemas.
...
Cualquier esquema que no sea un evento de experiencia XDM, como los perfiles individuales de XDM, seguirá cumpliendo los requisitos [campos que se marcan como identidad](../../xdm/ui/fields/identity.md).

Para obtener más información sobre los esquemas XDM, lea la [información general sobre esquemas](../../xdm/home.md).
...
[solicitudes de eliminación de Privacy Service](../privacy.md) funciona de la siguiente manera, para una identidad determinada:

* Perfil del cliente en tiempo real: elimina cualquier fragmento de perfil con el valor de identidad especificado como identidad principal. **La identidad principal en Perfil ahora se determinará en función de la prioridad del área de nombres.**
* Lago de datos: elimina cualquier registro con la identidad especificada como identidad principal o secundaria.

Para obtener más información, lea la [Resumen del servicio de privacidad](../../privacy-service/home.md).
