...
* Lea las páginas de [Adobe Experience Platform y los diagramas de arquitectura de aplicaciones](https://experienceleague.adobe.com/es/docs/blueprints-learn/architecture/architecture-overview/platform-applications#detailed-architecture-diagram) y [Edge Network and hub comparison](/help/landing/edge-and-hub-comparison.md) para obtener más información.
...
* Lea la documentación sobre [Tipos de elementos de datos](/help/tags/extensions/client/web-sdk/data-element-types.md) e [Identidad en la recopilación de datos](/help/collection/identity/overview.md) para obtener más información sobre cómo configurar la identidad principal en Web SDK.
