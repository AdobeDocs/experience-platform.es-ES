...
Si los datos lo requieren, primero debe crear los espacios de nombres adecuados para su organización. Para ver los pasos sobre cómo crear un área de nombres personalizada, lea la guía sobre [creación de un área de nombres personalizada en la IU](../features/namespaces.md#create-custom-namespaces).

## Uso de la herramienta de simulación de gráficos {#graph-simulation}

A continuación, vaya a [herramienta de simulación de gráficos](./graph-simulation.md) en el espacio de trabajo IU del servicio de ID. Puede utilizar la herramienta de simulación de gráficos para simular gráficos de identidad, creados con una variedad de diferentes configuraciones de área de nombres única y prioridad de área de nombres.
...
Una vez que tenga una mejor idea de cómo desea que se comporte el gráfico, vaya al [herramienta configuración de identidad](./identity-settings-ui.md) en el espacio de trabajo IU del servicio de ID.
...
Para obtener instrucciones sobre cómo crear un esquema, lea la guía de [creación de un esquema XDM en la IU](../../xdm/tutorials/create-schema-ui.md).
...
Para obtener instrucciones sobre cómo crear un conjunto de datos, lea la [guía de IU del conjunto de datos](../../catalog/datasets/user-guide.md).
...
Para cualquier comentario, utilice el **[!UICONTROL comentarios de Beta]** en el espacio de trabajo de IU del servicio de ID.