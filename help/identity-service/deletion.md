...
* [Servicio de identidad](home.md): obtenga una mejor vista de los clientes individuales y su comportamiento uniendo identidades entre dispositivos y sistemas.
   * [Gráfico de identidad](./ui/identity-graph-viewer.md): un gráfico de identidad es un mapa de relaciones entre identidades diferentes para un cliente en particular, que le proporciona una representación visual de cómo el cliente interactúa con la marca en diferentes canales.
