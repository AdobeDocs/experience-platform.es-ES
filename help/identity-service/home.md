...
| Término | Definición |
| --- | --- |
| Identidad | Una identidad son datos que son exclusivos de una entidad, normalmente de una persona individual. Una identidad, como un ID de inicio de sesión, ECID o ID de fidelidad, también se denomina &quot;identidad conocida&quot;. |
