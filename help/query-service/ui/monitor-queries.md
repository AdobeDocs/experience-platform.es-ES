...
Las consultas que utilizan bloques anónimos para conformar sus sentencias SQL se separan en subconsultas individuales. Esto le permite inspeccionar individualmente los detalles de ejecución de cada bloque de consulta.

>[!NOTE]
>
>Los detalles de ejecución de un bloque anónimo que utiliza el comando DROP **not** se registrarán como subconsulta independiente. Hay disponibles detalles de ejecución separados para consultas CTAS, consultas ITAS y declaraciones COPY utilizadas como subconsultas de bloque anónimas. Actualmente no se admiten los detalles de ejecución del comando DROP.
...
Las subconsultas de bloque anónimas tienen pestañas a la izquierda del estado de ejecución. Seleccione una pestaña para mostrar los detalles de ejecución.
