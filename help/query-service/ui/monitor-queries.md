...
Las consultas que utilizan bloques anónimos para comprender sus instrucciones SQL se separan en sus consultas individuales. Esto le permite inspeccionar los detalles de ejecución de cada bloque de consulta individualmente.
...
Las consultas de bloque anónimas tienen pestañas a la izquierda del estado de ejecución. Seleccione una pestaña para mostrar los detalles de la ejecución.
