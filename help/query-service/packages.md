---
title: Paquetes de servicio de consultas
description: En el siguiente documento se describen los paquetes de funciones y productos disponibles para el servicio de consultas, y se destacan las diferencias entre las consultas ad hoc y por lotes.
...
# Paquetes del servicio de consultas
...
| Interfaz de ejecución de consultas | <ul><li>IU del servicio de consultas</li><li>IU de cliente de terceros</li><li>[!DNL PostgresSQL] IU de cliente</li></ul> | <ul><li>IU de consulta </li><li>IU de cliente de terceros</li><li>[!DNL PostgresSQL] IU de cliente</li><li>API de REST</li></ul> |
| Resultados de consulta devueltos mediante | IU de cliente | Conjunto de datos derivado almacenado en el lago de datos |
| Límite de resultados | <ul><li>IU de consulta: 100 filas</li><li>Cliente de terceros: 50 000</li><li>[!DNL PostgresSQL] cliente: 50 000</li></ul> | <ul><li>IU de consulta (sin límite superior de filas)</li><li>Clientes de terceros (sin límite superior de filas)</li><li>[!DNL PostgresSQL] cliente (sin límite superior de filas)</li><li>API de REST (sin límite superior para filas)</li></ul> |
