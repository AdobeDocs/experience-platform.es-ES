...
Puede utilizar el servicio de consultas para conectar el recorrido del cliente con conexión y comprender la atribución omnicanal de su marca. El siguiente vídeo muestra cómo una empresa de experiencia puede utilizar el servicio de consultas para tratar casos de uso clave y explica cómo funciona el servicio de consultas.

>[!VIDEO](https://video.tv.adobe.com/v/33590?captions=spa&quality=12&learn=on)
...
Con la interfaz de usuario del servicio de consultas puede escribir, ejecutar y programar consultas, ver consultas ejecutadas anteriormente y acceder a las guardadas por usuarios de su organización. También puede probar las consultas antes de ejecutarlas en su conjunto de datos más amplio con el Editor de consultas. Consulte la [guía de la interfaz de usuario del servicio de consultas] (ui/overview.md) para obtener una descripción general de la funcionalidad de la interfaz de usuario.
...
Con Adobe Experience Platform, puede ingerir, almacenar, estructurar y extraer todos los conjuntos de datos almacenados, incluidos los datos de comportamiento, CRM y de punto de venta. Con el servicio de consulta, puede consultar estos conjuntos de datos y responder preguntas comerciales específicas, lo que genera perspectivas impactantes. Aprenda a crear y administrar paneles personalizados, donde puede crear, agregar y editar widgets personalizados para visualizar métricas clave con [paneles definidos por el usuario](../dashboards/standard-dashboards.md). También puede [personalizar sus propios informes de Real-Time CDP](../dashboards/data-models/cdp-insights-data-model-b2c.md) para los casos de uso de KPI y marketing mediante consultas SQL con modelos de datos de Real-Time Customer Data Platform Insights.
...
>[!VIDEO](https://video.tv.adobe.com/v/33588?captions=spa&quality=12&learn=on)
