...
La guía de análisis de consentimiento detalla cómo crear un panel de consentimiento para varios casos de uso de marketing para datos de Real-Time CDP. Para obtener información sobre cómo crear un panel de análisis de consentimiento para rastrear las tendencias del consentimiento del usuario a lo largo del tiempo, consulte la [guía del panel de análisis de consentimiento](../../dashboards/insights-use-cases/consent-analysis.md).
