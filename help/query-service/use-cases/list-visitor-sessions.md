...
title: Enumerar las vistas de página de un usuario
description: Obtenga información sobre cómo escribir consultas que utilicen eventos de experiencia para crear una lista de las últimas 100 páginas que ha utilizado un usuario especificado.
...
Al leer este documento, tiene una mejor comprensión de cómo utilizar el servicio de consulta con [!DNL Experience Events] para mostrar las vistas de página como un usuario especificado.
