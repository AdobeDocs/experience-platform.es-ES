...
Data Distiller permite a los científicos e ingenieros de datos enriquecer sus canalizaciones de aprendizaje automático con datos de experiencia del cliente de alto valor que se han recopilado y depurado en Adobe Experience Platform. Desde un bloc de notas de [!DNL Python] en cualquier entorno, puede explorar interactivamente los datos de los clientes en Experience Platform, definir y calcular características a partir de los datos, y leer las características calculadas en el entorno de aprendizaje automático para el modelado.
...
- Con las potentes funciones de consulta de Data Distiller, puede extraer funciones significativas de los abundantes datos de comportamiento disponibles en Experience Platform. A continuación, puede incorporar los datos de funciones detallados en el entorno de aprendizaje automático sin necesidad de copiar grandes volúmenes de datos de evento fuera de Experience Platform.
...
- Genere puntuaciones, predicciones o recomendaciones a partir de los modelos y devuelva el resultado a Experience Platform para optimizar las experiencias de los clientes mediante Real-Time Customer Data Platform y Adobe Journey Optimizer.
...
- Cómo [autenticar y acceder a las API de Experience Platform](../../../landing/api-authentication.md).
...
- **Configuración**: [Conectarse a Data Distiller desde un [!DNL Python] bloc de notas](./establish-connection.md)

La documentación enlazada a continuación corresponde a los pasos indicados en la infografía anterior.

- **Paso 1**: [Explorar y analizar conjuntos de datos](./exploratory-analysis.md)
...
- [aepp](https://github.com/adobe/aepp): una biblioteca [!DNL Python] de código abierto administrada por Adobe para realizar solicitudes a Data Distiller y otros servicios de Experience Platform desde código [!DNL Python].
