...
Los tipos de datos admitidos son: booleano, fecha, fecha, hora, texto, flotante, número entero, mapa, matriz y estructura/fila.

El bloque de código SQL que aparece a continuación proporciona ejemplos para definir tipos de datos de estructura/fila, mapa y matriz. La línea uno muestra la sintaxis de fila. La línea dos muestra la sintaxis del mapa y la línea tres, la sintaxis de la matriz.
