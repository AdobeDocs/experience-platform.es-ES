...
![Diagrama para explicar la distribución y el empaquetado de las capacidades del servicio de consulta en relación con las licencias.](./images/guardrails/query-capabilities.png)
