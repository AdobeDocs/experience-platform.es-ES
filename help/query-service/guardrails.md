...
| Usuarios del servicio de consultas simultáneos para lotes programados | Sin limitación de usuario | N/D | Las consultas por lotes programadas son trabajos asincrónicos, por lo que no hay limitación de usuarios. |
