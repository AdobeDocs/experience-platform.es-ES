...
| **Barrera** | **Límite** | **Tipo de límite** | **Descripción** |
|---|---|---|---|
| Tiempo máximo de ejecución | 24 horas | Protección impuesta por el sistema | Define el tiempo máximo de ejecución para una consulta SQL por lotes.<br>El tiempo de procesamiento de una consulta depende del volumen de datos que se procese y de la complejidad de la consulta. |
