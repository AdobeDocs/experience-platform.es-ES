...
La variable `COPY` genera el resultado de cualquier `SELECT` a una ubicación especificada. El usuario debe tener acceso a esta ubicación para que este comando se ejecute correctamente.
