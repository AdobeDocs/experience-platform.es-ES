...
Puede recuperar una lista de todas las consultas para su organización IMS realizando una solicitud de GET a la `/queries` punto final.
...
Una respuesta correcta devuelve el estado HTTP 200 con una lista de consultas para la organización IMS especificada como JSON. La siguiente respuesta devuelve la consulta más reciente creada para su organización IMS.
