...
Puede recuperar una lista de todas las consultas programadas para su organización realizando una solicitud de GET al `/schedules` punto final.
...
Una respuesta correcta devuelve el estado HTTP 200 con una lista de consultas programadas para la organización especificada. La siguiente respuesta devuelve la última consulta programada creada para su organización.
