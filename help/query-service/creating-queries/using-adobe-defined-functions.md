...
topic: queries
type: Tutorial
description: 'Este documento cubre las funciones definidas por el Adobe (ADF) para admitir tres funciones clave de actividades de Analytics: sesión, atribución y rutas.'
