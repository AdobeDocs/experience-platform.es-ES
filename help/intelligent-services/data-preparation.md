...
>[!IMPORTANT]
>
>Si ha configurado recientemente un conector, debe verificar que el conjunto de datos tenga la longitud mínima de datos requerida. Consulte la sección de datos históricos en la [documentación de entrada/salida](./customer-ai/input-output.md) para la inteligencia artificial aplicada al cliente y compruebe que tiene datos suficientes para el objetivo de predicción.
