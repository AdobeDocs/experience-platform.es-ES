...
title: Etiquetado de palabras clave en la API de API de etiquetado de contenido
...
En la tabla siguiente se enumeran las entidades con nombre que [!DNL Content Tagging AI] ha identificado:
