...
Una vez que haya completado los pasos descritos en el documento anterior, visite la [Entrada y salida](./input-output.md) documentación. Este documento proporciona una breve descripción de qué tipos de datos se utilizan y producen en la inteligencia artificial aplicada al cliente.
