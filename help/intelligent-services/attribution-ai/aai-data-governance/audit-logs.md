...
Para ver y exportar los registros de auditoría, se debe contar con el permiso de control Acceso a registros de auditoría en la consola de Adobe. Para obtener información sobre cómo administrar permisos individuales para características de Attribution AI, consulte la [documentación de control de acceso](../aai-data-governance/access-controls.md).
