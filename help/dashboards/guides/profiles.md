...
Para navegar al panel Perfiles dentro de la interfaz de usuario de Experience Platform, seleccione **[!UICONTROL Profiles]** en el carril izquierdo y, a continuación, seleccione la pestaña **[!UICONTROL Overview]** para mostrar el panel.

>[!NOTE]
>
>Si su organización es nueva en Experience Platform y aún no ha creado conjuntos de datos de perfil o políticas de combinación activos, el panel Perfiles no está visible. En su lugar, la pestaña [!UICONTROL Overview] muestra vínculos y documentación para ayudarle a empezar con el Perfil del cliente en tiempo real.
...
Puede modificar el aspecto del panel Perfiles seleccionando **[!UICONTROL Modify dashboard]**. Puede mover, agregar, cambiar el tamaño y quitar widgets del tablero, así como acceder a **[!UICONTROL Widget library]** para explorar los widgets disponibles y crear widgets personalizados para su organización.
...
Seleccione **[!UICONTROL Add widget]** para navegar a la biblioteca de widgets y ver una lista de los widgets disponibles para agregar al tablero.
...
La pestaña [!UICONTROL Browse] le permite buscar y ver los perfiles de solo lectura introducidos en su organización. Desde aquí puede ver información importante que pertenece al perfil de con respecto a sus preferencias, eventos anteriores, interacciones y audiencias.

## Detalles del perfil {#profile-details}

Para abrir el área de trabajo [!UICONTROL Profiles] [!UICONTROL Detail], seleccione un(a) [!UICONTROL Profile ID] de la lista.

![La ficha Examinar perfiles con un identificador de perfil resaltado.](../images/profiles/profile-id.png)

El área de trabajo [!UICONTROL Profiles] [!UICONTROL Detail] muestra varios widgets preconfigurados que transmiten información específica de ese perfil. Esta información le permite comprender los atributos clave del perfil de un vistazo. También puede personalizar el área de trabajo [!UICONTROL Profiles] [!UICONTROL Detail] creando sus propios widgets. Consulte la sección sobre [cómo agregar widgets](#add-widgets) para obtener más información.

![El área de trabajo [!UICONTROL Profiles] [!UICONTROL Detail] con la ficha [!UICONTROL Detail] resaltada.](../images/profiles/profile-details-workspace.png)
...
El widget [!UICONTROL Customer profile] muestra el nombre y los apellidos del usuario asociado con el perfil, así como su [!UICONTROL Profile ID]. Un ID de perfil es un identificador generado automáticamente y asociado a un tipo de identidad que representa un perfil. Para obtener más información acerca de identidades y áreas de nombres de identidad, vea la [descripción general de identidades](../../rtcdp/profile/identities-overview.md).

![Widget del perfil del cliente.](../images/profiles/customer-profile.png)

#### Atributos básicos {#basic-attributes}

El widget [!UICONTROL Basic attributes] muestra los atributos más utilizados para definir un perfil individual.

![Widget de atributos básicos.](../images/profiles/basic-attributes.png)

#### Identidades vinculadas {#linked-identities}

El widget [!UICONTROL Linked identities] muestra cualquier otra identidad asociada con el perfil.

Para ver los detalles de identidad del perfil con mayor profundidad y navegar al área de trabajo [!UICONTROL Identities], seleccione **[!UICONTROL View identity graph]**.

![El widget de identidades vinculadas.](../images/profiles/linked-identities.png)

#### Preferencias de canal {#channel-preferences}

El widget [!UICONTROL Channel preferences] muestra los canales de comunicación de los que el usuario ha aceptado recibir comunicaciones. Una marca de verificación indica cada canal del que el usuario ha aceptado recibir comunicaciones.
...
* Para obtener más información acerca de los grupos de campos de esquema necesarios para [recopilar datos de consentimiento según el estándar de Adobe](../../landing/governance-privacy-security/consent/adobe/overview.md), consulte la documentación sobre estos grupos de campos de esquema habilitados para perfiles.
   ...
   * [[!UICONTROL IdentityMap]](../../xdm/field-groups/profile/identitymap.md) (obligatorio si utiliza Experience Platform Web o Mobile SDK para enviar señales de consentimiento)
...
Para agregar widgets personalizados al área de trabajo [!UICONTROL Profiles] [!UICONTROL Detail], seleccione **[!UICONTROL Customize profile details]**.

![Espacio de trabajo de detalles de perfiles con [!UICONTROL Customize profile details] resaltado.](../images/profiles/customize-profile-details.png)

Ahora puede editar el espacio de trabajo mediante el cambio de tamaño o la reubicación de los widgets. Seleccione **[!UICONTROL Add widget]** para crear un widget con atributos personalizados.

![Espacio de trabajo de perfiles [!UICONTROL Detail] con [!UICONTROL Add widget] resaltado.](../images/profiles/add-widget.png)

Aparecerá el creador del widget. Escriba un nombre descriptivo para el widget en el campo de texto [!UICONTROL Card title] y seleccione **[!UICONTROL Add attributes]**.

![El lienzo del creador del widget con el campo [!UICONTROL Card title] y [!UICONTROL Add attributes] resaltados.](../images/profiles/widget-creator.png)
...
![El diagrama de esquema de unión con la casilla de verificación de atributo de fidelidad y [!UICONTROL Select] resaltado.](../images/profiles/union-schema-attributes.png)

En el lienzo se muestra una vista previa del widget completado. Una vez que esté satisfecho con los atributos elegidos, seleccione **[!UICONTROL Save]** para confirmar las opciones y volver al área de trabajo [!UICONTROL Profiles] [!UICONTROL Detail]. El widget recién creado ahora es visible en el espacio de trabajo.
...
El panel [!UICONTROL Union Schema] muestra el esquema de unión para una clase XDM específica. Al seleccionar el menú desplegable **[!UICONTROL Class]**, puede ver los esquemas de unión de diferentes clases XDM.
...
La fecha y la hora de la instantánea más reciente se muestran en la parte superior de la pestaña [!UICONTROL Overview] junto al menú desplegable de la política de combinación. Todos los datos del widget son precisos a partir de esa fecha y hora. La marca de tiempo de la instantánea se proporciona en formato UTC; no se encuentra en la zona horaria del usuario u organización individual.
...
El widget [!UICONTROL Customer AI distribution of scores] categoriza el número total de perfiles según sus puntuaciones de tendencia. La distribución del recuento de perfiles viene determinada por el modelo de IA y la política de combinación seleccionada y, a continuación, se visualiza en incrementos de cinco por ciento que indican su tendencia. El recuento de perfiles se proporciona a lo largo del eje Y y las puntuaciones de tendencia se proporcionan a lo largo del eje X.
...
Para ir a la página de detalles del modelo de inteligencia artificial aplicada al cliente seleccionado, seleccione **[!UICONTROL View model details]**.

![Panel de audiencias de Experience Platform con el widget [!UICONTROL Customer AI distribution of scores] y [!UICONTROL View model details] resaltados.](../images/segments/customer-ai-distribution-of-scores.png)
...
Para ir a la página de detalles del modelo de inteligencia artificial aplicada al cliente seleccionado, seleccione **[!UICONTROL View model details]**. Encontrará más información sobre inteligencia artificial aplicada al cliente en la [guía de la interfaz de usuario de Discover insights](../../intelligent-services/customer-ai/user-guide/discover-insights.md).

## Widgets estándar {#standard-widgets}

Adobe proporciona varios widgets estándar que puede utilizar para visualizar diferentes métricas relacionadas con los datos del perfil. También puede crear widgets personalizados para compartirlos con su organización mediante [!UICONTROL Widget library]. Para obtener más información sobre cómo crear widgets personalizados, comience por leer la [descripción general de la biblioteca de widgets](../customize/widget-library.md).
...
El widget **[!UICONTROL Profile count]** muestra el número total de perfiles combinados dentro del almacén de perfiles en el momento en que se tomó la instantánea. Este número es el resultado de la política de combinación seleccionada que se está aplicando a los datos del perfil para combinar fragmentos de perfil y formar un único perfil para cada individuo.
...
>[!NOTE]
>
>El widget [!UICONTROL Profile count] puede mostrar un número diferente al recuento de perfiles que se muestra en la ficha [!UICONTROL Browse] de la sección [!UICONTROL Profiles] de la interfaz de usuario por varios motivos. El motivo más común de esta diferencia es que la pestaña [!UICONTROL Browse] hace referencia al número total de perfiles combinados en función de la política de combinación predeterminada de su organización, mientras que el widget [!UICONTROL Profile count] hace referencia al número total de perfiles combinados en función de la política de combinación que ha seleccionado para ver en el panel.
>
>Otro motivo común se debe a las diferencias entre el momento en que se toma la instantánea del panel y el momento en que se ejecuta el trabajo de muestra para la pestaña [!UICONTROL Browse]. Puede ver cuándo se actualizó por última vez el widget [!UICONTROL Profile count] mirando la marca de tiempo del widget. Para obtener más información sobre cómo se activa el trabajo de ejemplo en la ficha [!UICONTROL Browse], consulte la sección [recuento de perfiles en la guía de la interfaz de usuario del perfil del cliente en tiempo real](../../profile/ui/user-guide.md#profile-count).
...
El widget **[!UICONTROL Profiles count change trend]** muestra un botón &quot;subtítulos&quot; en la parte superior derecha del widget. Para abrir el cuadro de diálogo de subtítulos automáticos, seleccione **[!UICONTROL Captions]**.
...
El widget **[!UICONTROL Profiles by identity]** muestra el desglose de identidades en todos los perfiles combinados del almacén de perfiles. El número total de perfiles por identidad (es decir, sumando los valores mostrados para cada área de nombres) puede ser mayor que el número total de perfiles combinados, ya que un perfil podría tener varias áreas de nombres asociadas. Por ejemplo, si un cliente interactúa con su marca en más de un canal, se asociarán varias áreas de nombres a ese cliente individual.
...
Para abrir el cuadro de diálogo de subtítulos automáticos, seleccione **[!UICONTROL Captions]**.
...
El widget **[!UICONTROL Identity overlap]** utiliza un diagrama de Venn, o diagrama de conjunto, para mostrar la superposición de perfiles en el almacén de perfiles que contienen las dos identidades seleccionadas.
...
El widget [!UICONTROL Single Identity Profiles] proporciona un recuento de los perfiles de su organización que solo tienen un tipo de ID que crea su identidad. Este tipo de ID puede ser un correo electrónico o un ECID. El recuento de perfiles se genera a partir de los datos contenidos en la instantánea más reciente.
...
El widget [!UICONTROL Unsegmented Profiles] proporciona el número total de perfiles que no están adjuntos a ninguna audiencia. El número generado es preciso desde la última instantánea y representa la oportunidad de activación de perfiles en toda la organización. También indica la oportunidad de eliminar perfiles que no proporcionan un ROI adecuado.
...
Seleccione **[!UICONTROL Audiences]** para navegar a la ficha [!UICONTROL Audiences] del panel [!UICONTROL Browse]. A partir de ahí, puede ver una lista de todas las definiciones de segmentos de su organización.
...
Este widget tabula la superposición de datos de todas las audiencias disponibles filtradas por la política de combinación. Se proporciona una lista de cinco audiencias clasificadas entre los porcentajes de superposición más altos y más bajos para la política de combinación elegida en el menú desplegable de la parte superior de la pantalla. Las dos audiencias analizadas se enumeran en las columnas [!UICONTROL AUDIENCE A NAME] y [!UICONTROL AUDIENCE B NAME]. La superposición porcentual se indica en la tercera columna con una precisión de doce decimales.
...
Seleccione **[!UICONTROL View more]** para abrir un cuadro de diálogo de pantalla completa que contenga más datos de superposición de audiencias.
...
Aparecerá el cuadro de diálogo [!UICONTROL Audience overlap report]. Este cuadro de diálogo puede contener hasta 50 filas de análisis de superposición de audiencias divididas en seis columnas. Para quitar o agregar columnas de la tabla, seleccione el icono de configuración (![El icono de configuración.](/help/images/icons/settings.png)).

![Cuadro de diálogo del informe de superposición de audiencias.](../images/profiles/profiles-audience-overlap-report-dialog.png)

>[!NOTE]
>
>Para cambiar la clasificación de los resultados entre mayor a menor o menor a mayor, seleccione el encabezado de columna **[!UICONTROL Overlapping]**.

Para descargar todo el informe en formato PDF, seleccione el menú de opciones (**`...`**) seguido de **[!UICONTROL Download]**.
...
Seleccione **[!UICONTROL Close]** para volver al tablero [!UICONTROL Profiles].

### [!UICONTROL Audiences mapped to destination status] {#audiences-mapped-to-destination-status}

El widget [!UICONTROL Audiences mapped to destination status] muestra el número total de audiencias asignadas y no asignadas en una sola métrica y usa un gráfico de anillo para ilustrar la diferencia proporcional entre sus totales. Los números calculados dependen de la política de combinación elegida.
