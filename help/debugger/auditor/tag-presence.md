...
| --- | --- | --- | --- |
| Adobe Advertising: presencia de código | 5 | La etiqueta Adobe Advertising no está disponible en el DOM. | Implemente la etiqueta Adobe Advertising con la [extensión de etiqueta Adobe Advertising](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |
| Adobe Advertising: Píxel de segmento implementado | 5 | Actualice los píxeles del segmento de Adobe Advertising con las nuevas etiquetas de solo imagen de Adobe Advertising. El uso de etiquetas de segmento AMO no soportadas puede causar la pérdida de datos. | Implemente el píxel del segmento de Adobe Advertising con la [extensión de etiqueta de Adobe Advertising](../../destinations/catalog/advertising/adobe-advertising-cloud.md). |
