...
* Se ha agregado compatibilidad con [`onBeforeLinkClickSend`](fundamentals/configuring-the-sdk.md#onBeforeLinkClickSend) vínculo haga clic en llamada de retorno.
* Se ha agregado compatibilidad con el rastreo de clics de Adobe Journey Optimizer.

**Correcciones y mejoras**

* La recopilación de vínculos ahora incluye el nombre del vínculo y la región del visitante.
* Se ha eliminado el error de la consola para destinos URL con errores.
