...
* (Beta) Se agregó **[!UICONTROL Actualizar variable]** acción y **[!UICONTROL Variable]** elemento de datos.
...
* Se ha corregido un problema que hacía que no funcionara al hacer clic en elementos dentro de una etiqueta de anclaje **[!UICONTROL Redireccionar con identidad]** acción utilizada.
