...
## [!UICONTROL Anulaciones de configuración de flujo de datos]
...
![Imagen que muestra las anulaciones de configuración de la secuencia de datos en la página de extensión de etiquetas del SDK web.](../assets/extension/overview/datastream-overrides.png)
