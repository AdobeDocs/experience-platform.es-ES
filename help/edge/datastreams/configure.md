...
| [!UICONTROL ID de contenedor de sincronización de ID de terceros] | ID numérico del contenedor que se va a utilizar para la sincronización de ID de terceros. |
...
| [!UICONTROL Anulaciones de grupos de informes] | En esta sección, puede agregar ID de grupos de informes adicionales que puede utilizar para anular la predeterminada. |
...
| Configuración | Descripción |
|---| --- |
| [!UICONTROL Conjunto de datos del evento] | **(Obligatorio)** Seleccione el conjunto de datos de Platform al que se transmitirán los datos de eventos del cliente. Este esquema debe utilizar la variable [Clase XDM ExperienceEvent](../../xdm/classes/experienceevent.md). Para agregar conjuntos de datos adicionales, seleccione **[!UICONTROL Agregar conjunto de datos de evento]**. |
...
| [!UICONTROL Anulaciones de tokens de propiedad] | En esta sección puede definir tokens de propiedad adicionales que puede utilizar para anular el predeterminado. |
