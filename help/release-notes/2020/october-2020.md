...
| Función | Descripción |
| ------- | ----------- |
| Adiciones a la API de vista previa de perfil | La API de vista previa del perfil (`/previewsamplestatus`) ahora incluye la capacidad de ver un desglose del total de fragmentos de perfil en la organización, así como de ver la distribución de fragmentos de perfil entre áreas de nombres de identidad. |
