...
| Función | Descripción |
| ------- | ----------- |
| Adiciones a API de previsualización de perfil | La API de previsualización de perfil (`/previewsamplestatus`) ahora incluye la capacidad de ver un desglose del total de fragmentos de perfil en su organización, así como de ver la distribución de fragmentos de perfil en áreas de nombres de identidad. |
