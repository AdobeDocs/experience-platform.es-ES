...
| Función | Descripción |
| ------- | ----------- |
| Compatibilidad adicional de API e interfaz de usuario para sistemas de almacenamiento en la nube | Nuevos conectores de origen para Apache HDFS |
| Compatibilidad adicional de API e interfaz de usuario con bases de datos | Conectores de origen nuevos para Couchbase. |
