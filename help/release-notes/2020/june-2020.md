...
Para obtener más información sobre [!DNL Real-time Machine Learning] alpha, consulte la [Resumen de aprendizaje automático en tiempo real](../../data-science-workspace/real-time-machine-learning/home.md).
