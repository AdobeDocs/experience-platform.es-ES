...
| --- | --- | --- |
| Clase | [[!UICONTROL XDM Individual Prospect Profile]](https://github.com/adobe/xdm/pull/1758/files) | Utilice esta clase para incorporar perfiles de clientes potenciales procedentes de los casos de uso de adquisición de clientes principales de los proveedores de datos. |
| Grupo de campo | [[!UICONTROL Enriched Event Segment Details]](https://github.com/adobe/xdm/pull/1754/files) | Una lista de públicos para las que el perfil cumple los requisitos en el momento de la colección del evento. |
...
| --- | --- | --- |
| Grupo de campo | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de experimental a `stable`. |
| Grupo de campo | [[!UICONTROL Media Interaction Details]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `stable` a `deprecated`. |
| Tipo de datos | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Tipo de datos | [[!UICONTROL Qoe Data details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Tipo de datos | [[!UICONTROL Player state data information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental`a `stable`. |
| Tipo de datos | [[!UICONTROL Media event information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Tipo de datos | [[!UICONTROL Media details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Tipo de datos | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Tipo de datos | [[!UICONTROL Error details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `stable` a `deprecated`. |
| Tipo de datos | [[!UICONTROL Custom metadata details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Tipo de datos | [[!UICONTROL Chapter details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Tipo de datos | [[!UICONTROL Advertising Pod details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Tipo de datos | [[!UICONTROL Advertising details information]](https://github.com/adobe/xdm/pull/1756/files) | `meta:status` se ha actualizado de `experimental` a `stable`. |
| Extensión (administración de recorrido del cliente) | [[!UICONTROL Domain]](https://github.com/adobe/xdm/pull/1756/files) | Se agregó el campo `Domain` a [!UICONTROL Adobe CJM ExperienceEvent - Message Profile Details] para registrar el dominio de la dirección de correo electrónico del destinatario. |
| Extensión (administración de recorrido del cliente) | [[!UICONTROL Channel's variant Name]](https://github.com/adobe/xdm/pull/1753/files) | Este campo se agregó a [!UICONTROL AJO Entity Fields] para representar el nombre de variante del canal. |
| Extensión: (Adobe Analytics) | [[!UICONTROL Context value]](https://github.com/adobe/xdm/pull/1761/files) | `Context value` se ha añadido a [!UICONTROL `Adobe Analytics ExperienceEvent Full Extension`]. |
