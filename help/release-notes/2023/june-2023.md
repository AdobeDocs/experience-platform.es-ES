...
| [!BADGE Beta]Compatibilidad con {type=Informative} para [!DNL RainFocus] | Ahora puede utilizar la integración de fuentes de [!DNL RainFocus] para obtener datos de análisis y administración de eventos de su cuenta de [!DNL RainFocus] para Experience Platform. Para obtener más información, lea la [[!DNL RainFocus] información general de fuentes](../../sources/connectors/analytics/rainfocus.md). |
