...
| Destino | Descripción |
| --- | --- |
| Detalles de caducidad de autenticación para [!DNL LinkedIn] y [!DNL Pinterest] destinos | La información de caducidad de la cuenta ahora está visible directamente en la interfaz de Experience Platform, por lo que puede ver cuándo caducará la autenticación de [!DNL LinkedIn] y [!DNL Pinterest] y la renovará antes de que cause interrupciones en los flujos de datos. |
