...
| Función | Descripción |
| --- | --- |
| Disponibilidad general del agente de asistencia técnica de productos | Ahora puede utilizar el agente de asistencia técnica de productos en el Asistente de IA para solucionar problemas sin interrumpir sus flujos de trabajo. Los administradores de asistencia técnica de su organización ahora pueden utilizar el agente de asistencia técnica de productos para crear vales de asistencia al cliente, con detalles del contexto y la sesión de sus interacciones con el Asistente de IA. <br><br>El acceso al agente de asistencia técnica de productos estará disponible hasta el 30 de noviembre de 2025. Debe ponerse en contacto con el representante de su cuenta de Adobe para obtener la licencia del agente de asistencia técnica de productos y seguir utilizando la función después de esta fecha. Para obtener más información, lea la [documentación del agente de asistencia técnica de productos](../../ai-assistant/new-features/customer-support.md). |
