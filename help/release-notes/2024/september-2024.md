...
| Volumen total de datos | La métrica “Riqueza promedio de perfiles” se ha reemplazado con la métrica “Volumen total de datos”. Volumen total de datos hace referencia a la cantidad total de datos disponibles que se pueden utilizar con el perfil del cliente en tiempo real para los flujos de trabajo de participación y personalización. Encontrará más detalles sobre este cambio en la [Guía de volumen total de datos](../../landing/license-usage-and-guardrails/total-data-volume.md). |
...
| Función | Descripción |
| --- | --- |
| Disponibilidad limitada de las reglas de vinculación de gráficos de identidad | Las reglas de vinculación de gráficos de identidad son un paquete de herramientas en el servicio de identidad que puede utilizar para garantizar una personalización precisa para los usuarios. <ul><li>Ahora puede usar el [algoritmo de optimización de identidad](../../identity-service/identity-graph-linking-rules/identity-optimization-algorithm.md) para asegurarse de que un gráfico de identidad sea representativo de una sola persona y, por lo tanto, evitar la combinación no deseada de identidades en el perfil del cliente en tiempo real.</li><li>Configure [prioridades del espacio de nombres](../../identity-service/identity-graph-linking-rules/namespace-priority.md) para definir la importancia de sus respectivos espacios de nombres e influir en cómo se forman y segmentan los perfiles.</li><li>Use la [herramienta de simulación de gráficos en la interfaz de usuario](../../identity-service/identity-graph-linking-rules/graph-simulation.md) para simular gráficos de identidad con configuraciones variables.</li><li>Use la [interfaz de configuración de identidad](../../identity-service/identity-graph-linking-rules/identity-settings-ui.md) para designar su espacio de nombres único y establecer prioridades para todos los espacios de nombres de su organización.</li><li>Consulte el [panel de identidad](../../identity-service/identity-graph-linking-rules/implementation-guide.md#validate-your-graphs) para ver las métricas y tendencias relacionadas con los datos del gráfico.</li></ul> Para probar las reglas de vinculación de gráficos de identidad, póngase en contacto con el equipo de cuentas de Adobe para obtener acceso a las zonas protegidas de desarrollo. |
