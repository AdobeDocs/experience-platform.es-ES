...
| Función | Descripción |
| --- | --- |
| Plantillas de Data Distiller | Explore varias plantillas para obtener información estructurada sobre los datos de público. Utilice paneles como **Superposiciones de público [!UICONTROL avanzadas]**, **[!UICONTROL Comparación de públicos]**, **[!UICONTROL Tendencias de público]** y **[!UICONTROL Superposiciones de identidad de público]** para tomar decisiones basadas en datos, optimizar la segmentación y mejorar las estrategias de participación. Consulte la [Guía de plantillas de Data Distiller](../../dashboards/sql-insights-query-pro-mode/templates/overview.md) para obtener más información. |
| Superposiciones de público avanzadas | Analice rápidamente las intersecciones de públicos para públicos específicos o vea todas las superposiciones para descubrir información de valor en todo su conjunto de públicos. Utilice estos datos para refinar la segmentación, reducir la mensajería redundante y crear campañas más segmentadas para mejorar la eficacia del marketing. Consulte la [Guía de superposiciones de público avanzadas](../../dashboards/sql-insights-query-pro-mode/templates/overlaps.md) para obtener más información. |
| Mejoras de comparación de públicos | Vea una comparación en paralelo de métricas clave entre diferentes grupos de públicos mediante el panel **Comparación de públicos**. Con este panel puede seleccionar lapsos de tiempo y KPI específicos, como el tamaño del público y la composición de la identidad, para tomar decisiones más informadas sobre la segmentación de público y las estrategias de segmentación. Consulte la [Guía de comparación de públicos](../../dashboards/sql-insights-query-pro-mode/templates/comparison.md) para obtener más información. |
| Visualización de tendencias de público | Analice las métricas de público con el tiempo con el panel **[!UICONTROL Tendencias de público]**. Visualice las tendencias sobre el tamaño del público, el número de identidades y el número de perfiles de identidad únicos para ayudarle a monitorizar la evolución del público, medir el crecimiento y refinar sus estrategias de participación. Consulte la [Guía de tendencias de público](../../dashboards/sql-insights-query-pro-mode/templates/trends.md) para obtener más información. |
| Análisis de superposiciones de identidad | Analice superposiciones de identidad en públicos seleccionados con el panel **[!UICONTROL Superposiciones de identidad de público]**. Vea las tendencias y desgloses de identidad para comprender cómo se relacionan los distintos tipos de identidad dentro del público, mejorando la identificación de identidad y la precisión de la segmentación de clientes. Consulte la [Guía de superposiciones de identidad de público](../../dashboards/sql-insights-query-pro-mode/templates/identity-overlaps.md) para obtener más información. |
