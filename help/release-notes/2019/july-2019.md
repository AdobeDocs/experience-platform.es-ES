...
Para obtener más información, visite la [descripción general del Privacy Service](../../privacy-service/home.md).
...
| Función | Descripción |
|---|---|
| Sistema de iconos mejorado | La interfaz de usuario de [!DNL Schema Editor] ha actualizado los iconos para que se alineen mejor con el diseño general de [!DNL Platform]. |
