...
description: Notas de la versión de junio de 2019 de Adobe Experience Platform.
...
| Notebooks | Entorno personalizado para científicos e ingenieros de datos con tecnología [!DNL Jupyter Notebooks] para permitirles preparar datos, extraer características y desarrollar modelos XML con una lista revisada de bibliotecas y marcos de aprendizaje automático populares. |
