...
| Función | Descripción |
| -----------| ---------- |
| Mejoras en la búsqueda [!DNL Profile] | Los usuarios ahora pueden buscar perfiles mediante descriptores de referencia y entidades relacionadas. |
| Limpiar los datos de un conjunto de datos determinado | Los usuarios ahora pueden eliminar datos de un conjunto de datos o lote determinado mediante la API de trabajos del sistema [!DNL Profile]. |
| Mejoras en la consulta de Edge [!DNL Profile] | Las aplicaciones ahora pueden consultar Edge [!DNL Profile] mediante cualquiera de las identidades de un perfil determinado. |
...
| Compatibilidad mejorada con el uso compartido de audiencias externas entre [!DNL Platform] y las soluciones de Adobe | Los usuarios ahora pueden introducir metadatos de audiencia externos (que no sean [!DNL Experience Platform]) en escenarios donde el número de audiencias sea grande o no se conozca a priori. Esta versión incluye acceso a los metadatos [!DNL Audience Manager] para los clientes que han aprovisionado el conector de la solución. Estos metadatos de audiencia se pueden usar en el Generador de segmentos para crear nuevos segmentos [!DNL Experience Platform]. <br/><br/> Además, los segmentos creados en ahora  [!DNL Experience Platform] estarán disponibles para su uso en soluciones de Adobe integradas, incluidas  [!DNL Audience Manager],  [!DNL Target] y  [!DNL Ad Cloud]. |
