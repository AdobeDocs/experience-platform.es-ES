...
| Función | Descripción |
| --- | --- |
| Caducidades de los conjuntos de datos | [Caducidad programada](../../hygiene/ui/dataset-expiration.md) para conjuntos de datos de Platform. |
...
| Compatibilidad con la ingesta de archivos con codificación `ISO-8859-1` | Use el parámetro `encoding` para introducir `ISO-8859-1` archivos codificados con un origen de almacenamiento en la nube en Platform mediante la API [!DNL Flow Service]. Consulte la guía sobre [creación de una conexión de origen de almacenamiento en la nube](../../sources/tutorials/api/collect/cloud-storage.md) para obtener más información. |
