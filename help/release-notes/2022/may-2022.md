...
Experience Platform proporciona un conjunto de funciones de higiene de los datos que le permiten administrar los datos almacenados mediante la eliminación mediante programación de registros de consumidores y conjuntos de datos. Con el espacio de trabajo [!UICONTROL Data Hygiene] en la interfaz de usuario o a través de llamadas a la API de higiene de datos, puede administrar los almacenes de datos para asegurarse de que la información se utiliza según lo esperado, se actualiza cuando es necesario corregir datos incorrectos y se elimina cuando las directivas de la organización lo consideran necesario.
...
| --- | --- | --- |
| Grupo de campos | [[!UICONTROL Change set]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/changeset.schema.json) | Registra cambios de nivel de fila en conjuntos de datos y desde ellos. Este grupo de campos puede emplearse en cualquier clase. |
| Grupo de campo | [[!UICONTROL Reference keys]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-reference-keys.schema.json) | Captura claves de referencia para esquemas de ExperienceEvent, lo que permite crear relaciones con esquemas basados en otras clases. |
...
| --- | --- | --- |
| Comportamiento | [[!UICONTROL Time-series Schema]](https://github.com/surbhi114/xdm/blob/master/components/behaviors/time-series.schema.json) | Se ha actualizado `eventType` para incluir varios tipos de eventos nuevos relacionados con medios y un caso de uso de entrada de canal web para Adobe Journey Optimizer. |
| Esquema global | [[!UICONTROL Destination]](https://github.com/tumulurik/xdm/blob/master/schemas/destinations/destination.schema.json) | Se eliminaron los valores de enumeración de `xdm:destinationCategory`. |
| Grupo de campo | [[!UICONTROL Record Status]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/shared/record-status.schema.json) | Se ha actualizado el estado del grupo de campos de `experimental` a `stable`. |
| Grupo de campo | (Varios) | Se han actualizado varios grupos de campos B2B de modo que algunos campos de ID queden obsoletos y prefieran los campos de tipo clave que utilizan el tipo de datos [[!UICONTROL B2B Source]](../../xdm/data-types/b2b-source.md). Los campos de ID anteriores quedarán obsoletos en una actualización futura. Consulte la siguiente [solicitud de extracción](https://github.com/adobe/xdm/pull/1533/files#diff-720c0bb1d1cbaf622f5656c2a4b62d35830c75f6563794da72a280a6a520fbc1) para obtener una lista completa de los cambios en los grupos de campos afectados. |
| Tipo de datos | [[!UICONTROL Browser details]](https://github.com/liljenback/xdm/blob/master/components/datatypes/browserdetails.schema.json) | Se ha agregado un nuevo campo `xdm:userAgentClientHints` que captura información contextual sobre el agente de usuario que interactúa con el explorador. |
| Tipo de datos | [[!UICONTROL Media information]](https://github.com/lidiaist/xdm/blob/master/docs/reference/datatypes/media.schema.json) | Se ha agregado un campo `xdm:playhead` para capturar el tiempo de cabezal de reproducción de un fragmento de contenido multimedia. Se corrigió la validación de patrones de `xdm:videoSegment`. |
| Tipo de datos | [[!UICONTROL Rating]](https://github.com/lidiaist/xdm/blob/master/components/datatypes/external/iptc/rating.schema.json) | `iptc4xmpExt:RatingSourceLink` ya no es un campo obligatorio. |
