...
| Función | Descripción |
| --- | --- |
| Caducidad de conjuntos de datos | [Programar caducidades](../../hygiene/ui/dataset-expiration.md) para conjuntos de datos de Platform. |
