...
| La columna Segmento en el flujo de datos se ejecuta en destinos por lotes | Para que el flujo de datos se ejecute en destinos por lotes, la interfaz de usuario ahora muestra el nombre del segmento asociado a cada ejecución de flujo de datos. Más información sobre [El flujo de datos se ejecuta en destinos por lotes](../../dataflows/ui/monitor-destinations.md#dataflow-runs-for-batch-destinations). |
...
| [Extensión de etiqueta de la capa de datos de Google](../../tags/extensions/client/google-data-layer/overview.md) | La extensión de capa de datos de Google le permite utilizar una capa de datos de Google en la implementación de etiquetas. |
...
| [Extensión de reenvío de eventos Mailchimp](../../tags/extensions/server/mailchimp/overview.md) | La extensión de reenvío de eventos Mailchimp envía eventos a la API de marketing Mailchimp que pueden enviar correos electrónicos de déclencheur para campañas de marketing Mailchimp, recorridos o transacciones. |
