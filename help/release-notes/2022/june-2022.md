...
Data Science Workspace utiliza aprendizaje automático e inteligencia artificial para obtener información de sus datos. Integrado en Adobe Experience Platform, Data Science Workspace le ayuda a hacer predicciones utilizando su contenido y sus recursos de datos en soluciones de Adobe. Una de las formas en que Data Science Workspace logra esto es a través del uso de JupyterLab. JupyterLab es una interfaz de usuario basada en web para el <a href="https://jupyter.org/" target="_blank">Proyecto Jupyter</a> y está totalmente integrada en Adobe Experience Platform. Proporciona un entorno de desarrollo interactivo para que los científicos de datos trabajen con cuadernos, códigos y datos de Jupyter.
...
| [[!DNL Adobe Advertising Cloud DSP]](../../destinations/catalog/advertising/adobe-advertising-cloud-connection.md) | El destino de Adobe Advertising Cloud DSP DSP [!DNL Demand-Side Platform] () le permite compartir segmentos de origen autenticados con anunciantes y usuarios aprobados para la activación de campañas con los que tiene acceso. |
...
| Función | Descripción |
| --- | --- |
| [Configuración de tipo de acceso para flujos de datos](../../datastreams/overview.md#create) | Al crear un nuevo conjunto de datos, ahora puede seleccionar qué tipo de solicitudes desea que acepte el Edge Network: <ul><li>**[!UICONTROL Autenticación mixta]**: cuando se selecciona esta opción, Edge Network acepta solicitudes autenticadas y no autenticadas. Seleccione esta opción si tiene previsto utilizar el SDK web o el [SDK móvil](https://developer.adobe.com/client-sdks/documentation/), junto con la [API de servidor](../../server-api/overview.md). </li><li>**[!UICONTROL Solo autenticado]**: cuando se selecciona esta opción, Edge Network solo acepta solicitudes autenticadas. Seleccione esta opción cuando planee usar solamente la API de servidor y desee evitar que [!DNL Edge Network] procese cualquier solicitud no autenticada. </li></ul> |
...
| Función | Descripción |
| --- | --- |
| Versión de Beta del origen [!DNL Mixpanel] | Ahora puede usar el origen [!DNL Mixpanel] para ingerir datos de análisis de su cuenta de [!DNL Mixpanel] en el Experience Platform. Consulte la [[!DNL Mixpanel] documentación de origen](../../sources/connectors/analytics/mixpanel.md) para obtener más información. |
