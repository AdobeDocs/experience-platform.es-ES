...
| Extensión [!DNL Splunk] para el reenvío de eventos | Ahora puede enviar datos a [!DNL Splunk] mediante una extensión de [reenvío de eventos](../../tags/ui/event-forwarding/overview.md). Consulte la [[!DNL Splunk] descripción general de la extensión](../../tags/extensions/server/splunk/overview.md) para obtener más información. |
| Extensión [!DNL Zendesk] para el reenvío de eventos | Ahora puede enviar datos a [!DNL Zendesk] mediante una extensión de [reenvío de eventos](../../tags/ui/event-forwarding/overview.md). Consulte la [[!DNL Zendesk] descripción general de la extensión](../../tags/extensions/server/zendesk/overview.md) para obtener más información. |
