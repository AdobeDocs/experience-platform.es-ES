...
| Grupo de campo | [[!UICONTROL Detalles de interacción de medios]](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-media.schema.json) | Un grupo de campos para [!UICONTROL ExperienceEvent de XDM] que captura detalles acerca de una interacción de medios. |
