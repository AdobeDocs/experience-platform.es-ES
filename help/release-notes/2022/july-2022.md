...
Consulte la [descripción general de Real-Time CDP, B2B Edition](../../rtcdp/b2b-overview.md) para obtener más información sobre las funciones B2B disponibles o el [tutorial completo](../../rtcdp/b2b-tutorial.md) para obtener más información sobre cómo se crean los perfiles de cuenta como parte del flujo de trabajo B2B.
...
| Función | Descripción |
| ----------- | ----------- |
| [Exportar archivo ahora (Beta)](../../destinations/ui/export-file-now.md) | Exportar un archivo completo sin interrumpir la programación actual de exportación de un segmento programado anteriormente. Esta exportación se realiza además de las exportaciones programadas anteriormente y no cambia la frecuencia de exportación del segmento. <br> La exportación de archivos se activa inmediatamente y recoge los últimos resultados de las ejecuciones de segmentación de Experience Platform. <br> <br>Póngase en contacto con el representante del Adobe para obtener acceso a esta funcionalidad. |
...
| Función | Descripción |
| --- | --- |
| Disponibilidad general de la fuente [!DNL Azure Data Explorer] | Utilice el origen de Data Explorer de Azure para llevar los datos de su instancia de [!DNL Azure] al Experience Platform. Consulte la [[!DNL Azure Data Explorer] descripción general del origen](../../sources/connectors/databases/data-explorer.md) para obtener más información. |
| Disponibilidad general del origen [!DNL Generic OData] | Utilice el origen [!DNL Generic OData] para llevar recursos de sistemas que admiten el protocolo de datos abiertos al Experience Platform. Consulte la [[!DNL Generic OData] descripción general del origen](../../sources/connectors/protocols/odata.md) para obtener más información. |
| Compatibilidad con la detección automática de las propiedades del archivo de origen para [!DNL Data Landing Zone] en la IU del Experience Platform | El origen [!DNL Data Landing Zone] ahora admite la detección automática de propiedades de archivo al utilizar la interfaz de usuario del Experience Platform. Consulte la documentación sobre [creación de una [!DNL Data Landing Zone] conexión de origen](../../sources/tutorials/ui/create/cloud-storage/data-landing-zone.md) para obtener más información. |
