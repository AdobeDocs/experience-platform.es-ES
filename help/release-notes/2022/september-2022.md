...
| [[!DNL Adobe Journey Optimizer] compatibilidad con datastreams](../../edge/datastreams/overview.md#aep) | El servicio Adobe Experience Platform para conjuntos de datos ahora es compatible [!DNL Adobe Journey Optimizer]. Esta opción le permite utilizar canales entrantes web y basados en aplicaciones en [!DNL Adobe Journey Optimizer]. |
