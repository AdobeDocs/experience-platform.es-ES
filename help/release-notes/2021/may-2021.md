...
- Cada organización de Experience Cloud viene con una zona protegida de producción predeterminada creada previamente. Esta zona protegida actúa como destino predeterminado para cada solicitud enviada a Platform desde otra aplicación de Adobe o aplicación que no sea de Adobe y que (aún) no sea compatible con la zona protegida. La zona protegida de producción predeterminada no se puede restablecer si Adobe Analytics también está usando el gráfico de identidades alojado en ella para la función [Cross Device Analytics (CDA)](https://experienceleague.adobe.com/docs/analytics/components/cda/overview.html?lang=es), o si Adobe Audience Manager también está utilizando el gráfico de identidades alojado en él para la función [People Based Destinations (PBD)](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/people-based/people-based-destinations-overview.html?lang=es).
