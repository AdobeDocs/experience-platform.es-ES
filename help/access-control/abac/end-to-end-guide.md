...
* Su equipo de marketing interno debe poder obtener acceso a los datos de **[!UICONTROL PHI/ Regulated Health Data]**.
* Su agencia externa no debería poder acceder a los datos de **[!UICONTROL PHI/ Regulated Health Data]**.
...
* [Etiquete sus recursos (campos de esquema y audiencias)](#label-resources): Asigne la etiqueta **[!UICONTROL PHI/ Regulated Health Data]** a los recursos y audiencias de esquema.
...
[!UICONTROL Permissions] es el área de Experience Cloud donde los administradores pueden definir roles de usuario y directivas para administrar permisos para características y objetos dentro de una aplicación de producto.

A través de [!UICONTROL Permissions], puede crear y administrar roles y asignar los permisos de recursos deseados para estos roles. [!UICONTROL Permissions] también le permite administrar las etiquetas, las zonas protegidas y los usuarios asociados a una función específica.

Póngase en contacto con el administrador del sistema para obtener acceso si no tiene privilegios de administrador.

Una vez que tengas privilegios de administrador, ve a [Adobe Experience Cloud](https://experience.adobe.com/) e inicia sesión con tus credenciales de Adobe. Una vez que haya iniciado sesión, aparecerá la página **[!UICONTROL Overview]** para su organización para la que tiene privilegios de administrador. Esta página muestra los productos a los que está suscrita su organización, junto con otros controles para agregar usuarios y administradores a la organización. Seleccione **[!UICONTROL Permissions]** para abrir el área de trabajo de la integración de Experience Platform.

![Imagen que muestra el producto Permisos seleccionado en Adobe Experience Cloud](../images/flac-ui/flac-select-product.png)

Aparece el área de trabajo Permisos para la interfaz de usuario de Experience Platform, que se abre en la página **[!UICONTROL Overview]**.
...
Para empezar, seleccione **[!UICONTROL Roles]** en el panel de navegación izquierdo y luego seleccione **[!UICONTROL ACME Business Group]**.
...
A continuación, seleccione **[!UICONTROL Labels]** y luego seleccione **[!UICONTROL Add Labels]**.
...
Aparecerá una lista de todas las etiquetas de su organización. Seleccione **[!UICONTROL RHD]** para agregar la etiqueta de **[!UICONTROL PHI/Regulated Health Data]** y luego seleccione **[!UICONTROL Save]**.
...
Seleccione **[!UICONTROL Schemas]** en el panel de navegación izquierdo y, a continuación, seleccione **[!UICONTROL ACME Healthcare]** de la lista de esquemas que aparecen.
...
A continuación, seleccione **[!UICONTROL Labels]** para ver una lista que muestre los campos asociados con su esquema. Desde aquí, puede asignar etiquetas a uno o varios campos a la vez. Seleccione los campos **[!UICONTROL BloodGlucose]** y **[!UICONTROL InsulinLevel]**, y después seleccione **[!UICONTROL Apply access and data governance labels]**.
...
Aparece el cuadro de diálogo **[!UICONTROL Edit labels]**, que le permite elegir las etiquetas que desea aplicar a los campos de esquema. Para este caso de uso, seleccione la etiqueta **[!UICONTROL PHI/ Regulated Health Data]** y luego seleccione **[!UICONTROL Save]**.
...
Seleccione **[!UICONTROL Audiences]** de la navegación izquierda en la sección **[!UICONTROL Customers]**. Se muestra una lista de las audiencias disponibles en su organización. En este ejemplo, las dos audiencias siguientes deben etiquetarse como si contuvieran datos confidenciales de estado:

* Glucosa en sangre > 100
* Insulina &lt;50

Seleccione **[!UICONTROL Blood Glucose >100]** (por el nombre de audiencia, no por la casilla de verificación) para comenzar a etiquetar la audiencia.
...
Aparecerá la pantalla del segmento **[!UICONTROL Details]**. Seleccione **[!UICONTROL Manage Access]**.
...
Aparece el cuadro de diálogo **[!UICONTROL Apply access and data governance labels]**, que le permite elegir las etiquetas que desea aplicar a la audiencia. Para este caso de uso, seleccione la etiqueta **[!UICONTROL PHI/ Regulated Health Data]** y luego seleccione **[!UICONTROL Save]**.
...
Repita los pasos anteriores con **[!UICONTROL Insulin <50]**.
...
Para activar la directiva de control de acceso, seleccione [!UICONTROL Permissions] en el panel de navegación izquierdo y luego seleccione **[!UICONTROL Policies]**.

![Lista de directivas mostrada](../images/abac-end-to-end-user-guide/abac-policies-page.png)

A continuación, seleccione los puntos suspensivos (`...`) junto a **[!UICONTROL Default-Field-Level-Access-Control-Policy]** y aparecerá un menú desplegable con controles para editar, activar, eliminar o duplicar la función. Seleccione **[!UICONTROL Activate]** de la lista desplegable.

![Menú desplegable para activar la directiva](../images/abac-end-to-end-user-guide/abac-policies-activate.png)

Aparecerá el cuadro de diálogo Activar directiva, que le pedirá que confirme la activación. Seleccione **[!UICONTROL Confirm]**.

![Activar diálogo de directiva](../images/abac-end-to-end-user-guide/abac-activate-policies-dialog.png)

Se recibe la confirmación de la activación de la directiva y se le devuelve a la página [!UICONTROL Policies].
