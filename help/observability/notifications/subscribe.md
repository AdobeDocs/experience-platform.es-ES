...
title: Suscripción a Notificaciones de Evento de Adobe I/O
...
Para recibir [!DNL I/O Event] notificaciones, debe registrar un enlace web especificando una URL de enlace web única como parte de los detalles de registro de evento.

Puede configurar su webgancho con el cliente que desee. Para que una dirección de webgancho temporal se utilice como parte de este tutorial, visite [Webhang.site](https://webhook.site/) y copie la dirección URL única proporcionada.

![](../images/notifications/webhook-url.png)

Durante el proceso de validación inicial, [!DNL I/O Events] envía un parámetro de consulta `challenge` en una solicitud de GET al enlace web. Debe configurar su webgancho para que devuelva el valor de este parámetro en la carga útil de respuesta. Si está utilizando Weblink.site, seleccione **[!DNL Edit]** en la esquina superior derecha y luego ingrese `$request.query.challenge$` en **[!DNL Response body]** antes de seleccionar **[!DNL Save]**.
...
* Si está suscrito a [!DNL Experience Platform] notificaciones, seleccione **[!UICONTROL Notificaciones de plataforma]**
...
A efectos de este tutorial, se sigue la primera opción. Seleccione el cuadro de opciones para **[!UICONTROL Generar un par de claves]** y luego seleccione el botón **[!UICONTROL Generar par de claves]** en la esquina inferior derecha.
...
En la siguiente pantalla, proporcione un nombre y una descripción para el registro de eventos en la sección [!UICONTROL Detalles del registro de Eventos]. Lo mejor es crear un nombre único y fácilmente identificable para ayudar a diferenciar este registro de eventos de otros en el mismo proyecto.

![](../images/notifications/registration-details.png)

Más abajo en la misma pantalla en la sección [!UICONTROL Cómo recibir eventos], puede configurar opcionalmente cómo recibir eventos. **** Webhookpermite proporcionar una dirección personalizada de enlace web para recibir eventos, mientras que  **[!UICONTROL la acción]** de tiempo de ejecución le permite hacer lo mismo con  [Adobe I/O Runtime](https://www.adobe.io/apis/experienceplatform/runtime/docs.html).

Para este tutorial, seleccione **[!UICONTROL Webgancho]** y proporcione la dirección URL del webgancho que creó anteriormente. Una vez que haya terminado, seleccione **[!UICONTROL Guardar eventos configurados]** para completar el registro de evento.
...
Consulte la [[!DNL Observability Insights] información general](../home.md) para obtener más información sobre cómo puede monitorear sus actividades en [!DNL Experience Platform] y [!DNL Privacy Service].