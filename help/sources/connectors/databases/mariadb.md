...
La siguiente documentación proporciona información sobre cómo conectar [!DNL MariaDB] a [!DNL Experience Platform] mediante API o la interfaz de usuario:

## Conectar [!DNL MariaDB] a [!DNL Experience Platform] mediante API
...
## Conectar [!DNL MariaDB] a [!DNL Experience Platform] mediante la interfaz de usuario
