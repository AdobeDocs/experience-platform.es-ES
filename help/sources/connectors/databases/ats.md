...
Experience Platform permite la ingesta de datos desde una base de datos de terceros. Platform puede conectarse a diferentes tipos de bases de datos, como relacional, sinSQL o data warehouse. La compatibilidad con los proveedores de bases de datos incluye [!DNL Azure Table Storage].
...
## Connect [!DNL Azure Table Storage] a Platform mediante la interfaz de usuario
