...
La siguiente documentación proporciona información sobre cómo conectar [!DNL Phoenix] a [!DNL Platform] mediante API o la interfaz de usuario:

## Connect [!DNL Phoenix] a [!DNL Platform] uso de API
...
## Connect [!DNL Phoenix] a [!DNL Platform] uso de la interfaz de usuario
