...
Experience Platform proporciona soporte para la ingesta de datos desde una base de datos de terceros. Platform puede conectarse a diferentes tipos de bases de datos, como relacional, sinSQL o datas warehouses. La compatibilidad con proveedores de bases de datos incluye Phoenix.

La siguiente documentación proporciona información sobre cómo conectar Phoenix a Platform mediante API o la interfaz de usuario:

## Conectar Phoenix a Platform mediante API
...
## Conectar Phoenix a Platform mediante la interfaz de usuario
