...
title: Información general del conector de origen Phoenix
topic: overview
...
[!DNL Experience Platform] permite la ingesta de datos desde una base de datos de terceros. [!DNL Platform] puede conectarse a diferentes tipos de bases de datos, como relacional, sinSQL o almacenes de datos. La compatibilidad con proveedores de bases de datos incluye [!DNL Phoenix].
...
- [Creación de una conexión de origen Phoenix mediante la API de servicio de flujo](../../tutorials/api/create/databases/phoenix.md)
...
- [Creación de una conexión de origen Phoenix en la interfaz de usuario](../../tutorials/ui/create/databases/phoenix.md)
