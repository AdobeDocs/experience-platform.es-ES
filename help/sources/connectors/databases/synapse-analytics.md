...
title: Conector de Analytics de sincronización de Azure
topic: overview
...
[!DNL Experience Platform] permite la ingesta de datos desde una base de datos de terceros. [!DNL Platform] puede conectarse a diferentes tipos de bases de datos, como relacional, sinSQL o datas warehouses. La compatibilidad con proveedores de base de datos incluye [!DNL Azure Synapse Analytics].
...
- [Creación de un conector de Analytics de sincronización de Azure mediante la API de servicio de flujo](../../tutorials/api/create/databases/synapse-analytics.md)
...
- [Creación de un conector de origen de Analytics de sincronización de Azure en la interfaz de usuario](../../tutorials/ui/create/databases/synapse-analytics.md)
