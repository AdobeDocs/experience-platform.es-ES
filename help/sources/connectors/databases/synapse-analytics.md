...
La siguiente documentación proporciona información sobre cómo conectar [!DNL Azure Synapse Analytics] a [!DNL Platform] mediante API o la interfaz de usuario:

## Connect [!DNL Azure Synapse Analytics] a [!DNL Platform] uso de API
...
## Connect [!DNL Azure Synapse Analytics] a [!DNL Platform] uso de la interfaz de usuario
