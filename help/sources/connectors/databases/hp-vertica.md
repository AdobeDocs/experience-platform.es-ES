...
title: Información general del conector de origen vertical HP
topic: overview
description: Obtenga información sobre cómo conectar HP Vertica a Adobe Experience Platform mediante API o la interfaz de usuario.
...
>[!NOTE]
>
>El conector [!DNL HP Vertica] está en versión beta. Consulte la [información general de las fuentes](../../home.md#terms-and-conditions) para obtener más información sobre el uso de conectores con etiquetas beta.
...
La documentación siguiente proporciona información sobre cómo conectar [!DNL HP Vertica] a [!DNL Platform] mediante API o la interfaz de usuario:

## Conectar [!DNL HP Vertica] a [!DNL Platform] mediante API

- [Creación de una conexión de origen HP Vertica mediante la API de servicio de flujo](../../tutorials/api/create/databases/hp-vertica.md)
...
- [Creación de una conexión de origen HP Vertica en la interfaz de usuario](../../tutorials/ui/create/databases/hp-vertica.md)
