...
topic: overview
description: La siguiente documentación proporciona información sobre cómo conectar Apache Spark en Azure HDInsights a Platform mediante API o la interfaz de usuario.
...
# (Beta) [!DNL Apache Spark] en el [!DNL Azure HDInsights] conector
...
[!DNL Experience Platform] permite la ingesta de datos desde una base de datos de terceros. [!DNL Platform] puede conectarse a diferentes tipos de bases de datos, como relacional, sinSQL o almacenes de datos. La compatibilidad con los proveedores de bases de datos incluye [!DNL Apache Spark] en [!DNL Azure HDInsights].
...
La siguiente documentación proporciona información sobre cómo conectarse [!DNL Apache Spark] a [!DNL Azure HDInsights] [!DNL Platform] través de API o de la interfaz de usuario:

## Conectar [!DNL Apache Spark] a [!DNL Azure HDInsights][!DNL Platform] mediante API
...
## Conectar [!DNL Apache Spark] con [!DNL Azure HDInsights] la [!DNL Platform] IU

- [Crear una chispa Apache en el conector de origen de Azure HDInsights en la interfaz de usuario](../../tutorials/ui/create/databases/spark.md)
