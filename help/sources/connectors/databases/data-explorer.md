...
Se admiten diferentes tipos de bases de datos de terceros, incluyendo relacional, NoSQL o datas warehouses. La compatibilidad con proveedores de bases de datos incluye el Explorador de datos de Azure.

La siguiente documentación proporciona información sobre cómo conectar el Explorador de datos de Azure a Platform mediante API o la interfaz de usuario:

## Conectar el Explorador de datos de Azure a Platform mediante API
...
## Conectar el Explorador de datos de Azure a Platform mediante la interfaz de usuario
