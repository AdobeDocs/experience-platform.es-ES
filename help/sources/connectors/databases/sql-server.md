...
title: Información general del conector de SQL Server Source
...
# Conector de SQL Server [!DNL Microsoft]
...
[!DNL Experience Platform] proporciona soporte para la ingesta de datos desde una base de datos de terceros. [!DNL Experience Platform] puede conectarse a diferentes tipos de bases de datos, como relacionales, NoSQL o almacenes de datos. La compatibilidad con los proveedores de bases de datos incluye [!DNL Microsoft] SQL Server.
...
La siguiente documentación proporciona información sobre cómo conectar [!DNL Microsoft] SQL Server a [!DNL Experience Platform] mediante API o la interfaz de usuario:

## Conectar [!DNL Microsoft] SQL Server a [!DNL Experience Platform] mediante API

- [Crear una conexión base de Microsoft SQL Server mediante la API de Flow Service](../../tutorials/api/create/databases/sql-server.md)
...
## Conectar [!DNL Microsoft] SQL Server a [!DNL Experience Platform] mediante la interfaz de usuario

- [Crear una conexión de origen de Microsoft SQL Server en la IU](../../tutorials/ui/create/databases/sql-server.md)
