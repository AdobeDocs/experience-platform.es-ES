...
# (Beta) [!DNL Microsoft] Conector de SQL Server
...
La documentación siguiente proporciona información sobre cómo conectar [!DNL Microsoft] SQL Server con [!DNL Platform] mediante API o la interfaz de usuario:

## Conectar [!DNL Microsoft] SQL Server con [!DNL Platform] mediante API
...
- [Creación de una conexión de origen de Microsoft SQL Server en la interfaz de usuario](../../tutorials/ui/create/databases/sql-server.md)
