...
topic: overview
description: La siguiente documentación proporciona información sobre cómo conectar Amazon Redshift a la plataforma mediante API o la interfaz de usuario.
...
[!DNL Experience Platform] permite la ingesta de datos desde una base de datos de terceros. [!DNL Platform] puede conectarse a diferentes tipos de bases de datos, como relacional, sinSQL o almacenes de datos. La compatibilidad con proveedores de base de datos incluye [!DNL Amazon Redshift].
...
La documentación siguiente proporciona información sobre cómo conectarse [!DNL Amazon Redshift] a [!DNL Platform] través de API o de la interfaz de usuario:

## Conectar [!DNL Amazon Redshift] a [!DNL Platform] mediante API
...
## Conectar [!DNL Amazon Redshift] a [!DNL Platform] mediante la interfaz de usuario
