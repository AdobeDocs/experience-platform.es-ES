...
title: Información general sobre el conector Oracle Source
...
La siguiente documentación proporciona información sobre cómo conectar [!DNL Oracle] a [!DNL Experience Platform] mediante API o la interfaz de usuario:
