...
Se admiten diferentes tipos de bases de datos de terceros, incluyendo relacional, NoSQL o datas warehouses. La compatibilidad con proveedores de bases de datos incluye [!DNL Oracle].
...
La documentación siguiente proporciona información sobre cómo conectarse [!DNL Oracle] a [!DNL Platform] través de API o de la interfaz de usuario:

## Conectar [!DNL Oracle] a [!DNL Platform] mediante API
...
## Conectar [!DNL Oracle] a [!DNL Platform] mediante la interfaz de usuario
