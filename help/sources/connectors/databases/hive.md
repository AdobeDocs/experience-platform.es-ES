...
>[!NOTE]
>
>El Apache Hive del conector Azure HDInsights está en versión beta. Consulte la [información general sobre fuentes](../../home.md#terms-and-conditions) para obtener más información sobre el uso de conectores con etiqueta beta.
...
La documentación siguiente proporciona información sobre cómo conectar [!DNL Apache Hive] en [!DNL Azure HDInsights] a [!DNL Platform] mediante API o la interfaz de usuario:
