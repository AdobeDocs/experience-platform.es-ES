...
La plataforma de experiencias ofrece compatibilidad para la ingesta de datos desde una base de datos de terceros. La plataforma puede conectarse a diferentes tipos de bases de datos, como relacional, sinSQL o data warehouses. Los proveedores de bases de datos admiten Apache Hive en Azure HDInsights.

La siguiente documentación proporciona información sobre cómo conectar Apache Hive en Azure HDInsights a Platform mediante API o la interfaz de usuario:
...
## Conectar Apache Hive en Azure HDInsights a Platform mediante la interfaz de usuario
