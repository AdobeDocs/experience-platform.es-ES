...
## Configurar el origen de [!DNL Amazon S3] para el Experience Platform en Azure {#azure}
...
## Configurar el origen de [!DNL Amazon S3] para el Experience Platform en Amazon Web Service {#aws}
...
Una vez configurados los permisos, vuelva al catálogo de orígenes en la interfaz de usuario de Experience Platform y vaya a la página de configuración de orígenes de [!DNL Amazon S3]. Proporcione el nombre del bloque [!DNL Amazon S3] al que desea conectarse y, si corresponde, proporcione la ruta a la carpeta específica dentro del bloque. Para comprobar la configuración, seleccione **[!UICONTROL Probar conexión]**. Si lo consigue, puede continuar y [crear un flujo de datos para introducir datos de almacenamiento en la nube en el Experience Platform](../../tutorials/ui/dataflow/batch/cloud-storage.md).

## Pasos siguientes

La siguiente documentación proporciona información sobre cómo conectar [!DNL Amazon S3] al Experience Platform mediante API o la interfaz de usuario:

### Conectar [!DNL Amazon S3] al Experience Platform mediante la API

- [Conecte Amazon S3 a Experience Platform mediante la API de Flow Service](../../tutorials/api/create/cloud-storage/s3.md)
...
### Conectar [!DNL Amazon S3] al Experience Platform mediante la interfaz de usuario
