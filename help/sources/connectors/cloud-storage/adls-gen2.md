...
La documentación siguiente proporciona información sobre cómo conectarse [!DNL Azure Data Lake Storage Gen2] a [!DNL Platform] través de API o de la interfaz de usuario:
