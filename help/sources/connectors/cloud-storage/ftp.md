...
title: Información general sobre el conector Source FTP
...
La siguiente documentación proporciona información sobre cómo conectar un servidor FTP a [!DNL Experience Platform] mediante API o la interfaz de usuario:
