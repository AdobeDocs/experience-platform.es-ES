...
La documentación siguiente proporciona información sobre cómo conectar un servidor FTP a [!DNL Platform] mediante API o la interfaz de usuario:

### Uso de las API

- [Creación de una conexión de origen FTP mediante la API de servicio de flujo](../../tutorials/api/create/cloud-storage/ftp.md)
