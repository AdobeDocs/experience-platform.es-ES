...
Adobe Experience Platform proporciona conectividad nativa para proveedores de nube como AWS, [!DNL Google Cloud Platform], lo que le permite introducir datos de estos sistemas en Platform para su uso en servicios y destinos descendentes.

Las fuentes de almacenamiento en la nube pueden llevar sus datos a Platform sin necesidad de descargar, formatear o cargar. Los datos introducidos pueden tener el formato XDM JSON, XDM Parquet o delimitados. Cada paso del proceso se integra en el flujo de trabajo de fuentes. Platform le permite incorporar datos de [!DNL Oracle Object Storage] por lotes.

## LISTA DE PERMITIDOS de direcciones IP

Se debe agregar una lista de direcciones IP a una lista de permitidos antes de trabajar con conectores de origen. Si no agrega las direcciones IP específicas de su región a su lista de permitidos, puede que se produzcan errores o que no se produzca un rendimiento al utilizar fuentes. Consulte el documento [IP address lista de permitidos](../../ip-address-allow-list.md) para obtener más información.
...
## Conectar [!DNL Oracle Object Storage] a Platform
...
- [Creación de una conexión de origen de almacenamiento de objetos de Oracle mediante la API de servicio de flujo](../../tutorials/api/create/cloud-storage/oracle-object-storage.md)
