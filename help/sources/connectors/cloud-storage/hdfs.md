...
title: Información general sobre el conector Source Apache HDFS
...
La siguiente documentación proporciona información sobre cómo conectar [!DNL Apache] HDFS a [!DNL Experience Platform] mediante API o la interfaz de usuario:
