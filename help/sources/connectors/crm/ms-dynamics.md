...
topic: overview
description: La siguiente documentación proporciona información sobre cómo conectar Microsoft Dynamics a la plataforma mediante API o la interfaz de usuario.
