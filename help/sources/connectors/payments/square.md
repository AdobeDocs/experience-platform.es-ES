...
Experience Platform proporciona asistencia para la ingesta de datos desde una aplicación de pagos de terceros. La compatibilidad con proveedores de pagos incluye [!DNL Square].
...
## Conectar [!DNL Square] a Platform mediante API
...
## Conectar [!DNL Square] a Platform mediante la interfaz de usuario
