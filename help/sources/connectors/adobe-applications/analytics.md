...
| Nuevos datos para el Customer Journey Analytics sin [unión](https://experienceleague.adobe.com/docs/analytics-platform/using/stitching/overview.html?lang=en) | &lt; 3,75 horas |
...
Para obtener más información sobre las latencias del Customer Journey Analytics, consulte: [Protecciones del Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-admin/guardrails.html?lang=en).
