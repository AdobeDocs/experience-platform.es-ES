...
| Nuevos datos en [!DNL Real-Time Customer Profile] (A4T) **es** enabled) | &lt; 15 minutos |
| Nuevos datos en Data Lake | &lt; 90 minutos |
| Relleno de menos de 10 000 millones de eventos | &lt; 4 semanas |

Los rellenos de Analytics tienen un valor predeterminado de 13 meses. El límite de 10 000 millones de eventos mencionado en el cuadro anterior se aplica estrictamente a la latencia esperada.
