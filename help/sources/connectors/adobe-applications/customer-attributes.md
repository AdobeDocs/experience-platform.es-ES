...
Puede establecer el área de nombres `CORE` estableciendo el Experience Cloud ID para el visitante mediante [Web SDK](/help/collection/use-cases/identity/id-overview.md), [Mobile SDK](https://developer.adobe.com/client-sdks/documentation/mobile-core/identity/) o [la API del servicio de Experience Cloud ID](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=es).
