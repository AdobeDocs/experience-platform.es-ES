---
keywords: Experience Platform;inicio;temas populares;orígenes;recopilación de datos
...
La integración de fuentes de recopilación de datos de Adobe Experience Platform le permite acceder a los datos en Edge Network, incluida la preparación para la recopilación de datos, así como mejorar la compatibilidad con las advertencias, a través del catálogo de fuentes.
...
La IU de recopilación de datos aparece en la ficha **[!UICONTROL Datastreams]**.
