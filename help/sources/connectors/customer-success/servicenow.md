...
title: Información general sobre el conector de origen ServiceNow
...
[!DNL Experience Platform] proporciona asistencia para la ingesta de datos desde un sistema de éxito de clientes de terceros. Los proveedores de éxito de los clientes incluyen [!DNL ServiceNow].

## LISTA DE PERMITIDOS de direcciones IP

Se debe agregar una lista de direcciones IP a una lista de permitidos antes de trabajar con conectores de origen. Si no se agregan las direcciones IP específicas de la región a la lista de permitidos, pueden producirse errores o no rendimiento al utilizar fuentes. Consulte la [LISTA DE PERMITIDOS de direcciones IP](../../ip-address-allow-list.md) para obtener más información.

La siguiente documentación proporciona información sobre cómo conectarse [!DNL ServiceNow] hasta [!DNL Platform] mediante las API de o la interfaz de usuario de:

## Connect [!DNL ServiceNow] hasta [!DNL Platform] uso de API
...
## Connect [!DNL ServiceNow] hasta [!DNL Platform] uso de la IU
