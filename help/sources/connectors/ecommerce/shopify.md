...
La siguiente documentación proporciona información sobre cómo conectar [!DNL Shopify] a [!DNL Experience Platform] mediante API o la interfaz de usuario:

## Conectar [!DNL Shopify] a [!DNL Experience Platform] mediante API
...
## Conectar [!DNL Shopify] a [!DNL Experience Platform] mediante la interfaz de usuario
