...
title: (Beta) Información General Sobre El Origen De Responsys De Oracle
...
>[!NOTE]
>
>El [!DNL Oracle Responsys] el origen está en versión beta. Consulte la [Resumen de orígenes](../../home.md#terms-and-conditions) para obtener más información sobre el uso de fuentes etiquetadas como beta.
...
[!DNL Oracle Responsys] es una plataforma de administración de campañas en canales múltiples que le permite ofrecer inteligencia avanzada a escala y crear mensajes personalizados que se ajusten a los intereses y preferencias específicos de sus clientes.

Experience Platform proporciona asistencia para la ingesta de datos desde un sistema de automatización de marketing de terceros. La compatibilidad con proveedores de automatización de marketing incluye [!DNL Oracle Responsys].

## LISTA DE PERMITIDOS de direcciones IP

Se debe agregar una lista de direcciones IP a una lista de permitidos antes de trabajar con conectores de origen. Si no se agregan las direcciones IP específicas de la región a la lista de permitidos, pueden producirse errores o no rendimiento al utilizar fuentes. Consulte la [LISTA DE PERMITIDOS de direcciones IP](../../ip-address-allow-list.md) para obtener más información.

La siguiente documentación proporciona información sobre cómo conectarse [!DNL Oracle Responsys] Vaya a Platform mediante las API o la interfaz de usuario de:

## Connect [!DNL Oracle Responsys] a Platform mediante API
...
## Connect [!DNL Oracle Responsys] a Platform mediante la IU
