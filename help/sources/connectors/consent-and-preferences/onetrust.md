...
El Experience Platform de proporciona asistencia para la ingesta de datos desde una plataforma de administración de preferencias y consentimiento de terceros. Los proveedores de preferencias y consentimiento incluyen [!DNL OneTrust Integration].
...
## Conectar [!DNL OneTrust Integration] a Platform mediante API
...
## Conectar [!DNL OneTrust Integration] a Platform mediante la interfaz de usuario
