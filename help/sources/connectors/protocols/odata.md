...
[!DNL Experience Platform] proporciona soporte para la ingesta de datos desde una aplicación de protocolos de terceros. La compatibilidad con los proveedores de protocolos incluye [!DNL Generic OData].
