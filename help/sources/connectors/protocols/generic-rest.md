...
Platform proporciona compatibilidad para la ingesta de datos de aplicaciones de protocolos, incluido [!DNL Generic REST API].

El origen [!DNL Generic REST API] le permite traer datos de aplicaciones basadas en REST a Platform. [!DNL Generic REST API] admite la autenticación básica y la autenticación basada en código de actualización de OAuth 2.

## LISTA DE PERMITIDOS de direcciones IP

Se debe agregar una lista de direcciones IP a una lista de permitidos antes de trabajar con conectores de origen. Si no se agregan las direcciones IP específicas de la región a la lista de permitidos, pueden producirse errores o no rendimiento al utilizar fuentes. Consulte la página [lista de permitidos de direcciones IP](../../ip-address-allow-list.md) para obtener más información.

La siguiente documentación proporciona información sobre cómo conectar un origen de [!DNL Generic REST API] a Platform mediante API.

## Conectar [!DNL Generic REST API] a [!DNL Platform] mediante API
