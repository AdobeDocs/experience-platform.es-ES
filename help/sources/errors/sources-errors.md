...
| `1014-400` | Solicitud incorrecta, argumento ilegal | No se ha podido procesar la solicitud. {detailedMessage} |
...
| `1203-400` | Solicitud incorrecta | La clave de cifrado no existe con el keyID={keyID} en las transformaciones del flujo={transformations}. Compruebe el KeyID proporcionado e inténtelo de nuevo. |
...
| Código de error | Título | Mensaje detallado |
| --- | --- | --- |
| `1300-400` | Solicitud incorrecta | La solicitud de conexión de revisión no es compatible con el conector {connectorType}. Compruebe la solicitud proporcionada e inténtelo de nuevo. |
...
| `1302-400` | Solicitud incorrecta | El tipo de autenticación proporcionado = {authType} no es compatible con el conector={connectorType}. Proporcione un tipo de autenticación válido para el conector determinado. |
| `1303-400` | Solicitud incorrecta | No se pudo codificar la dirección URL con los parámetros de autenticación proporcionados porque no se admite la codificación de la dirección URL para {value}. Compruebe los parámetros de autenticación e inténtelo de nuevo. |
| `1304-400` | Solicitud incorrecta | No se ha proporcionado el campo obligatorio {field}. Proporcione el {field} e inténtelo de nuevo. |
...
| `1315-400` | Solicitud incorrecta | La ruta de acceso {path} proporcionada debe apuntar a una matriz de registros. Asegúrese de que la ruta proporcionada apunta a la matriz de registros e inténtelo de nuevo. |
...
| `1323-400` | Solicitud incorrecta | {entity} no puede ser nulo ni estar vacío en la conexión de origen: {sourceConnection}. Proporcione un {entity} válido e inténtelo de nuevo. |
...
| `1328-400` | Solicitud incorrecta | La transformación de asignación no puede ser nula al extraer {param}. Proporcione una transformación de asignación válida e inténtelo de nuevo. |
...
| `1333-400` | Solicitud incorrecta | flowRunAction={flowRunAction} no es compatible con el origen con id. de especificación={specId}. Proporcione una acción de ejecución de flujo válida e inténtelo de nuevo. |
...
| `1336-400` | Solicitud incorrecta | La conexión Explorar no es compatible con el id. de especificación de conexión: {connectionSpecId}. Proporcione el ID de especificación de conexión compatible e inténtelo de nuevo. |
...
| `1344-400` | Solicitud incorrecta | La definición de &#39;dls:partitionSpec&#39; en &#39;odi.json&#39; no es válida porque se encontró más de un partitionSpecs. Proporcione las definiciones adecuadas en &quot;odi.json&quot; e inténtelo de nuevo. |
...
| `1363-400` | Solicitud incorrecta | No se permite el intervalo {interval} con la frecuencia: {frequency}. Proporcione un valor de intervalo válido e inténtelo de nuevo. |
...
| `1365-400` | Solicitud incorrecta | La ruta de acceso {path} proporcionada en operaciones no es válida. Proporcione una ruta de acceso válida {path} e inténtelo de nuevo. |
...
| `1371-400` | Solicitud incorrecta | No se admite la detección de propiedades de archivo para el conector {connectorType}. Proporcione las propiedades del archivo manualmente. |
...
| `1392-400` | Solicitud incorrecta | No se pudieron analizar las transformaciones en la solicitud de flujo para flowId={flowId}. Compruebe las transformaciones en la solicitud e inténtelo de nuevo. |
| `1393-400` | Solicitud incorrecta | El parámetro proporcionado {parameter} es nulo o está vacío. Proporcione un {parameter} válido e inténtelo de nuevo. |
...
| `1706-400` | Solicitud incorrecta | La configuración de activaciones permitidas no está configurada correctamente para la zona de aterrizaje={landingZoneType}. Vuelva a intentarlo y, si el problema persiste, póngase en contacto con el servicio de atención al cliente. |
...
| `1710-400` | Solicitud incorrecta | No se admite la zona de aterrizaje de tipo {landingZoneUseCase} proporcionada. Proporcione un tipo de zona de aterrizaje válido e inténtelo de nuevo. |
| `1711-400` | Solicitud incorrecta | No se encontraron los detalles SAS para la zona de aterrizaje de datos proporcionada del tipo: {landingZoneUseCase}. Compruebe si se proporcionan detalles SAS para el tipo de zona de aterrizaje proporcionado. |
| `1712-400` | Solicitud incorrecta | La acción de zona de aterrizaje proporcionada: {actionType} no está permitida. Proporcione una acción de zona de aterrizaje de datos válida e inténtelo de nuevo. |
| `1713-400` | Solicitud incorrecta | No se permite {OperationType} para el(la) {tokenType} proporcionado(a). Compruebe su solicitud e inténtelo de nuevo. |
| `1714-400` | Solicitud incorrecta | clientId={clientId} no puede realizar esta operación. Compruebe su solicitud con permisos e inténtelo de nuevo. |
