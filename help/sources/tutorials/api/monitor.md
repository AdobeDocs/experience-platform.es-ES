...
Las secciones siguientes proporcionan información adicional que deberá conocer para poder supervisar correctamente las ejecuciones de flujo mediante la [!DNL Flow Service] API.
