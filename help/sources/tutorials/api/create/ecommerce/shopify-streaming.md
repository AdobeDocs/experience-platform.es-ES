...
# Crear una conexión de origen de flujo continuo y un flujo de datos para [!DNL Shopify] datos mediante la API de Flow Service

>[!NOTE]
>
>El [!DNL Shopify] la fuente de streaming está en versión beta. Lea el [información general de orígenes](../../../../home.md#terms-and-conditions) para obtener más información sobre el uso de fuentes etiquetadas como beta.
...
## Transmitir [!DNL Shopify] datos a Platform mediante la API de Flow Service

A continuación se describen los pasos que debe seguir para crear una conexión de origen y un flujo de datos para transmitir el flujo de trabajo [!DNL Shopify] datos a Platform.
...
| `data.format` | El formato del [!DNL Shopify] datos que desea introducir. Actualmente, el único formato de datos admitido es `json`. |
...
| `data.format` | El formato del [!DNL Shopify] datos que desee llevar a Platform. |
...
El último paso para obtener datos de [!DNL Shopify] a Platform es crear un flujo de datos. Por ahora, tiene preparados los siguientes valores obligatorios:
...
Actualice los detalles del flujo de datos, como su nombre y descripción, así como su programación de ejecución y los conjuntos de asignaciones asociados, realizando una solicitud del PATCH a `/flows` punto final del [!DNL Flow Service] API, mientras proporciona el ID del flujo de datos. Al realizar una solicitud de PATCH, debe proporcionar la variable única del flujo de datos `etag` en el `If-Match` encabezado. Para ver ejemplos completos de la API, lea la guía de [actualización de flujos de datos de origen mediante la API](https://experienceleague.adobe.com/docs/experience-platform/sources/api-tutorials/update-dataflows.html)
