...
Para crear un identificador de conexión base con el código de actualización de OAuth 2, realice una petición POST al extremo `/connections` y proporcione sus credenciales de OAuth 2.
...
Para crear una conexión base de [!DNL Generic REST API] con autenticación básica, realice una petición POST al extremo `/connections` de la API [!DNL Flow Service] y proporcione sus credenciales de autenticación básicas.
