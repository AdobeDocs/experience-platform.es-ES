...
## Conectar [!DNL Pendo] a la plataforma mediante la API [!DNL Flow Service] {#connect-platform-to-flow-api}

A continuación se describen los pasos que debe seguir para crear una conexión de origen y un flujo de datos que lleve los datos de eventos de [!DNL Pendo] al Experience Platform.
...
El último paso para llevar datos de [!DNL Pendo] a Platform es crear un flujo de datos. Por ahora, tiene preparados los siguientes valores obligatorios:
