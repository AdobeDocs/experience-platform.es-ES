---
title: Crear una conexión de origen y un flujo de datos para Pendo mediante la API de servicio de flujo
description: Obtenga información sobre cómo conectar Adobe Experience Platform a Pendo mediante la API de servicio de flujo.
badge: "Beta"
...
# Crear una conexión de origen y un flujo de datos para [!DNL Pendo] uso de la API de servicio de flujo
...
El siguiente tutorial le guía por los pasos para crear una conexión de origen y un flujo de datos para [[!DNL Pendo]](https://Pendo.com/) datos de evento a Adobe Experience Platform mediante la variable [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
## Connect [!DNL Pendo] a Platform que utiliza la variable [!DNL Flow Service] API {#connect-platform-to-flow-api}

A continuación, se describen los pasos que debe seguir para crear una conexión de origen y un flujo de datos que le lleven a su [!DNL Pendo] datos de eventos a Experience Platform.
...
| `data.format` | El formato de la variable [!DNL Pendo] datos que desea ingerir. Actualmente, el único formato de datos admitido es `json`. |
...
| `data.format` | El formato de la variable [!DNL Pendo] datos que desea ingerir. |
...
El último paso para obtener datos de [!DNL Pendo] a Platform es crear un flujo de datos. A partir de ahora, se han preparado los siguientes valores obligatorios:
...
Una respuesta correcta devuelve información sobre su flujo de datos, incluida la dirección URL del extremo, marcada como `inletUrl`. Consulte la [Configuración de Weblock](../../../ui/create/analytics/pendo-webhook.md#get-streaming-endpoint-url) para obtener el valor requerido.
