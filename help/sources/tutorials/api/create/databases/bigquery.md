...
# Cree un conector [!DNL Google BigQuery] mediante la API [!DNL Flow Service]
...
Para que [!DNL Flow Service] se conecte con BigQuery, debe proporcionar las siguientes propiedades de conexión:
