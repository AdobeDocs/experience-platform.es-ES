...
title: Creación de una conexión base de Teradata Vantage mediante la API de Flow Service
description: Aprenda a conectar Adobe Experience Platform al Teradata Vantage mediante la API de Flow Service.
