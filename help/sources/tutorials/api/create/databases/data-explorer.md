---
keywords: Experience Platform;inicio;temas populares;Azure Data Explorer;Azure Data Explorer;Azure Data Explorer
solution: Experience Platform
title: Crear una conexión base de Azure Data Explorer mediante la API de Flow Service
type: Tutorial
description: Obtenga información sobre cómo conectar Azure Data Explorer a Adobe Experience Platform mediante la API de Flow Service.
...
Para crear un identificador de conexión base, realice una petición POST al extremo `/connections` y proporcione sus credenciales de autenticación [!DNL Azure Data Explorer] como parte de los parámetros de solicitud.
