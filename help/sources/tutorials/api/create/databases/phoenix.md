...
Debe proporcionar las siguientes credenciales de autenticación para conectar su cuenta de [!DNL Phoenix] al Experience Platform.
...
Para crear una conexión base, realice una solicitud de POST al extremo `/connections` y proporcione las credenciales de autenticación [!DNL Phoenix] en el cuerpo de la solicitud.
