...
Para crear una conexión base autenticada, debe especificar su ID de origen y si se requiere autenticación al realizar una solicitud de POST al `/connections` punto final.
