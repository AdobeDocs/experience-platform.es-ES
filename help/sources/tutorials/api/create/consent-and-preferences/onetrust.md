...
title: (Beta) Cree un flujo de datos para un origen de integración de OneTrust mediante la API de servicio de flujo
...
# (Beta) Cree un flujo de datos para un [!DNL OneTrust Integration] fuente que utiliza la variable [!DNL Flow Service] API
...
| `auth.params.` | Contiene las credenciales necesarias para autenticar el origen. El host raíz y el token de acceso para conectarse a la API. |
| `auth.params.host` | El entorno desde el que se puede [!DNL OneTrust Integration] los datos deben extraerse de . |
...
Se puede crear un esquema XDM de destino realizando una solicitud de POST al [API del Registro de esquemas](https://www.adobe.io/apis/experienceplatform/home/api-reference.html#!acpdr/swagger-specs/schema-registry.yaml).
