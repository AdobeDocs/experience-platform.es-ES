...
Este tutorial le guía por los pasos para crear una conexión base para [!DNL Azure File Storage] mediante la [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
