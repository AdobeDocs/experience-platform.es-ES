...
>[!NOTE]
>El conector del Almacenamiento de archivos de Azure está en versión beta. Las funciones y la documentación están sujetas a cambios.
...
Este tutorial utiliza la API de servicio de flujo para guiarle por los pasos necesarios para conectar el Almacenamiento de archivos de Azure con la plataforma de experiencia.
...
Para crear una conexión de Almacenamiento de archivos de Azure, se debe proporcionar su ID de especificación de conexión única como parte de la solicitud POST. El ID de especificación de conexión para el Almacenamiento de archivos de Azure es `be5ec48c-5b78-49d5-b8fa-7c89ec4569b8`.
