...
Este tutorial proporciona los pasos para crear una conexión base para [!DNL Azure Blob] (en lo sucesivo, &quot;[!DNL Blob]&quot;) utilizando el [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
Para crear un [!DNL Blob] conexión con el URI de firma de acceso compartido, realice una solicitud de POST al [!DNL Flow Service] API mientras proporciona valores para su [!DNL Blob] `sasUri`.
