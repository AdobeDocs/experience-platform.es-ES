...
Si prefiere utilizar la interfaz de usuario en [!DNL Experience Platform], el tutorial [de la interfaz de usuario del conector de origen](../../../ui/create/cloud-storage/blob-s3.md) Azure Blob o Amazon S3 proporciona instrucciones paso a paso para realizar acciones similares.
