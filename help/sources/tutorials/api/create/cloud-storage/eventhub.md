...
Este tutorial le guía por los pasos para conectar [!DNL Azure Event Hubs] (en adelante denominado &quot;[!DNL Event Hubs]&quot;) con el Experience Platform, utilizando la [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
