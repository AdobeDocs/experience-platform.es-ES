...
title: Creación de una conexión de origen HDFS de Apache mediante la API de servicio de flujo
topic: overview
type: Tutorial
...
# Cree una conexión de origen [!DNL Apache] HDFS mediante la API [!DNL Flow Service]
