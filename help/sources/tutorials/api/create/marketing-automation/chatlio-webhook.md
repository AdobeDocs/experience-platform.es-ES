---
title: Crear una conexión de origen y un flujo de datos para Chatlio mediante la API de servicio de flujo
description: Obtenga información sobre cómo conectar Adobe Experience Platform a Chatlio mediante la API de servicio de flujo.
badge: "Beta"
...
# Crear una conexión de origen y un flujo de datos para [!DNL Chatlio] uso de la API de servicio de flujo
...
El siguiente tutorial le guía por los pasos para crear una conexión de origen y un flujo de datos para [[!DNL Chatlio]](https://chatlio.com/) datos de evento a Adobe Experience Platform mediante la variable [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
## Connect [!DNL Chatlio] a Platform que utiliza la variable [!DNL Flow Service] API {#connect-platform-to-flow-api}

A continuación, se describen los pasos que debe seguir para crear una conexión de origen y un flujo de datos que le lleven a su [!DNL Chatlio] datos de eventos a Experience Platform.
...
| `data.format` | El formato de la variable [!DNL Chatlio] datos que desea ingerir. Actualmente, el único formato de datos admitido es `json`. |
...
| `data.format` | El formato de la variable [!DNL Chatlio] datos que desea ingerir. |
...
El último paso para obtener datos de [!DNL Chatlio] a Platform es crear un flujo de datos. A partir de ahora, se han preparado los siguientes valores obligatorios:
...
Una respuesta correcta devuelve información sobre su flujo de datos, incluida la dirección URL del extremo, marcada como `inletUrl`. Consulte la [Configuración de Weblock](../../../ui/create/marketing-automation/chatlio-webhook.md#get-streaming-endpoint-url) para obtener el valor requerido.
