...
## Conectar [!DNL Customer.io] a Experience Platform mediante la API [!DNL Flow Service] {#connect-platform-to-flow-api}

A continuación se describen los pasos que debe seguir para crear una conexión de origen y un flujo de datos que lleve los datos de eventos de [!DNL Customer.io] a Experience Platform.
...
El último paso para llevar datos de [!DNL Customer.io] a Experience Platform es crear un flujo de datos. Por ahora, tiene preparados los siguientes valores obligatorios:
