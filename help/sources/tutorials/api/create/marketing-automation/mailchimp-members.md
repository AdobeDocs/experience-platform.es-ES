...
El siguiente tutorial lo acompañará durante los pasos para crear una conexión de origen y un flujo de datos para llevar datos de [!DNL Mailchimp Members] a Experience Platform mediante la [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
Una vez que haya recuperado sus credenciales de autenticación de [!DNL Mailchimp], ahora puede iniciar el proceso de creación del flujo de datos para llevar los datos de [!DNL Mailchimp Members] a Experience Platform. El primer paso para crear un flujo de datos es crear una conexión base.
