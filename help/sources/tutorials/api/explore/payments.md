...
Debe tener una conexión activa con una aplicación de pagos para explorar los archivos y la estructura de archivos de origen. Lea los siguientes documentos para obtener más información:
...
Con el ID de conexión para su sistema de pagos, puede explorar las tablas de datos realizando solicitudes de GET. Utilice la siguiente llamada para encontrar la ruta de acceso de la tabla que desea inspeccionar o introducir en [!DNL Experience Platform].
...
Una respuesta correcta devuelve una matriz de tablas desde el sistema de pagos. Busque la tabla que desea incluir en [!DNL Experience Platform] y tome nota de su propiedad `path`, ya que debe proporcionarla en el siguiente paso para inspeccionar su estructura.
...
Para inspeccionar la estructura de una tabla desde el sistema de pagos, realice una petición GET y especifique la ruta de una tabla como parámetro de consulta.
...
Siguiendo este tutorial, ha explorado el sistema de pagos, ha encontrado la ruta de la tabla que desea introducir en [!DNL Experience Platform] y ha obtenido información sobre su estructura. Puedes usar esta información en el siguiente tutorial para [recopilar datos de tu sistema de pagos e introducirlos en Experience Platform](../collect/payments.md).
