...
# Explorar un sistema de pago mediante la API de servicio de flujo
...
Este tutorial utiliza la API de servicio de flujo para explorar las aplicaciones de pago.
...
Las secciones siguientes proporcionan información adicional que debe conocer para conectarse correctamente a una aplicación de pagos mediante la API de servicio de flujo.

### Recopilar las credenciales necesarias

Este tutorial requiere que tenga una conexión válida con la aplicación de pagos de terceros desde la que desea ingestar datos. Una conexión válida implica el ID de especificación de conexión y el ID de conexión de la aplicación. Encontrará más información sobre la creación de una conexión de pagos y la recuperación de estos valores en el tutorial [Conectar una fuente de pagos a la plataforma](../../api/create/payments/paypal.md) .
...
Con el ID de conexión del sistema de pagos, puede explorar las tablas de datos realizando solicitudes GET. Utilice la siguiente llamada para encontrar la ruta de la tabla que desea inspeccionar o transferir a Platform.
...
Una respuesta correcta devuelve una matriz de tablas del sistema de pagos. Encuentre la tabla que desee traer a Platform y tome nota de su `path` propiedad, ya que se le pedirá que la proporcione en el próximo paso para inspeccionar su estructura.
...
Para inspeccionar la estructura de una tabla desde el sistema de pagos, realice una solicitud GET mientras especifica la ruta de una tabla como parámetro de consulta.
...
Siguiendo este tutorial, ha explorado su sistema de pagos, ha encontrado la ruta de la tabla que desea transferir a Platform y ha obtenido información sobre su estructura. Puede utilizar esta información en el siguiente tutorial para [recopilar datos de su sistema de pagos y llevarlos a la plataforma](../collect/payments.md).