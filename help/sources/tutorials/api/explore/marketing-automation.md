...
# Explorar un sistema de automatización de marketing mediante la API de servicio de flujo
...
Este tutorial utiliza la API de servicio de flujo para explorar los sistemas de automatización de marketing.
...
Con la conexión base para su sistema de automatización de marketing, puede explorar las tablas de datos realizando solicitudes GET. Utilice la siguiente llamada para encontrar la ruta de la tabla que desea inspeccionar o transferir a Platform.
...
Una respuesta correcta es una matriz de tablas desde a su sistema de automatización de marketing. Encuentre la tabla que desee traer a Platform y tome nota de su `path` propiedad, ya que se le pedirá que la proporcione en el próximo paso para inspeccionar su estructura.
...
Siguiendo este tutorial, ha explorado su sistema de automatización de marketing, ha encontrado la ruta de la tabla que desea traer a Platform y ha obtenido información sobre su estructura. Puede utilizar esta información en el siguiente tutorial para [recopilar datos de su sistema de automatización de marketing y llevarlos a la plataforma](../collect/marketing-automation.md).
