...
Siguiendo este tutorial, ha explorado su sistema CRM, ha encontrado la ruta de la tabla a la que desea acceder [!DNL Platform]y ha obtenido información sobre su estructura. Puede utilizar esta información en el siguiente tutorial para [recopilar datos de su sistema CRM y traerlos a Platform](../collect/crm.md).