...
Con el ID de conexión de la base de datos, puede explorar las tablas de datos realizando solicitudes de GET. Utilice la siguiente llamada para encontrar la ruta de la tabla que desea inspeccionar o en la que desea realizar la ingesta [!DNL Platform].
...
Siguiendo este tutorial, ha explorado la base de datos, ha encontrado la ruta de la tabla en la que desea realizar la ingesta [!DNL Platform]y ha obtenido información sobre su estructura. Puede utilizar esta información en el siguiente tutorial para [recopilar datos de la base de datos e incluirlos en la plataforma](../collect/database-nosql.md).