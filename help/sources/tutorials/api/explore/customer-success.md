...
Para explorar el sistema CSS mediante las API de [!DNL Experience Platform], debe poseer un identificador de conexión base válido. Si todavía no dispone de una conexión base para el sistema CSS con el que desea trabajar, puede crearla mediante los siguientes tutoriales:
...
Con la conexión base del sistema CSS, puede explorar las tablas de datos realizando solicitudes de GET. Utilice la siguiente llamada para encontrar la ruta de acceso de la tabla que desea inspeccionar o introducir en [!DNL Experience Platform].
...
Una respuesta correcta devuelve una matriz de tablas del sistema CSS. Busque la tabla que desea incluir en [!DNL Experience Platform] y tome nota de su propiedad `path`, ya que debe proporcionarla en el siguiente paso para inspeccionar su estructura.
...
Para inspeccionar la estructura de una tabla desde el sistema CSS, realice una petición GET y especifique la ruta de una tabla como parámetro de consulta.
...
Al seguir este tutorial, ha explorado el sistema CSS, ha encontrado la ruta de acceso de la tabla que desea introducir en [!DNL Experience Platform] y ha obtenido información sobre su estructura. Puedes usar esta información en el siguiente tutorial para [recopilar datos de tu sistema CS e introducirlos en Experience Platform](../collect/customer-success.md).
