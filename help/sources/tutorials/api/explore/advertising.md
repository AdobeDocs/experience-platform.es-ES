...
# Explorar un sistema de publicidad mediante la API de servicio de flujo
...
Con la conexión base para su sistema de publicidad, puede explorar las tablas de datos realizando solicitudes GET. Utilice la siguiente llamada para encontrar la ruta de la tabla que desea inspeccionar o transferir a Platform.
...
Una respuesta correcta es una matriz de tablas desde a su sistema de publicidad. Encuentre la tabla que desee traer a Platform y tome nota de su `path` propiedad, ya que se le pedirá que la proporcione en el próximo paso para inspeccionar su estructura.
...
Siguiendo este tutorial, ha explorado su sistema de publicidad, ha encontrado la ruta de la tabla que desea traer a Platform y ha obtenido información sobre su estructura. Puede utilizar esta información en el siguiente tutorial para [recopilar datos de su sistema de publicidad e incluirlos en la plataforma](../collect/advertising.md).
