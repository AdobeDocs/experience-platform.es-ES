...
title: Creación de un flujo de datos para fuentes de automatización de marketing mediante la API de Flow Service
type: Tutorial
description: Este tutorial trata los pasos para recuperar datos de un sistema de automatización de marketing e introducirlos en Adobe Experience Platform mediante conectores de origen y API.
...
# Cree un flujo de datos para los orígenes de automatización de marketing mediante la API [!DNL Flow Service]

Este tutorial trata los pasos para recuperar datos de una fuente de automatización de marketing y llevarlos a Experience Platform mediante [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>* Para crear un flujo de datos, ya debe tener un ID de conexión base válido con una fuente de automatización de marketing. Si no tiene este identificador, vea la [descripción general de orígenes](../../../home.md#marketing-automation) para obtener una lista de orígenes de automatización de marketing con los que puede crear una conexión base.
...
| -------- | ----------- |
| `baseConnectionId` | El ID de conexión único del sistema de automatización de marketing de terceros al que está accediendo. |
| `params.path` | La ruta del archivo de origen al que está accediendo. |
...
Una respuesta correcta devuelve detalles de la asignación recién creada, incluido su identificador único (`id`). Almacene este valor tal y como se requiere en el paso posterior para crear un flujo de datos.
...
Un flujo de datos es responsable de recopilar datos de fuentes y llevarlos a Experience Platform. Para crear un flujo de datos, primero debe obtener las especificaciones del flujo de datos responsables de recopilar datos de automatización de marketing.
...
El último paso para recopilar datos de automatización de marketing es crear un flujo de datos. Por ahora, tiene preparados los siguientes valores obligatorios:
