...
# Cree un flujo de datos para las fuentes de automatización de marketing mediante [!DNL Flow Service] API

Este tutorial explica los pasos para recuperar datos de una fuente de automatización de marketing y llevarlos a Platform mediante [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener un ID de conexión base válido con una fuente de automatización de marketing. Si no tiene este ID, consulte la [información general de orígenes](../../../home.md#marketing-automation) para obtener una lista de fuentes de automatización de marketing con las que puede crear una conexión base.
...
Un flujo de datos es responsable de recopilar datos de fuentes y llevarlos a Platform. Para crear un flujo de datos, primero debe obtener las especificaciones del flujo de datos responsables de recopilar datos de automatización de marketing.
