...
Este tutorial trata los pasos para recuperar datos de una fuente de automatización de marketing y llevarlos a Platform mediante [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
