...
| -------- | ----------- |
| `baseConnectionId` | ID de conexión del origen de la base de datos. |
...
Para que los datos de origen se utilicen en Platform, se debe crear un esquema XDM de destinatario para estructurar los datos de origen según sus necesidades. El esquema destinatario XDM se utiliza para crear un conjunto de datos de plataforma en el que se incluyen los datos de origen. Este esquema XDM de destinatario también extiende la clase [!DNL XDM Individual Profile].
