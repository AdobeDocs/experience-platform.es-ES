...
title: Creación de un flujo de datos para orígenes de protocolos mediante la API de Flow Service
type: Tutorial
description: Este tutorial trata los pasos para recuperar datos de una aplicación de protocolos e ingerirlos en Experience Platform mediante conectores de origen y API.
...
# Crear un flujo de datos para orígenes de protocolos mediante la API [!DNL Flow Service]

Este tutorial trata los pasos para recuperar datos de una fuente de protocolos y llevarlos a Experience Platform mediante [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>* Para crear un flujo de datos, ya debe tener un ID de conexión base válido con un origen de protocolos. Si no tiene este identificador, consulte la [descripción general de orígenes](../../../home.md#protocols) para obtener una lista de orígenes de protocolos con los que puede crear una conexión base.
...
| -------- | ----------- |
| `baseConnectionId` | Id. de conexión de la aplicación de protocolos |
...
Un flujo de datos es responsable de recopilar datos de fuentes y llevarlos a Experience Platform. Para crear un flujo de datos, primero debe obtener las especificaciones del flujo de datos responsables de recopilar datos de la aplicación de protocolos.
...
| `transformations.params.deltaColum` | La columna designada se utiliza para diferenciar entre datos nuevos y existentes. Los datos incrementales se incorporarán en función de la marca de tiempo de la columna seleccionada. El formato admitido para `deltaColumn` al usar OData genérico es `yyyy-MM-ddTHH:mm:ssZ`. |
