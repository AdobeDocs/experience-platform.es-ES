...
type: Tutorial
description: Este tutorial cubre los pasos para recuperar datos de un sistema CRM de terceros y llevarlos a Platform mediante conectores de origen y API.
...
# Cree un flujo de datos para orígenes CRM mediante [!DNL Flow Service] API

Este tutorial trata los pasos para recuperar datos de una fuente CRM y llevarlos a Platform mediante [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener un ID de conexión base válido con un origen CRM. Si no tiene este ID, consulte la [información general de orígenes](../../../home.md#customer-relationship-management) para obtener una lista de orígenes CRM con los que puede crear una conexión base.
...
| `connectionSpec.id` | El ID de especificación de conexión asociado con el sistema CRM de terceros específico. Consulte la [apéndice](#appendix) para obtener una lista de los ID de especificación de conexión. |
...
Un flujo de datos es responsable de recopilar datos de fuentes y llevarlos a Platform. Para crear un flujo de datos, primero debe obtener las especificaciones del flujo de datos responsables de recopilar datos CRM.
