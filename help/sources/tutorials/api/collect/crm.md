...
title: Crear un flujo de datos para orígenes CRM mediante la API de servicio de flujo
...
# Cree un flujo de datos para orígenes CRM usando la variable [!DNL Flow Service] API

Este tutorial trata los pasos para recuperar datos de un origen CRM y llevarlos a Platform mediante [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).

>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener un ID de conexión base válido con un origen CRM. Si no tiene este ID, consulte la [información general sobre fuentes](../../../home.md#customer-relationship-management) para obtener una lista de orígenes CRM con los que puede crear una conexión base.
...
| `connectionSpec.id` | El ID de especificación de conexión asociado al sistema CRM de terceros específico. Consulte la [apéndice](#appendix) para obtener una lista de ID de especificaciones de conexión. |
