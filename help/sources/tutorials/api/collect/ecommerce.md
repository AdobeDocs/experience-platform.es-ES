...
Este tutorial trata los pasos para recuperar datos de una fuente de comercio electrónico y llevarlos a Experience Platform mediante [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
