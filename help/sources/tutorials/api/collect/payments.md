...
Este tutorial trata los pasos para recuperar datos de una aplicación de pago e ingerirlos en la plataforma a través de conectores de origen y API.

## Primeros pasos

Este tutorial requiere que tenga acceso a un sistema de pago a través de una conexión válida, así como información sobre el archivo que desea introducir en Platform (incluyendo la ruta y estructura del archivo). Si no tiene esta información, consulte el tutorial sobre [explorar una aplicación de pagos mediante la API](../explore/payments.md) de servicio de flujo antes de intentar este tutorial.
...
Una respuesta correcta devuelve los detalles de la especificación de flujo de datos que es responsable de llevar los datos de la aplicación de pagos a Platform. Este ID es necesario en el paso siguiente para crear un nuevo flujo de datos.
