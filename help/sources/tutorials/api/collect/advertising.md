...
title: Creación de un flujo de datos para fuentes de publicidad mediante la API de Flow Service
type: Tutorial
...
# Cree un flujo de datos para fuentes publicitarias utilizando [!DNL Flow Service] API

Este tutorial explica los pasos para recuperar datos de una aplicación de publicidad de terceros e ingerirlos en Adobe Experience Platform a través de conectores de origen y la [[!DNL Flow Service]](https://www.adobe.io/experience-platform-apis/references/flow-service/) API.
