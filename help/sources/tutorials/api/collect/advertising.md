...
En este tutorial se explican los pasos para recuperar datos de una aplicación de publicidad de terceros y llevarlos a la plataforma mediante conectores de origen y API.
