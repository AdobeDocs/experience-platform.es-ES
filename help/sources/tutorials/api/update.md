---
keywords: Experience Platform;inicio;temas populares; servicio de flujo; actualizar conexiones
...
Este tutorial trata los pasos para actualizar los detalles y las credenciales de una conexión existente mediante [[!DNL Flow Service API]](https://www.adobe.io/apis/experienceplatform/home/api-reference.html#!acpdr/swagger-specs/flow-service.yaml).
...
>[!NOTE]
>Este tutorial utiliza el [conector de origen de Salesforce](../../connectors/crm/salesforce.md) como ejemplo, pero los pasos descritos se aplican a cualquiera de los [conectores de origen disponibles](../../home.md).
...
Una vez que tenga un ID de conexión existente, realice una solicitud de PATCH a la API [!DNL Flow Service].

>[!IMPORTANT]
>Una solicitud de PATCH requiere el uso del encabezado `If-Match`. El valor de este encabezado es la versión única de la conexión.
...
Puede recuperar el mismo ID de conexión que ha actualizado para ver los cambios realizados mediante una solicitud de GET a la API [!DNL Flow Service].
