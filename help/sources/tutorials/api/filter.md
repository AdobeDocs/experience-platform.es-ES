...
>[!IMPORTANT]
>
>Actualmente, la compatibilidad con el filtrado de datos de nivel de fila para un origen solo está disponible para la variable [[!DNL Google BigQuery]](../../connectors/databases/bigquery.md) y [[!DNL Snowflake]](../../connectors/databases/snowflake.md) fuentes.
