...
Los conectores de origen en Adobe Experience Platform permiten la ingesta de datos externos de forma programada. Este tutorial proporciona los pasos para crear un conector de origen ServiceNow mediante la interfaz de usuario de Platform.
...
Para acceder a su cuenta de ServiceNow en Platform, debe proporcionar los siguientes valores:
