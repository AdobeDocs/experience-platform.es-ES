...
Los conectores de origen de Adobe Experience Platform permiten la ingesta de datos externos de forma programada. Este tutorial proporciona los pasos para crear un conector de origen de Salesforce Service Cloud (en adelante denominado &quot;SSC&quot;) mediante la interfaz de usuario de la plataforma.
...
Una vez que haya recopilado las credenciales necesarias, puede seguir los pasos a continuación para crear una nueva cuenta SSC para conectarse a Platform.
...
Siguiendo este tutorial, ha establecido una conexión con su cuenta SSC. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para llevar los datos de éxito del cliente a la plataforma](../../dataflow/customer-success.md).