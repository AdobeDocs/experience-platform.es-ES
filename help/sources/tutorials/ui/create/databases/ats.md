...
Los conectores de origen en Adobe Experience Platform permiten la ingesta de datos externos de forma programada. Este tutorial proporciona los pasos para crear un conector de origen [!DNL Azure Table Storage] (en adelante, &quot;ATS&quot;) mediante la interfaz [!DNL Platform] de usuario.
