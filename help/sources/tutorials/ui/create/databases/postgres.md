...
topic: overview
type: Tutorial
description: Este tutorial proporciona los pasos para crear un conector de origen PostgreSQL (en adelante denominado "PSQL") mediante la interfaz de usuario de la plataforma.
...
Una vez recopiladas las credenciales requeridas, puede seguir los pasos a continuación para vincular su cuenta de PSQL a [!DNL Platform].
...
En la categoría **[!UICONTROL Bases de datos]** , seleccione Base de datos **[!UICONTROL PostgreSQL]**. Si es la primera vez que utiliza este conector, seleccione **[!UICONTROL Configurar]**. De lo contrario, seleccione **[!UICONTROL Añadir datos]** para crear un nuevo conector PSQL.
...
Siguiendo este tutorial, ha establecido una conexión con su cuenta PSQL. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para incluir [!DNL Platform]](../../dataflow/databases.md)datos.