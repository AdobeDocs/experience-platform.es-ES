...
En la categoría **[!UICONTROL Bases de datos]**, seleccione **[!UICONTROL Azure synapse Analytics]**. Si es la primera vez que utiliza este conector, seleccione **[!UICONTROL Configurar]**. De lo contrario, seleccione **[!UICONTROL Add data]** para crear un nuevo conector [!DNL Synapse].
