...
Los conectores de origen en Adobe Experience Platform permiten la ingesta de datos externos de forma programada. Este tutorial proporciona los pasos para crear un conector de [!DNL GreenPlum] origen mediante la interfaz [!DNL Platform] de usuario.
...
En la categoría *[!UICONTROL Bases de datos]* , seleccione **[!UICONTROL GreenPlum]** y haga clic **en el icono + (+)** para crear un nuevo [!DNL GreenPlum] conector.
