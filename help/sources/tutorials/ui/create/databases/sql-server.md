...
topic: overview
type: Tutorial
description: Este tutorial proporciona los pasos para crear un conector de origen de Microsoft SQL Server (en adelante denominado "SQL Server") mediante la interfaz de usuario de la plataforma.
