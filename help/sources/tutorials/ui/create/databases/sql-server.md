...
En la categoría *Bases de datos*, seleccione **[!DNL Microsoft SQL Server]** y luego seleccione **[!UICONTROL Set up]**.
...
Aparecerá la página **[!UICONTROL Connect to Microsoft SQL Server]**. En esta página, puede usar credenciales nuevas o existentes.

>[!BEGINTABS]

>[!TAB Crear una nueva cuenta]

Para crear una cuenta nueva, seleccione **[!UICONTROL New account]** y proporcione un nombre, una descripción opcional y sus credenciales.

Cuando termine, seleccione **[!UICONTROL Connect to source]** y deje pasar un tiempo para que se establezca la nueva conexión.
...
Para usar una cuenta existente, seleccione **[!UICONTROL Existing account]** y luego seleccione la cuenta que desee usar del catálogo de cuentas existente.
