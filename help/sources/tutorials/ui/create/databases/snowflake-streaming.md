...
# Transmita datos desde su [!DNL Snowflake] de la base de datos al Experience Platform mediante la IU

Aprenda a utilizar la interfaz de usuario de para transmitir datos desde su [!DNL Snowflake] a Adobe Experience Platform siguiendo esta guía.
...
Lea la guía de [configuración de requisitos previos para [!DNL Snowflake] transmisión de datos](../../../../connectors/databases/snowflake-streaming.md) para obtener información sobre los pasos que debe seguir antes de poder ingerir datos de flujo continuo desde [!DNL Snowflake] al Experience Platform.

## Utilice el [!DNL Snowflake Streaming] origen a flujo [!DNL Snowflake] datos para el Experience Platform
...
En el *Bases de datos* categoría, seleccionar **[!DNL Snowflake Streaming]**, y luego seleccione **[!UICONTROL Añadir datos]**.

>[!TIP]
>
>Las fuentes que no tienen una cuenta autenticada en el catálogo de fuentes muestran el **[!UICONTROL Configuración de]** opción. Una vez que existe una cuenta autenticada, esta opción cambia a **[!UICONTROL Añadir datos]**.

![El catálogo de fuentes en la interfaz de usuario de Experience Platform, con la tarjeta de fuente de flujo de Snowflake seleccionada.](../../../../images/tutorials/create/snowflake-streaming/catalog.png)

El **[!UICONTROL Conectar la cuenta de flujo de Snowflake]** página. En esta página, puede usar credenciales nuevas o existentes.
...
| --- | --- |
| Cuenta | El nombre de su [!DNL Snowflake] cuenta. |
| Almacén | El nombre de su [!DNL Snowflake] almacén. Los almacenes administran la ejecución de consultas en [!DNL Snowflake]. Cada [!DNL Snowflake] el almacén es independiente entre sí y se debe acceder a él individualmente para llevar los datos al Experience Platform. |
| Base de datos | El nombre de su [!DNL Snowflake] base de datos. La base de datos contiene los datos que desea llevar al Experience Platform. |
| Esquema | (Opcional) El esquema de base de datos asociado con su [!DNL Snowflake] cuenta. |
| Nombre de usuario | El nombre de usuario de su [!DNL Snowflake] cuenta. |
| Una contraseña | La contraseña de su [!DNL Snowflake] cuenta. |
...
Para obtener más información sobre la creación de cuentas, lea la sección sobre [configurar opciones de rol](../../../../connectors/databases/snowflake-streaming.md#configure-role-settings) en el [!DNL Snowflake Streaming] información general.

>[!TAB Usar una cuenta existente]

Para usar una cuenta existente, seleccione **[!UICONTROL Cuenta existente]** y, a continuación, seleccione la cuenta que desee en el catálogo de cuentas existente.

Seleccione **[!UICONTROL Siguiente]** para continuar.

![La página de selección de cuentas existente del catálogo de fuentes.](../../../../images/tutorials/create/snowflake-streaming/existing.png)
...
El [!UICONTROL Seleccionar datos] aparece el paso. En este paso, debe seleccionar los datos que desea importar en Experience Platform, configurar las marcas de tiempo y las zonas horarias, y proporcionar un archivo de datos de origen de muestra para la ingesta de datos sin procesar.
...
![Interfaz de selección de datos con una tabla de base de datos seleccionada.](../../../../images/tutorials/create/snowflake-streaming/select-table.png)

A continuación, seleccione el tipo de columna de marca de tiempo de la tabla. Puede seleccionar entre dos tipos de columnas de marca de tiempo: `TIMESTAMP_NTZ` o  `TIMESTAMP_LTZ`. Si selecciona un tipo de columna de `TIMESTAMP_NTZ`, entonces también debe proporcionar una zona horaria. Las columnas no deben tener una restricción nula. Para obtener más información, lea la sección sobre [limitaciones y preguntas más frecuentes]
...
Seleccione el **[!UICONTROL Relleno]** para habilitar el relleno.

![Los pasos de configuración marca de tiempo, zona horaria y relleno.](../../../../images/tutorials/create/snowflake-streaming/timezone.png)

Finalmente, seleccione **[!UICONTROL Elegir archivo]** para cargar datos de origen de ejemplo para crear el conjunto de asignaciones, que se utilizará en un paso posterior para asignar los datos originales al modelo de datos de experiencia (XDM).
...
![El paso Revisar del flujo de trabajo de orígenes.](../../../../images/tutorials/create/snowflake-streaming/review.png)
...
Una vez creado el flujo de datos, puede monitorizar los datos que se están ingiriendo a través de él para ver información sobre las tasas de ingesta, el éxito y los errores. Para obtener más información sobre cómo monitorizar los flujos de datos de flujo continuo, visite el tutorial sobre [monitorización de flujos de datos de streaming en la IU](../../monitor-streaming.md).
