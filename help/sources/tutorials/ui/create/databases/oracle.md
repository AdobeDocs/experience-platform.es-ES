...
title: Creación de una conexión de Source de Oracle DB en la IU
type: Tutorial
...
Los conectores de Source en Adobe Experience Platform permiten introducir datos de origen externo de forma programada. Este tutorial proporciona los pasos para crear un conector de origen [!DNL Oracle DB] mediante la interfaz de usuario [!DNL Platform].
...
Para tener acceso a su cuenta de [!DNL Oracle DB] en [!DNL Platform], debe proporcionar los siguientes valores:
...
Una vez que haya recopilado las credenciales requeridas, puede seguir los pasos a continuación para vincular su cuenta de [!DNL Oracle DB] y conectarse a [!DNL Platform].
...
Aparecerá la página **[!UICONTROL Conectarse a la base de datos de Oracle]**. En esta página, puede usar credenciales nuevas o existentes.
...
Al seguir este tutorial, ha establecido una conexión con su cuenta de [!DNL Oracle DB]. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para introducir datos en [!DNL Platform]](../../dataflow/databases.md).
