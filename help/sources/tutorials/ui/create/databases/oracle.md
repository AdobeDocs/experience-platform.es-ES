...
Los conectores de origen de Adobe Experience Platform permiten la ingesta de datos externos de forma programada. Este tutorial proporciona los pasos para crear un conector de [!DNL Oracle] origen mediante la interfaz [!DNL Platform] de usuario.
...
En la categoría *[!UICONTROL Bases de Datos]* , seleccione **[!UICONTROL Oracle DB]** seguido de **[!UICONTROL Añadir datos]** para crear un nuevo [!DNL Oracle] conector.
