...
# Crear un [!DNL Acxiom Data Ingestion] conexión de origen y flujo de datos en la IU

>[!NOTE]
>
>El [!DNL Acxiom Data Ingestion] el origen está en versión beta. Lea el [términos y condiciones](../../../../home.md#terms-and-conditions) en la descripción general de fuentes para obtener más información sobre el uso de fuentes etiquetadas como beta.
...
Lea este tutorial para aprender a crear un [!DNL Acxiom Data Ingestion] conexión de origen y flujo de datos mediante la interfaz de usuario de Adobe Experience Platform. El [!DNL Acxiom Data Ingestion] origen se utiliza para recuperar y asignar la respuesta de [!DNL Acxiom] servicio de mejora de con Amazon S3 como punto de caída.
...
En el **[!UICONTROL Socios de datos e identidad]** categoría, seleccionar **[!UICONTROL Ingesta de datos de Acxiom]** y luego seleccione **[!UICONTROL Configuración de]**.
...
![El catálogo de fuentes con la fuente Acxiom seleccionada.](../../../../images/tutorials/create/acxiom-data-enhancement-import/image-source-catalog.png)
...
![Interfaz de selección de datos y previsualización de archivos del flujo de trabajo de orígenes.](../../../../images/tutorials/create/acxiom-data-enhancement-import/image-source-preview.png)
...
![La interfaz del conjunto de datos existente.](../../../../images/tutorials/create/acxiom-data-enhancement-import/image-source-dataset.png)
...
![La interfaz de configuraciones de detalles del flujo de datos.](../../../../images/tutorials/create/acxiom-data-enhancement-import/image-source-dataset-details.png)
...
![La interfaz de configuración de programación.](../../../../images/tutorials/create/acxiom-data-enhancement-import/image-source-scheduling.png)
...
Para obtener más información, lea la [[!DNL Acxiom] InfoBase](https://www.acxiom.com/wp-content/uploads/2022/02/fs-acxiom-infobase_AC-0268-22.pdf).
