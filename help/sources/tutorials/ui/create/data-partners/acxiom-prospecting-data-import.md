...
Lea este tutorial para aprender a crear una conexión de origen y un flujo de datos de [!DNL Acxiom Prospecting Data Import] mediante la interfaz de usuario de Adobe Experience Platform.
...
* [[!DNL Prospect Profile]](../../../../../profile/ui/prospect-profile.md): Aprenda a crear y utilizar un perfil de cliente potencial para recopilar información acerca de clientes desconocidos que utilizan información de terceros.
...
En la categoría **[!UICONTROL Socios de datos e identidad]**, seleccione **[!UICONTROL Importación de datos de prospección de Acxiom]** y, a continuación, seleccione **[!UICONTROL Configurar]**.
...
![El catálogo de orígenes con el origen Acxiom seleccionado.](../../../../images/tutorials/create/acxiom-prospect-suppression-data-sourcing/image-source-catalog.png)
...
![Interfaz de selección de datos y vista previa de archivos del flujo de trabajo de orígenes.](../../../../images/tutorials/create/acxiom-prospect-suppression-data-sourcing/image-source-preview.png)
...
![Interfaz de conjunto de datos existente.](../../../../images/tutorials/create/acxiom-prospect-suppression-data-sourcing/image-source-dataset.png)

>[!ENDTABS]

### Detalles del flujo de datos

Durante este paso, si el conjunto de datos está habilitado para el perfil, puede seleccionar la opción **[!UICONTROL Conjunto de datos del perfil]** para habilitar los datos para la ingesta de perfiles. También puede habilitar [!UICONTROL diagnósticos de error] e [!UICONTROL ingesta parcial].

* **Diagnósticos de error** - Seleccione **Diagnósticos de error** para indicar al origen que produzca diagnósticos de error a los que pueda hacer referencia posteriormente mediante API. Para obtener más información, lea la [descripción general de diagnósticos de error](../../../../../ingestion/quality/error-diagnostics.md)
* **Habilitar ingesta parcial** - La ingesta parcial por lotes es la capacidad de ingerir datos que contengan errores, hasta un determinado umbral. Con esta capacidad, los usuarios pueden introducir correctamente todos sus datos correctos en Adobe Experience Platform, mientras que todos sus datos incorrectos se agrupan por separado, junto con los detalles de por qué no es válido.  Para obtener más información, lea la [descripción general de la ingesta parcial](../../../../../ingestion/batch-ingestion/partial.md)

![Interfaz de configuraciones de detalles del flujo de datos.](../../../../images/tutorials/create/acxiom-prospect-suppression-data-sourcing/image-source-dataset-details.png)
...
* **Intervalo**: Una vez que seleccione una frecuencia, puede configurar el intervalo para establecer el lapso de tiempo entre cada ingesta. Por ejemplo, si establece la frecuencia en día y configura el intervalo en 15, el flujo de datos se ejecutará cada 15 días. El intervalo no puede establecerse en cero y debe establecerse en al menos 15.
...
![Interfaz de configuración de programación.](../../../../images/tutorials/create/acxiom-prospect-suppression-data-sourcing/image-source-scheduling.png)
