...
>[!AVAILABILITY]
>
>El origen [!DNL Kobie Streaming Events] está en la versión beta. Lea los [términos y condiciones](../../../../home.md#terms-and-conditions) en la descripción general de orígenes para obtener más información sobre el uso de orígenes etiquetados como beta.
...
Para transmitir datos de [!DNL Kobie], seleccione la tarjeta de origen **[!UICONTROL Kobie Streaming Events]** en *[!UICONTROL Loyalty]* y, a continuación, seleccione **[!UICONTROL Add data]**.
...
![El catálogo de orígenes en la interfaz de usuario con la tarjeta Eventos de transmisión de Kobie seleccionada.](../../../../images/tutorials/create/kobie/catalog.png)
...
![Paso para seleccionar datos del flujo de trabajo de orígenes](../../../../images/tutorials/create/kobie/select-data.png)
...
![Interfaz de detalles del flujo de datos](../../../../images/tutorials/create/kobie/dataflow-details.png)
...
![Paso de asignación del flujo de trabajo](../../../../images/tutorials/create/kobie/mapping.png)
...
![Paso de revisión en el flujo de trabajo de orígenes.](../../../../images/tutorials/create/kobie/review.png)
...
![La dirección URL del extremo de flujo continuo.](../../../../images/tutorials/create/kobie/streaming-endpoint.png)
