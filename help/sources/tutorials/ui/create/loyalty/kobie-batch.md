---
title: Ingesta De Datos Por Lotes De Kobie En Experience Platform Mediante La IU
description: Aprenda a ingerir datos por lotes de Kobie en Adobe Experience Platform mediante la interfaz de usuario.
badge: Beta
hide: true
hidefromtoc: true
...
# Ingesta de datos por lotes de [!DNL Kobie] en Experience Platform mediante la interfaz de usuario

Lea este tutorial para aprender a ingerir datos por lotes de su cuenta de [!DNL Kobie] en Adobe Experience Platform mediante el espacio de trabajo de fuentes en la interfaz de usuario.
...
Para introducir datos de [!DNL Kobie], seleccione la tarjeta de origen **[!UICONTROL Kobie Batch Source Connector]** en *[!UICONTROL Loyalty]* y, a continuación, seleccione **[!UICONTROL Add data]**.
...
Para crear una nueva cuenta para el origen de [!DNL Kobie], seleccione **[!UICONTROL New account]** y proporcione un nombre y una descripción opcional para la cuenta. A continuación, proporcione su dominio [!DNL Kobie] y su [!UICONTROL Kobie Management API Key]. Cuando termine, seleccione **[!UICONTROL Connect to source]** y espere unos momentos para que se establezca la conexión.



### Usar una cuenta existente

Para usar una cuenta existente, seleccione **[!UICONTROL Existing account]** y la cuenta [!DNL Kobie] que desee usar en la interfaz de cuentas.
...
>[!IMPORTANT]
>
>Para obtener instrucciones adicionales sobre cómo asignar los datos de origen de [!DNL Kobie], lea la [[!DNL Kobie] descripción general]
