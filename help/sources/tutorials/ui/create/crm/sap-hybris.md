---
title: Creación de una conexión de origen de SAP Hybris en la interfaz de usuario
description: Aprenda a crear una conexión de origen de SAP Hybris mediante la interfaz de usuario de Adobe Experience Platform.
badge: Beta
hide: true
hidefromtoc: true
...
# Crear un [!DNL SAP Hybris] conexión de origen en la interfaz de usuario
...
El siguiente tutorial le guiará para crear una [!DNL SAP Hybris] conexión de origen para traer [[!DNL SAP] Facturación de suscripción](https://www.sap.com/products/financial-management/subscription-billing.html) contactos y datos de clientes mediante la interfaz de usuario de Adobe Experience Platform.
...
Si ya tiene un válido [!DNL SAP Hybris] cuenta de, puede omitir el resto de este documento y continuar con el tutorial sobre [configuración de un flujo de datos](../../dataflow/crm.md).
...
## Conecte su [!DNL SAP Hybris] account {#connect-account}
...
En el *CRM* categoría, seleccionar **[!UICONTROL SAP Hybris]**, y luego seleccione **[!UICONTROL Añadir datos]**.

![Captura de pantalla de la IU de Platform para el catálogo con la tarjeta SAP Hybris](../../../../images/tutorials/create/crm/sap-hybris-subscription-billing-customers-and-contacts/catalog-card.png)

El **[!UICONTROL Conectar la cuenta de SAP Hybris]** página. En esta página, puede usar credenciales nuevas o existentes.

### Cuenta existente {#existing-account}

Para utilizar una cuenta existente, seleccione la [!DNL SAP Hybris] cuenta con la que desea crear un nuevo flujo de datos y seleccione **[!UICONTROL Siguiente]** para continuar.

![Captura de pantalla de la IU de Platform para conectar la cuenta de SAP Hybris con una cuenta existente](../../../../images/tutorials/create/crm/sap-hybris-subscription-billing-customers-and-contacts/existing.png)
...
![Captura de pantalla de la IU de Platform para conectar la cuenta de SAP Hybris con una nueva cuenta](../../../../images/tutorials/create/crm/sap-hybris-subscription-billing-customers-and-contacts/new.png)
...
![Captura de pantalla de la IU de Platform para SAP Hybris que muestra la configuración con la opción Clientes seleccionada](../../../../images/tutorials/create/crm/sap-hybris-subscription-billing-customers-and-contacts/configuration-customers.png)
...
![Captura de pantalla de la IU de Platform para SAP Hybris que muestra la configuración con la opción Contactos seleccionada](../../../../images/tutorials/create/crm/sap-hybris-subscription-billing-customers-and-contacts/configuration-contacts.png)

>[!ENDTABS]

## Pasos siguientes {#next-steps}

Al seguir este tutorial, ha establecido una conexión con su [!DNL SAP Hybris] cuenta. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para introducir datos CRM en Platform](../../dataflow/crm.md).

## Recursos adicionales {#additional-resources}

Las secciones siguientes proporcionan recursos adicionales a los que puede hacer referencia al utilizar el [!DNL SAP Hybris] origen.
...
Para datos de clientes, [!DNL SAP Hybris] utiliza el [clientes](https://api.sap.com/api/BusinessPartner_APIs/path/GET_customers) y el [relaciones cliente-contactos](https://api.sap.com/api/BusinessPartner_APIs/path/GET_relationships-customer-contacts) puntos finales del [!DNL SAP Business Partners] API para recuperar los datos

A continuación se muestra un ejemplo de asignación de configuraciones para [!DNL SAP Hybris] flujo de datos para los datos de clientes:
...
![Paso de asignación del flujo de trabajo de orígenes.](../../../../images/tutorials/create/crm/sap-hybris-subscription-billing-customers-and-contacts//mapping-customers.png)

>[!TAB Contactos]

Para datos de contacto, [!DNL SAP Hybris] utiliza el [contactos](https://api.sap.com/api/BusinessPartner_APIs/path/GET_contacts) punto final del [!DNL SAP Business Partners] API para recuperar los datos.

A continuación se muestra un ejemplo de asignación de configuraciones para [!DNL SAP Hybris] flujo de datos para datos de contacto:
...
![Paso de asignación del flujo de trabajo de orígenes.](../../../../images/tutorials/create/crm/sap-hybris-subscription-billing-customers-and-contacts/mapping-contacts.png)
