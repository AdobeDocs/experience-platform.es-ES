...
Los conectores de Source en Adobe Experience Platform permiten introducir datos CRM de origen externo de forma programada. Este tutorial proporciona los pasos para crear un conector de origen [!DNL Veeva CRM] mediante la interfaz de usuario [!DNL Platform].
...
Una vez que haya recopilado las credenciales requeridas, puede seguir los pasos a continuación para vincular su cuenta de [!DNL Veeva CRM] a [!DNL Platform].
...
Al seguir este tutorial, ha establecido una conexión con su cuenta de [!DNL Veeva CRM]. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para introducir datos en la plataforma](../../dataflow/crm.md).
