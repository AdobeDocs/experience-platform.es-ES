...
title: Crear una conexión de origen de miembros de MailChimp mediante la IU de Experience Platform
description: Aprenda a conectar Adobe Experience Platform con los miembros de MailChimp mediante la interfaz de usuario de Experience Platform.
...
# Crear una conexión de origen [!DNL Mailchimp Members] mediante la interfaz de usuario de Experience Platform
...
Para poder llevar los datos de [!DNL Mailchimp Members] a Experience Platform, primero debe proporcionar las credenciales de autenticación adecuadas que se correspondan con la cuenta de [!DNL Mailchimp].
...
## Conecte su cuenta de [!DNL Mailchimp Members] a Experience Platform
