...
Siguiendo este tutorial, ha establecido una conexión de base con su [!DNL HubSpot] cuenta. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para llevar los datos del sistema de automatización de marketing a la plataforma](../../dataflow/marketing-automation.md).