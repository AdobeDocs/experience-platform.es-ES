...
![Captura de pantalla de la interfaz de usuario de Experience Platform para el catálogo con la tarjeta Oracle NetSuite Activities](../../../../images/tutorials/create/marketing-automation/oracle-netsuite-activities/catalog-card.png)
...
![Captura de pantalla de la IU de Experience Platform para conectar la cuenta de actividades de Oracle NetSuite con una cuenta existente](../../../../images/tutorials/create/marketing-automation/oracle-netsuite-activities/existing.png)
