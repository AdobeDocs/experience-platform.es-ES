...
&lt;!: los grupos de informes de Analytics se pueden configurar para un simulador de pruebas a la vez. Para importar el mismo grupo de informes en un entorno limitado diferente, se deberá eliminar el flujo del conjunto de datos y crear una instancia de nuevo mediante la configuración de un entorno limitado diferente.—>
