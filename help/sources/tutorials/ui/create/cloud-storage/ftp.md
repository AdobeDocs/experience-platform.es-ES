...
title: Creación de un conector de origen FTP en la interfaz de usuario
topic: overview
type: Tutorial
description: Este tutorial proporciona los pasos para crear un conector de origen FTP mediante la interfaz de usuario de la plataforma.
...
# Creación de un conector de origen FTP en la interfaz de usuario
...
Este tutorial proporciona los pasos para crear un conector de origen FTP mediante la interfaz de usuario de la plataforma.
...
Siguiendo este tutorial, ha establecido una conexión con su cuenta de FTP. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para traer datos de su almacenamiento de nube a la plataforma](../../dataflow/batch/cloud-storage.md).