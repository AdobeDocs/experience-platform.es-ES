...
Si ya tiene una conexión base S3, puede omitir el resto de este documento y continuar con el tutorial sobre la [configuración de un flujo de datos](../../dataflow/batch/cloud-storage.md).
...
Una vez recopiladas las credenciales necesarias, puede seguir los pasos a continuación para crear una nueva cuenta S3 con la que conectarse [!DNL Platform].
...
En la categoría *[!UICONTROL Bases de datos]* , seleccione **[!UICONTROL Amazon S3]** y haga clic en **Añadir datos** para crear un nuevo conector S3.
...
Si está utilizando nuevas credenciales, seleccione **[!UICONTROL Nueva cuenta]**. En el formulario de entrada que aparece, proporcione la conexión con un nombre, una descripción opcional y sus credenciales S3. Cuando termine, seleccione **[!UICONTROL Connect]** y, a continuación, espere un poco de tiempo para que se establezca la nueva cuenta.
...
Siguiendo este tutorial, ha establecido una conexión con su cuenta S3. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para traer datos de su almacenamiento de nube a la plataforma](../../dataflow/batch/cloud-storage.md).