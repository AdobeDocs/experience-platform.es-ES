---
keywords: Experience Platform;inicio;temas populares;Almacenamiento de Google Cloud;almacenamiento de Google Cloud;GCS;gcs
solution: Experience Platform
title: Creación de una conexión de origen de Almacenamiento de Google Cloud en la interfaz de usuario
topic: overview
type: Tutorial
...
Los conectores de origen de Adobe Experience Platform permiten la ingesta de datos externos de forma programada. Este tutorial proporciona los pasos para crear un conector de origen [!DNL Google Cloud Storage] (en adelante denominado &quot;GCS&quot;) mediante la interfaz de usuario [!DNL Platform].
...
Si ya tiene una conexión GCS válida, puede omitir el resto de este documento y continuar con el tutorial sobre [configuración de un flujo de datos](../../dataflow/batch/cloud-storage.md).
...
| ---------- | ----------- |
| ID de clave de acceso | ID de clave de acceso de la cuenta [!DNL Google Cloud Storage]. |
| Clave de acceso secreta | El secreto de cliente de la cuenta [!DNL Google Cloud Storage]. |

Para obtener más información sobre cómo empezar, consulte [guía de autenticación de servidor a servidor](https://cloud.google.com/docs/authentication/production) para [!DNL Google Cloud Storage].

## Conectar su cuenta [!DNL Google Cloud Storage]
...
En la categoría **[!UICONTROL Bases de datos]**, seleccione **[!UICONTROL Almacenamiento de Google Cloud]**. Si es la primera vez que utiliza este conector, seleccione **[!UICONTROL Configurar]**. De lo contrario, seleccione **[!UICONTROL Añadir datos]** para crear un nuevo conector GCS.
