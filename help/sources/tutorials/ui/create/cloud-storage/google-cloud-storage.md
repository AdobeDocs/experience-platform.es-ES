...
En la categoría *[!UICONTROL Bases]* de datos, seleccione Almacenamiento **[!UICONTROL de]** Google Cloud seguido de **[!UICONTROL Añadir datos]** para crear un nuevo conector GCS.
