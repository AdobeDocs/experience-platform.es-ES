...
Si ya tiene una conexión de base GCS, puede omitir el resto de este documento y continuar con el tutorial sobre la [configuración de un flujo de datos](../../dataflow/cloud-storage.md).
...
Siguiendo este tutorial, ha establecido una conexión de base con su cuenta GCS. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para traer datos a Platform](../../dataflow/cloud-storage.md).