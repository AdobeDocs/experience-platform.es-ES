...
title: Creación de un conector de origen Shopify en la interfaz de usuario
topic: overview
type: Tutorial
description: Este tutorial proporciona los pasos para crear un conector de origen Shopify mediante la interfaz de usuario de la plataforma.
...
# Creación de un conector [!DNL Shopify] de origen en la interfaz de usuario
...
Los conectores de origen de Adobe Experience Platform permiten la ingesta de datos externos de forma programada. Este tutorial proporciona los pasos para crear un conector de [!DNL Shopify] origen mediante la interfaz [!DNL Platform] de usuario.
...
Si ya tiene una [!DNL Shopify] conexión, puede omitir el resto de este documento y continuar con el tutorial sobre la [configuración de un flujo de datos para un conector](../../dataflow/ecommerce.md)eCommerce.
...
## Conectar su [!DNL Shopify] cuenta

Una vez recopiladas las credenciales necesarias, puede seguir los pasos a continuación para vincular su [!DNL Shopify] cuenta a [!DNL Platform].
...
En la categoría **[!UICONTROL eCommerce]** , seleccione **[!UICONTROL Shopify]**. Si es la primera vez que utiliza este conector, seleccione **[!UICONTROL Configurar]**. De lo contrario, seleccione **[!UICONTROL Añadir datos]** para crear un nuevo [!DNL Shopify] conector.
...
Si está utilizando nuevas credenciales, seleccione **[!UICONTROL Nueva cuenta]**. En el formulario de entrada que aparece, especifique un nombre, una descripción opcional y sus [!DNL Shopify] credenciales. Cuando termine, seleccione **[!UICONTROL Connect]** y, a continuación, espere un poco de tiempo para que se establezca la nueva conexión.
...
Siguiendo este tutorial, ha establecido una conexión con su [!DNL Shopify] cuenta. Ahora puede continuar con el siguiente tutorial y [configurar un flujo de datos para introducir [!DNL Platform]](../../dataflow/ecommerce.md)datos de comercio electrónico.