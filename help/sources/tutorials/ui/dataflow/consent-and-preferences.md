...
title: Creación de un flujo de datos mediante una fuente de preferencias y consentimiento en la IU
type: Tutorial
...
Después de crear la cuenta de origen de consentimiento y preferencias, la variable **[!UICONTROL Añadir datos]** Este paso aparece y proporciona una interfaz para que explore la jerarquía de tablas de la cuenta de consentimiento y preferencias.
