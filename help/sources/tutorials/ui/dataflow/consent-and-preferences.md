...
# Crear un flujo de datos con un origen de consentimiento y preferencias en la interfaz de usuario

Un flujo de datos es una tarea programada que recupera e incorpora datos de un origen a un conjunto de datos en Adobe Experience Platform. Este tutorial proporciona pasos sobre cómo crear un flujo de datos para un origen de consentimiento y preferencias mediante la interfaz de usuario de Platform.

>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener una cuenta autenticada con la variable [!DNL OneTrust Integration] fuente. Consulte el tutorial en [crear un [!DNL OneTrust Integration] conexión de origen en la interfaz de usuario](../../ui/create/consent-and-preferences/onetrust.md) para obtener más información.
...
Después de crear la cuenta de origen de consentimiento y preferencias, la variable **[!UICONTROL Añadir datos]** aparece, proporcionando una interfaz para explorar la jerarquía de tablas de la cuenta de consentimiento y preferencias.
...
Siguiendo este tutorial, ha creado correctamente un flujo de datos para traer los datos de su consentimiento y la fuente de preferencias a Platform. Los datos entrantes ahora se pueden usar en el flujo descendente [!DNL Platform] servicios como [!DNL Real-Time Customer Profile] y [!DNL Data Science Workspace]. Consulte los siguientes documentos para obtener más información:
