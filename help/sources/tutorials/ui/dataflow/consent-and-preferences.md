...
title: Creación de un flujo de datos mediante un Source de consentimiento y preferencias en la IU
type: Tutorial
description: Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos de Experience Platform. Este tutorial proporciona pasos sobre cómo crear un flujo de datos para una fuente de preferencias y consentimiento mediante la interfaz de usuario de Experience Platform.
...
# Creación de un flujo de datos mediante una fuente de consentimiento y preferencias en la interfaz de usuario

Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos en Adobe Experience Platform. Este tutorial proporciona pasos sobre cómo crear un flujo de datos para una fuente de preferencias y consentimiento mediante la interfaz de usuario de Experience Platform.

>[!NOTE]
>
>* Para crear un flujo de datos, ya debe tener una cuenta autenticada con el origen [!DNL OneTrust Integration]. Consulte el tutorial sobre [creación de una conexión de origen [!DNL OneTrust Integration] en la interfaz de usuario](../../ui/create/consent-and-preferences/onetrust.md) para obtener más información.
...
Después de crear la cuenta de origen de consentimiento y preferencias, aparece el paso **[!UICONTROL Agregar datos]**, que proporciona una interfaz para explorar la jerarquía de tabla de la cuenta de consentimiento y preferencias.
...
Al seguir este tutorial, ha creado correctamente un flujo de datos para llevar los datos de su fuente de preferencias y consentimiento a Experience Platform. Los datos entrantes ahora pueden ser utilizados por servicios de flujo descendente [!DNL Experience Platform] como [!DNL Real-Time Customer Profile] y [!DNL Data Science Workspace]. Consulte los siguientes documentos para obtener más información:
