...
title: Creación de un flujo de datos con un Source de éxito del cliente en la IU
type: Tutorial
description: Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos de Experience Platform. Este tutorial proporciona pasos sobre cómo crear un flujo de datos para una fuente de éxito del cliente mediante la interfaz de usuario de Experience Platform.
...
Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos en Adobe Experience Platform. Este tutorial proporciona pasos sobre cómo crear un flujo de datos para una fuente de éxito del cliente mediante la interfaz de usuario de Experience Platform.

>[!NOTE]
>
>* Para crear un flujo de datos, ya debe tener una cuenta autenticada con un origen de éxito de cliente. Encontrará una lista de tutoriales para crear distintas cuentas de origen de éxito de clientes en la interfaz de usuario en [descripción general de orígenes](../../../home.md#customer-success).
...
Después de crear la cuenta de origen de éxito del cliente, aparece el paso **[!UICONTROL Agregar datos]**, que proporciona una interfaz para explorar la jerarquía de tabla de la cuenta de origen de éxito del cliente.
...
Al seguir este tutorial, ha creado correctamente un flujo de datos para llevar los datos de su fuente de éxito del cliente a Experience Platform. Los datos entrantes ahora pueden ser utilizados por servicios de flujo descendente [!DNL Experience Platform] como [!DNL Real-Time Customer Profile] y [!DNL Data Science Workspace]. Consulte los siguientes documentos para obtener más información:
