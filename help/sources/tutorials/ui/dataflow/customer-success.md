...
title: Creación de un flujo de datos mediante una fuente de éxito del cliente en la IU
type: Tutorial
description: Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos de Platform. Este tutorial proporciona pasos sobre cómo crear un flujo de datos para una fuente de éxito del cliente mediante la IU de Platform.
...
# Creación de un flujo de datos mediante una fuente de éxito del cliente en la IU

Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos en Adobe Experience Platform. Este tutorial proporciona pasos sobre cómo crear un flujo de datos para una fuente de éxito del cliente mediante la IU de Platform.

>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener una cuenta autenticada con un origen de éxito de cliente. Puede encontrar una lista de tutoriales para crear diferentes cuentas de origen de éxito de clientes en la interfaz de usuario de en el [información general de orígenes](../../../home.md#customer-success).
...
Después de crear la cuenta de origen de éxito del cliente, la variable **[!UICONTROL Añadir datos]** Este paso aparece y proporciona una interfaz para explorar la jerarquía de tablas de la cuenta de origen de éxito del cliente.
...
>[!NOTE]
>
>La opción de búsqueda de datos de fuente está disponible para todas las fuentes basadas en tablas, excepto para Adobe Analytics. [!DNL Amazon Kinesis], y [!DNL Azure Event Hubs].

Una vez encontrados los datos de origen, seleccione la tabla y, a continuación, seleccione **[!UICONTROL Siguiente]**.
...
Al seguir este tutorial, ha creado correctamente un flujo de datos para llevar los datos de su fuente de éxito del cliente a Platform. Ahora, los datos entrantes pueden utilizarse en el flujo descendente [!DNL Platform] servicios como [!DNL Real-Time Customer Profile] y [!DNL Data Science Workspace]. Consulte los siguientes documentos para obtener más información:
