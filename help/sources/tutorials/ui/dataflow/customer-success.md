...
type: Tutorial
description: Un flujo de datos es una tarea programada que recupera e incorpora datos de un origen a un [!DNL Platform] conjunto de datos. Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de éxito de cliente.
...
Un flujo de datos es una tarea programada que recupera e incorpora datos de un origen a un [!DNL Platform] conjunto de datos. Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de éxito de cliente.
...
Además, este tutorial requiere que ya haya creado una cuenta de éxito de cliente. Puede encontrar una lista de tutoriales para crear diferentes conectores de éxito de clientes en la interfaz de usuario en la [información general sobre conectores de origen](../../../home.md).

## Seleccionar datos

Después de crear el conector de éxito del cliente, la variable **[!UICONTROL Seleccionar datos]** aparece, proporcionando una interfaz interactiva para explorar la jerarquía de archivos.
...
Dentro de **[!UICONTROL Autenticación]** , seleccione el nombre de la cuenta asociada al flujo de datos que desea desactivar.
