...
Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos de la Plataforma. Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de éxito de cliente.
...
Después de crear el conector de éxito del cliente, aparece el paso *Seleccionar datos* , que proporciona una interfaz interactiva para explorar la jerarquía de archivos.
...
En el espacio de trabajo *Fuentes* , seleccione la fuente de éxito del cliente que desea vista en la categoría Éxito *del* cliente. Seleccione *Connect Source* para iniciar la interfaz de autenticación. Para vista de un flujo de datos existente, seleccione Cuenta ** existente y seleccione la cuenta a la que desea acceder.
...
Siguiendo este tutorial, ha creado correctamente un flujo de datos para traer datos de un origen de éxito de cliente y ha adquirido una perspectiva sobre la supervisión de conjuntos de datos. Los datos entrantes ahora se pueden utilizar en los servicios de plataforma descendente, como Perfil del cliente en tiempo real y Área de trabajo de ciencias de datos. Consulte los siguientes documentos para obtener más información:
...
En la pantalla de *autenticación* , seleccione el nombre de la cuenta asociada al flujo de datos que desea deshabilitar.
