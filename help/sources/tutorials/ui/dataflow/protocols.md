...
Aparece el paso de detalles ** de flujo de datos, donde debe proporcionar un nombre y una descripción opcional para el flujo de datos. Haga clic en **[!UICONTROL Siguiente]** cuando termine.
