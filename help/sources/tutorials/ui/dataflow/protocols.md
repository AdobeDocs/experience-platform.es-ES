...
title: Creación de un flujo de datos mediante una fuente de protocolos en la IU
type: Tutorial
...
Después de crear la cuenta de origen de protocolos, la variable **[!UICONTROL Añadir datos]** Este paso aparece y proporciona una interfaz para explorar la jerarquía de tablas de la cuenta de origen de protocolos.
