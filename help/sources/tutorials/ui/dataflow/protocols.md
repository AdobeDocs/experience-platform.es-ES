...
Además, este tutorial requiere que ya haya creado una cuenta de protocolos. Puede encontrar una lista de tutoriales para crear diferentes conectores de protocolo en la interfaz de usuario en la [información general de conectores de origen](../../../home.md).
...
Aparece el paso **[!UICONTROL Dataflow detail]**, que le permite asignar un nombre y proporcionar una breve descripción del nuevo flujo de datos.
