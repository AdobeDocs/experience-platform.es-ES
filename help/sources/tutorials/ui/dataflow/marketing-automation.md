...
title: Creación de un flujo de datos con un Source de automatización de marketing en la IU
type: Tutorial
...
>[!NOTE]
>
>* Para crear un flujo de datos, ya debe tener una cuenta autenticada con una fuente de automatización de marketing. Encontrará una lista de tutoriales para crear diferentes cuentas de origen de automatización de marketing en la interfaz de usuario en [descripción general de las fuentes](../../../home.md#marketing-automation).
...
Después de crear la cuenta de origen de automatización de marketing, aparece el paso **[!UICONTROL Agregar datos]**, que proporciona una interfaz para explorar la jerarquía de tablas de la cuenta de origen de automatización de marketing.
...
Al seguir este tutorial, ha creado correctamente un flujo de datos para llevar los datos de su fuente de automatización de marketing a Platform. Los datos entrantes ahora pueden ser utilizados por servicios de flujo descendente [!DNL Platform] como [!DNL Real-Time Customer Profile] y [!DNL Data Science Workspace]. Consulte los siguientes documentos para obtener más información:
