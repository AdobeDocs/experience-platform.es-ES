---
keywords: Experience Platform;inicio;temas populares;conector de automatización de mercadotecnia
solution: Experience Platform
title: Configuración de un flujo de datos para una conexión de origen de automatización de marketing en la interfaz de usuario
topic: overview
type: Tutorial
description: Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos [!DNL Platform] . Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de automatización de marketing.
...
# Configuración de un flujo de datos para una conexión de automatización de marketing en la interfaz de usuario

Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos [!DNL Platform]. Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de automatización de marketing.
...
Además, este tutorial requiere que ya haya creado una cuenta de automatización de marketing. Encontrará una lista de tutoriales para crear diferentes conectores de automatización de mercadotecnia en la interfaz de usuario en la [información general de los conectores de origen](../../../home.md).
