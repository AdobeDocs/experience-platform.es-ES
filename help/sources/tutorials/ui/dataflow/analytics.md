...
>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener una cuenta autenticada con el origen [!DNL Mixpanel]. Consulte el tutorial sobre [creación de una conexión de origen [!DNL Mixpanel] en la interfaz de usuario](../../ui/create/analytics/mixpanel.md) para obtener más información.
...
>
>[!VIDEO](https://video.tv.adobe.com/v/32646?captions=spa&quality=12&learn=on)
