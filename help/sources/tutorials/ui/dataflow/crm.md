...
En el espacio de trabajo _Fuentes_ , seleccione el origen CRM que desea vista en la categoría *CRM* . Seleccione *Connect Source* para iniciar la interfaz de autenticación. Para vista de un flujo de datos existente, seleccione Cuenta ** existente y seleccione la cuenta a la que desea acceder.
