...
title: Creación de un flujo de datos mediante una fuente CRM en la IU
type: Tutorial
...
Después de crear la cuenta de origen de CRM, la variable **[!UICONTROL Añadir datos]** Este paso aparece y proporciona una interfaz para que explore la jerarquía de tablas de su cuenta de CRM.
