...
Para introducir datos en un conjunto de datos existente, seleccione **[!UICONTROL Existing dataset]** y haga clic en el icono del conjunto de datos.
...
Dentro del espacio de trabajo **[!UICONTROL Sources]** , seleccione la pestaña **[!UICONTROL Dataflows]** . A continuación, seleccione el flujo de datos que desea desactivar.

![](../../../images/tutorials/dataflow/databases/list-of-dataflows.png)

La columna **[!UICONTROL Properties]** aparece en el lado derecho de la pantalla, incluido un botón de alternancia **[!UICONTROL Enabled]**. Seleccione la opción para desactivar el flujo de datos. Se puede utilizar la misma opción para volver a habilitar un flujo de datos una vez desactivado.
