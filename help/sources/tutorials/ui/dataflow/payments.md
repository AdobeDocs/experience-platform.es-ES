...
title: Configurar un flujo de datos para una conexión de origen de pago en la interfaz de usuario
topic-legacy: overview
type: Tutorial
description: Un flujo de datos es una tarea programada que recupera e incorpora datos de un origen a un conjunto de datos de Adobe Experience Platform. Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de pagos.
...
# Configurar un flujo de datos para una conexión de pago en la interfaz de usuario

Un flujo de datos es una tarea programada que recupera e incorpora datos de un origen a un conjunto de datos de Adobe Experience Platform. Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de pagos.
...
Además, este tutorial requiere que ya haya creado una cuenta de pagos. Puede encontrar una lista de tutoriales para crear diferentes conectores de pago en la interfaz de usuario en la [información general de conectores de origen](../../../home.md).

## Seleccionar datos

Después de crear su cuenta de pagos, aparece el paso **[!UICONTROL Select data]**, que proporciona una interfaz interactiva para explorar la jerarquía de archivos.
