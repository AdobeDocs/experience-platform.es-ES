...
# Crear un flujo de datos para un origen de pagos en la interfaz de usuario

Un flujo de datos es una tarea programada que recupera e incorpora datos de un origen a un conjunto de datos en Adobe Experience Platform. Este tutorial proporciona pasos sobre cómo crear un flujo de datos para una fuente de pagos mediante la interfaz de usuario de Platform.

>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener una cuenta autenticada con un origen de pagos. Puede encontrar una lista de tutoriales para crear distintas cuentas de fuentes de pagos en la interfaz de usuario en la [información general sobre fuentes](../../../home.md#payments).
...
Después de crear la cuenta de origen de pagos, la variable **[!UICONTROL Añadir datos]** aparece, proporcionando una interfaz para explorar la jerarquía de tablas de la cuenta de origen de pagos.
...
Al seguir este tutorial, ha creado correctamente un flujo de datos para traer los datos de su fuente de pagos a Platform. Los datos entrantes ahora se pueden usar en el flujo descendente [!DNL Platform] servicios como [!DNL Real-Time Customer Profile] y [!DNL Data Science Workspace]. Consulte los siguientes documentos para obtener más información:
