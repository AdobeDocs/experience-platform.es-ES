...
Además, este tutorial requiere que ya haya creado una cuenta de **[!UICONTROL eCommerce]**. Puede encontrar una lista de tutoriales para crear diferentes conectores **[!UICONTROL eCommerce]** en la interfaz de usuario en la [información general de conectores de origen](../../../home.md).

## Seleccionar datos

Después de crear la cuenta de **[!UICONTROL eCommerce]**, aparece el paso **[!UICONTROL Select data]**, que proporciona una interfaz interactiva para explorar la jerarquía de archivos.
