...
type: Tutorial
description: Un flujo de datos es una tarea programada que recupera e incorpora datos de un origen a un conjunto de datos [!DNL Platform] . Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de comercio electrónico.
...
Un flujo de datos es una tarea programada que recupera e incorpora datos de un origen a un conjunto de datos [!DNL Platform]. Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta **[!UICONTROL eCommerce]**.
...
Además, este tutorial requiere que ya haya creado una cuenta **[!UICONTROL eCommerce]**. Puede encontrar una lista de tutoriales para crear diferentes conectores **[!UICONTROL eCommerce]** en la interfaz de usuario en la [información general de conectores de origen](../../../home.md).

## Seleccionar datos

Después de crear su cuenta **[!UICONTROL eCommerce]**, aparece el paso **[!UICONTROL Select data]**, que proporciona una interfaz interactiva para explorar la jerarquía de archivos.
