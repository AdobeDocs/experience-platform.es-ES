...
Además, este tutorial requiere que ya haya creado una cuenta publicitaria. Puede encontrar una lista de tutoriales para crear diferentes conectores de pago en la interfaz de usuario en la [información general sobre conectores de origen](../../../home.md).

## Seleccionar datos

Después de crear la cuenta publicitaria, la variable **[!UICONTROL Seleccionar datos]** aparece, proporcionando una interfaz interactiva para explorar la jerarquía de archivos.
...
La variable **[!UICONTROL Seleccionar esquema]** se abre. Seleccione el esquema que desea aplicar al nuevo conjunto de datos y haga clic en **[!DNL Done]**.
