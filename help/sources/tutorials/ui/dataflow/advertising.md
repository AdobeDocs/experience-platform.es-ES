...
title: Creación de un flujo de datos con una fuente de publicidad en la IU
type: Tutorial
...
>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener una cuenta autenticada con una fuente de publicidad. Puede encontrar una lista de tutoriales para crear diferentes cuentas de fuentes de publicidad en la interfaz de usuario en [información general de orígenes](../../../home.md#advertising).
...
Después de crear la cuenta de origen de publicidad, la variable **[!UICONTROL Añadir datos]** Este paso aparece y proporciona una interfaz para explorar la jerarquía de tabla de la cuenta de origen de publicidad.
...
Al seguir este tutorial, ha creado correctamente un flujo de datos para llevar los datos de su fuente de publicidad a Platform. Ahora, los datos entrantes pueden utilizarse en el flujo descendente [!DNL Platform] servicios como [!DNL Real-Time Customer Profile] y [!DNL Data Science Workspace]. Consulte los siguientes documentos para obtener más información:
