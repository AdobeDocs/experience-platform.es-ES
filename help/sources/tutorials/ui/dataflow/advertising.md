...
# Configurar un flujo de datos para un conector de publicidad en la interfaz de usuario

Un flujo de datos es una tarea programada que recupera e ingiere datos de un origen a un conjunto de datos de la plataforma de experiencia de Adobe. Este tutorial proporciona pasos para configurar un nuevo flujo de datos con su cuenta de publicidad.
...
Después de crear la cuenta de publicidad, aparece el paso *Seleccionar datos* , que proporciona una interfaz interactiva para explorar la jerarquía de archivos.
...
![programar](../../../images/tutorials/dataflow/advertising/schedule.png)
