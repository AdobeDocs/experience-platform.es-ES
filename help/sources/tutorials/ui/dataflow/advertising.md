...
>[!NOTE]
>
>Para crear un flujo de datos, ya debe tener una cuenta autenticada con un origen publicitario. Puede encontrar una lista de tutoriales para crear distintas cuentas de fuentes de publicidad en la interfaz de usuario en la [información general sobre fuentes](../../../home.md#advertising).
