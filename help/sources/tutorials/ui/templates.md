...
>[!TIP]
>
>Puede acceder al flujo de datos de borrador a través de la [!UICONTROL Flujos de datos] página catálogo en el espacio de trabajo orígenes. Seleccionar **[!UICONTROL Flujos de datos]** en el encabezado superior y, a continuación, seleccione el flujo de datos que desee actualizar en la lista.
>
>![Una lista de flujos de datos existentes en el catálogo de flujos de datos del espacio de trabajo de fuentes.](../../images/tutorials/templates/dataflows.png)
...
Finalmente, revise los detalles del flujo de datos y, a continuación, seleccione **[!UICONTROL Guardar e introducir]** para publicar el borrador.
