...
Para utilizar fuentes de autoservicio (SDK por lotes), debe asegurarse de tener acceso a un Simulador para pruebas de organización proporcionado con fuentes de Adobe Experience Platform.
