...
La siguiente solicitud actualiza `name` del origen [!DNL MailChimp] creado en el paso anterior.
...
Una llamada correcta devuelve los detalles actualizados de la especificación de conexión, incluido su nombre actualizado.
