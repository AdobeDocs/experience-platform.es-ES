...
Para crear un ID de conexión base, realice una solicitud de POST al `/connections` extremo al proporcionar su *SU ORIGEN* credenciales de autenticación como parte del cuerpo de la solicitud.
