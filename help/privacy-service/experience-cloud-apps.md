...
| ------- | ----------- |
| [Adobe Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-64/managing/data-protection/data-protection-and-privacy.html) | Una visión general de cómo un administrador de privacidad del cliente o un administrador de AEM puede gestionar las solicitudes de RGPD. |
