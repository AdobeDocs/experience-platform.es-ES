...
Adobe Experience Platform [!DNL Privacy Service] está diseñada para admitir solicitudes de privacidad para varias aplicaciones de Adobe Experience Cloud. Cada aplicación admite distintos valores e ID de productos para identificar a los interesados.

Este documento sirve como referencia para [!DNL Experience Cloud] documentación de la aplicación que describe cómo configurar esa aplicación para operaciones relacionadas con la privacidad. Esto incluye cómo dar formato y etiquetar los datos. Se cubren dos categorías de aplicaciones:

* [Aplicaciones integradas con Privacy Service](#integrated): aplicaciones que pueden enviar solicitudes de acceso, eliminación u exclusión a [!DNL Privacy Service].
* [Aplicaciones de autoservicio](#self-serve): aplicaciones que deben administrar sus solicitudes de privacidad internamente y con las que no pueden comunicarse [!DNL Privacy Service] directamente.

Consulte la documentación de su [!DNL Experience Cloud] para obtener información sobre cómo dar formato a las solicitudes de privacidad y qué valores se admiten en ellas.

## Aplicaciones integradas con [!DNL Privacy Service] {#integrated}

La siguiente es una lista de [!DNL Experience Cloud] aplicaciones integradas con [!DNL Privacy Service], incluido el [!DNL Privacy Service] funciones con las que son compatibles, sus protocolos para procesar solicitudes de eliminación y vínculos a la documentación de para obtener más información.
...
| --- | :---: | :---: | --- | --- |
| Adobe Advertising Cloud | ✓ | ✓ | La ID de cookie del interesado o la ID de dispositivo se eliminan del sistema, junto con todos los datos de costes, clics e ingresos asociados con la cookie. | <ul><li>[Documentación de acceso o eliminación para el RGPD](https://experienceleague.adobe.com/docs/advertising-cloud/privacy/ad-cloud-gdpr.html)</li><li>[Documentación de acceso o eliminación para la CCPA](https://experienceleague.adobe.com/docs/advertising-cloud/privacy/ad-cloud-ccpa-access-delete.html)</li><li>[Documentación de exclusión de la venta para CCPA](https://experienceleague.adobe.com/docs/advertising-cloud/privacy/ad-cloud-ccpa-opt-out-of-sale.html)</li></ul> |
| Adobe Analytics | ✓ | ✓ | If `analyticsDeleteMethod` se omite o se establece en `anonymize` al realizar la solicitud de privacidad, todos los datos a los que se hace referencia en la recopilación de ID de usuario dada se vuelven anónimos. If `analyticsDeleteMethod` se establece en `purge`, todos los datos se eliminarán por completo. | <ul><li>[Documentación de acceso/eliminación](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/an-gdpr-overview.html?lang=es)</li><li>[!DNL Analytics] administra las solicitudes de exclusión mediante [variables de informes de privacidad](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/consent-variables.html?lang=es)</li></ul> |
...
La siguiente es una lista de [!DNL Experience Cloud] aplicaciones que no están integradas con [!DNL Privacy Service] y deben gestionar internamente sus problemas de privacidad. Se proporcionan vínculos a la documentación de cada aplicación, junto con descripciones del contenido de la documentación.
