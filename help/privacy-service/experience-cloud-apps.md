...
| Adobe Campaign Classic | ✓ | ✓ | Los datos almacenados del interesado se eliminan del sistema. | <ul><li>[Administración de la privacidad](https://experienceleague.adobe.com/es/docs/campaign-classic/using/getting-started/privacy/privacy-management)</li></ul> |
...
| Atributos del cliente de Adobe (CRS) | ✓ | N/A | Los atributos del interesado se eliminan del sistema. | <ul><li>[Acceder o eliminar la documentación de RGPD](https://experienceleague.adobe.com/es/docs/core-services/interface/services/customer-attributes/gdpr)</li><li>[Acceder o eliminar la documentación de la CCPA](https://experienceleague.adobe.com/es/docs/core-services/interface/services/customer-attributes/ccpa)</li><li>Los atributos del cliente no tienen la capacidad de transferir datos, por lo que las solicitudes de exclusión de la venta no son aplicables.</li></ul> |
...
| ------- | ----------- |
| [Adobe Experience Manager](https://experienceleague.adobe.com/es/docs/experience-manager-64/managing/data-protection/data-protection-and-privacy) | Una visión general de cómo un administrador de privacidad del cliente o un administrador de AEM puede gestionar las solicitudes de RGPD. |
