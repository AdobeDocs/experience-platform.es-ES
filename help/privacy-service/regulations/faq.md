...
>[!NOTE]
>
>Las definiciones de los diversos términos utilizados en este documento se encuentran en la [terminología de regulación de la privacidad](terminology.md) guía.
...
Un **controlador de datos** es la entidad que determina los propósitos, condiciones y medios para procesar datos personales, mientras que el **procesador de datos** es una entidad que procesa datos personales en nombre del controlador de datos.
