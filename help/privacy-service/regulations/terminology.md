...
**RGPD**: La [!DNL General Data Protection Regulation] (RGPD) es un marco jurídico que establece directrices para la recopilación y el procesamiento de información personal de personas dentro del Espacio Económico Europeo (EEE). El RGPD establece los principios para la gestión de datos y los derechos de las personas, al tiempo que impone multas que pueden basarse en los ingresos. El RGPD cubre todas las compañías que tratan con los datos de los ciudadanos del EEE, por lo que es una regulación crítica para los funcionarios de cumplimiento corporativo en bancos, aseguradoras y otras compañías financieras.
