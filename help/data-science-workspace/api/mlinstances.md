...
Puede eliminar todas las instancias MLI que compartan el mismo motor realizando una solicitud DELETE que incluya el ID del motor como parámetro de consulta.
...
Puede eliminar una sola instancia MLI realizando una solicitud DELETE que incluya el ID de la instancia MLI de destinatario en la ruta de solicitud.
