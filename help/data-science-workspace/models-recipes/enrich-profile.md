...
1. En Adobe Experience Platform, haga clic en la **[!UICONTROL Schema]** ficha para acceder al explorador de esquema. Haga clic en **[!UICONTROL Create Schema]** acceder al Editor *de*Esquemas, donde puede crear esquemas de forma interactiva.
   ![](../images/models-recipes/enrich-rtcdp/schema_browser.png)

2. En la ventana *Composición* , haga clic en **[!UICONTROL Assign]** para examinar las clases disponibles.
   * Para asignar una clase existente, haga clic en y resalte la clase deseada y, a continuación, haga clic en **[!UICONTROL Assign Class]**.
      ![](../images/models-recipes/enrich-rtcdp/existing_class.png)

   * Para crear una clase personalizada, haga clic en **[!UICONTROL Create New Class]** Encontrado cerca de la parte central de la ventana del explorador. Proporcione un nombre de clase, una descripción y elija el comportamiento de la clase. Haga clic **[!UICONTROL Assign Class]** cuando haya terminado.
...
3. En la ventana *Composición* , haga clic **[!UICONTROL Add]** en la subsección *Mezclas* .
   * Para asignar una mezcla existente, haga clic en y resalte la mezcla deseada y, a continuación, haga clic en **[!UICONTROL Add Mixin]**. A diferencia de las clases, se pueden asignar varias mezclas a un solo esquema siempre que sea apropiado.
      ![](../images/models-recipes/enrich-rtcdp/existing_mixin.png)

   * Para crear una nueva mezcla, haga clic en **[!UICONTROL Create New Mixin]** encontrado cerca de la parte central de la ventana del explorador. Proporcione un nombre y una descripción para la mezcla y haga clic **[!UICONTROL Assign Mixin]** una vez que haya terminado.
      ![](../images/models-recipes/enrich-rtcdp/create_new_mixin.png)

   * Para agregar campos de mezcla, haga clic en el nombre de la mezcla dentro de la ventana *Composición* . A continuación, se le proporcionará la opción de agregar campos de mezcla haciendo clic en **[!UICONTROL Add Field]** dentro de la ventana *Estructura* . Asegúrese de proporcionar las propiedades de mezcla correspondientes.
      ![](../images/models-recipes/enrich-rtcdp/mixin_properties.png)

4. Una vez que haya terminado de crear el esquema, haga clic en el campo de nivel superior del esquema dentro de la ventana *Estructura* para mostrar las propiedades del esquema en la ventana de propiedades de la derecha. Proporcione un nombre y una descripción y haga clic en **[!UICONTROL Save]** para crear el esquema.
   ![](../images/models-recipes/enrich-rtcdp/save_schema.png)

5. Cree un conjunto de datos de salida con el esquema recién creado haciendo clic en **[!UICONTROL Datasets]** la columna de navegación izquierda y luego haga clic en **[!UICONTROL Create dataset]**. En la siguiente pantalla, elija **[!UICONTROL Create dataset from schema]**.
   ![](../images/models-recipes/enrich-rtcdp/dataset_overview.png)

6. Con el navegador de esquema, busque y seleccione el esquema recién creado y, a continuación, haga clic en **[!UICONTROL Next]**.
   ![](../images/models-recipes/enrich-rtcdp/choose_schema.png)

7. Proporcione un nombre y una descripción opcional y, a continuación, haga clic en **[!UICONTROL Finish]** para crear el conjunto de datos.
...
3. Establezca el campo como identidad principal habilitando la propiedad **[!UICONTROL Identity]** del campo, la propiedad **[!UICONTROL Primary Identity]** y, a continuación, seleccionando una **[!UICONTROL Identity Namespace]**. Haga clic **[!UICONTROL Apply]** una vez que haya realizado los cambios.
   ![](../images/models-recipes/enrich-rtcdp/set_identity.png)

4. Haga clic en el objeto de nivel superior de la estructura del esquema para mostrar las propiedades del esquema y activar el esquema para el Perfil alternando el **[!UICONTROL Profile]** conmutador. Haga clic en **[!UICONTROL Save]** para finalizar los cambios. El conjunto de datos que se creó con este esquema ahora puede habilitarse para Perfil.
...
6. Habilite el conjunto de datos para el Perfil alternando el **[!UICONTROL Profile]** conmutador que se encuentra en la columna de información derecha.
...
1. En Adobe Experience Platform, haga clic en la **[!UICONTROL Segments]** ficha seguida de **[!UICONTROL Create Segment]** para acceder al Generador de segmentos.
...
5. Seleccione un nombre apropiado **[!UICONTROL Merge Policy]**, proporcione un nombre y una descripción opcional y haga clic en **[!UICONTROL Save]** para completar el nuevo segmento.
