...
Además, cada organización solo puede tener **one** directiva de combinación activa en edge. Si una directiva de combinación está activa en Edge, puede utilizarse para otros sistemas Edge, como Perfil de Edge, Segmentación de Edge y Destinations on Edge.
