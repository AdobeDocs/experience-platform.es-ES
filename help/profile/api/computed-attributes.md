...
1. **Uso de la aplicación:** Otro ejemplo incluye la capacidad de acumulado del número de veces que un usuario abre la aplicación. Al rastrear el número total de aperturas de aplicaciones, en función de eventos abiertos individuales, puede enviar ofertas o mensajes especiales a los usuarios en su 100° número de aperturas abiertas, lo que estimula un compromiso más profundo con su marca.
...
Para definir correctamente un campo de atributo calculado, el esquema debe estar habilitado para el Perfil y aparecer como parte del esquema de unión para la clase en la que se basa el esquema. Para obtener más información sobre esquemas y uniones habilitados para Perfiles, consulte la sección de la guía para desarrolladores del Registro de Esquemas sobre la [activación de un esquema para Perfil y visualización de esquemas](../../xdm/api/getting-started.md)de unión. También se recomienda examinar la [sección sobre uniones](../../xdm/schema/composition.md) en la documentación básica sobre la composición del esquema.

El flujo de trabajo de este tutorial utiliza un esquema con Perfil habilitado y sigue los pasos para definir una nueva combinación que contenga el campo de atributo calculado y garantizar que sea la Área de nombres correcta. Si ya tiene un campo que se encuentra en la Área de nombres correcta dentro de un esquema con Perfil habilitado, puede continuar directamente con el paso para [crear un atributo](#create-a-computed-attribute)calculado.

### Vista de un esquema

Los pasos siguientes utilizan la interfaz de usuario de Adobe Experience Platform para localizar un esquema, agregar una mezcla y definir un campo. Si prefiere utilizar la API del Registro de Esquema, consulte la guía [para desarrolladores de](../../xdm/api/getting-started.md) Esquema Registry para ver los pasos sobre cómo crear una mezcla, agregar una mezcla a un esquema y habilitar un esquema para su uso con el Perfil del cliente en tiempo real.

En la interfaz de usuario, haga clic en **Esquemas** en el carril izquierdo y utilice la barra de búsqueda de la ficha *Examinar* para encontrar rápidamente el esquema que desea actualizar.

![](../images/computed-attributes/Schemas-Browse.png)

Una vez que haya localizado el esquema, haga clic en su nombre para abrir el Editor de Esquemas, donde podrá realizar modificaciones en el esquema.

![](../images/computed-attributes/Schema-Editor.png)

### Crear una mezcla

Para crear una nueva mezcla, haga clic en **Añadir** junto a *Mezclinas* en la sección *Composición* en la parte izquierda del editor. Esto abre el cuadro de diálogo **Añadir mezcla** , donde puede ver las mezclas existentes. Haga clic en el botón de radio para **Crear nueva mezcla** para definir la nueva mezcla.

Asigne un nombre y una descripción a la mezcla y haga clic en **Añadir mezcla** cuando la haya completado.

![](../images/computed-attributes/Add-mixin.png)

### Añadir un campo de atributo calculado en el esquema

La nueva mezcla debe aparecer ahora en la sección *Mezclas* en *Composición*. Haga clic en el nombre de la mezcla y aparecerán varios botones de campo **** Añadir en la sección *Estructura* del editor.

Seleccione **Añadir campo** junto al nombre del esquema para agregar un campo de nivel superior, o bien puede seleccionar agregar el campo en cualquier lugar dentro del esquema que prefiera.

Después de hacer clic en **Añadir campo** , se abre un nuevo objeto, denominado por su ID de inquilino, que muestra que el campo está en la Área de nombres correcta. Dentro de ese objeto, aparece un campo ** Nuevo. Esto sucede si el campo en el que se va a definir el atributo calculado.

![](../images/computed-attributes/New-field.png)

### Configurar el campo

Mediante la sección Propiedades *del* campo a la derecha del editor, proporcione la información necesaria para el nuevo campo, incluido su nombre, nombre para mostrar y tipo.
...
Cuando termine, haga clic en **Aplicar** y aparecerá el nombre del campo, así como su tipo en la sección *Estructura* del editor.

![](../images/computed-attributes/Apply.png)

### Habilitar esquema para Perfil

Antes de continuar, asegúrese de que el esquema se ha habilitado para el Perfil. Haga clic en el nombre del esquema en la sección *Estructura* del editor para que aparezca la ficha Propiedades *del* Esquema. Si el control deslizante del **Perfil** es azul, el esquema se ha activado para el Perfil.

>[!NOTE]
>No se puede deshacer la activación de un esquema para Perfil, por lo que si hace clic en el control deslizante una vez activado, no tendrá que correr el riesgo de deshabilitarlo.

![](../images/computed-attributes/Profile.png)

Ahora puede hacer clic en **Guardar** para guardar el esquema actualizado y continuar con el resto del tutorial con la API.

### Crear un atributo calculado {#create-a-computed-attribute}

Con el campo de atributo calculado identificado y la confirmación de que el esquema está habilitado para Perfil, ahora puede configurar un atributo calculado.
...
| `expression.value` | Una expresión de lenguaje de Consulta de Perfil (PQL) válida. Para obtener más información sobre PQL y vínculos a consultas compatibles, lea la descripción general [de](../../segmentation/pql/overview.md)PQL. |
...
| Propiedad | Descripción |
|---|---|
| `{NEW_EXPRESSION_VALUE}` | Una expresión de lenguaje de Consulta de Perfil (PQL) válida. Para obtener más información sobre PQL y vínculos a consultas compatibles, lea la descripción general [de](../../segmentation/pql/overview.md)PQL. |
