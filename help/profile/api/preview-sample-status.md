...
Puede realizar una solicitud de GET a `/previewsamplestatus` punto final para ver los detalles del último trabajo de muestra correcto que se ejecutó para su organización IMS. Esto incluye el número total de perfiles en la muestra, así como la métrica de recuento de perfiles o el número total de perfiles que su organización tiene dentro del Experience Platform.
