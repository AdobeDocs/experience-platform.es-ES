...
* [Esquemas](../xdm/home.md): los esquemas XDM (Experience Data Model) son el marco estandarizado mediante el cual Platform organiza los datos de experiencia del cliente.
* [Audiencias](../segmentation/home.md): El motor de segmentación de Platform se usa para crear audiencias a partir de los perfiles de clientes en función de los comportamientos y atributos de los clientes.
...
| Recuento de identidades para el gráfico de identidades de perfil individual | 50 | Protección impuesta por el sistema | **El número máximo de identidades en un gráfico de identidad para un perfil individual es 50.**: todos los perfiles con más de 50 identidades se excluyen de la segmentación, las exportaciones y las búsquedas. |
