...
Además, la asignación de tipos de datos para `eventType` en el ejemplo anterior son los siguientes (los campos solo de creación de informes no deben estar presentes en la carga útil):

| eventType | datatypes | campos solo de creación de informes (ignorados) |
| -------- | ------ | ---------- |
| mediaSessionStart | sessionDetails | ID, adCount, averageMinuteAudience, chapterCount, estimatedStreams, hasPauseImpactedStreams, hasProgress10, hasProgress25, hasProgress50, hasProgress75, hasProgress95, hasSegmentView, isCompleted, isDownloaded, isFederated, isPlayed, isViewed, pauseCount, pauseTime, secondsSinceLastCall, segment, timePlayed, totalTimePlayed, TimePlayed, pev3, pccr |
...
## Solicitud de evento de inicio de búfer
