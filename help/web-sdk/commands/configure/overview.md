...
Se requieren las propiedades [`datastreamId`](datastreamid.md) y [`orgId`](orgid.md). Todas las demás propiedades son opcionales, según los requisitos de implementación de su organización.
