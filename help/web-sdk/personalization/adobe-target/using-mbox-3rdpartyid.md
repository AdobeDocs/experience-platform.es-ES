...
description: Aprenda a utilizar mbox3rdPartyId con Adobe Experience Platform Web SDK.
...
## Cómo usar `mbox3rdPartyId` con Web SDK
...
![IU de Experience Platform que muestra el campo de área de nombres de ID de terceros de Target.](assets/mbox3rdpartyid.png)
