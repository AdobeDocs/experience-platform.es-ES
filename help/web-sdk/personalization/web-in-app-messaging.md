...
Para obtener más información sobre la configuración de un CSP, consulte la [documentación dedicada](../use-cases/configuring-a-csp.md).
...
En el [Configuración del SDK web](../commands/configure/overview.md) configure el `personalizationStorageEnabled` opción según sus necesidades:
