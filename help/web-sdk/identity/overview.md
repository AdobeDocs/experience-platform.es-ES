...
Este documento proporciona información general sobre cómo administrar [!DNL ECIDs] mediante el SDK web.

## Seguimiento de ECID mediante SDK web {#tracking-ecids-we-sdk}
