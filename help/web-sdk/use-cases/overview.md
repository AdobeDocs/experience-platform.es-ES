...
Para obtener información detallada sobre la implementación de casos de uso admitidos, consulte su documentación correspondiente en la [Página de proyecto de casos de uso del SDK web](https://github.com/orgs/adobe/projects/18/views/1?filterQuery=).
