...
Adobe no garantiza estas extensiones de terceros y, por lo tanto, es responsabilidad de sus autores elegir una licencia y un proceso de asistencia para ellas. Muchos desarrolladores han elegido publicar el código fuente de sus paquetes de extensión en un repositorio público de GitHub donde los usuarios de pueden revisarlo según les convenga. Consulte el grupo de desarrolladores de [Connections en GitHub](https://github.com/Connections-Developers) para obtener más información.
