...
La extensión de etiquetas de privacidad de Adobe le permite recopilar y eliminar ID de usuario asignados a usuarios finales por soluciones de Adobe en dispositivos del lado del cliente. Las ID recopiladas se pueden enviar a [Adobe Experience Platform Privacy Service](../../../../privacy-service/home.md) para acceder a los datos personales de las personas relacionadas o eliminarlos en las aplicaciones de Adobe Experience Cloud compatibles.

Esta guía explica cómo instalar y configurar la extensión de privacidad de Adobe en la interfaz de usuario de Experience Platform o de recopilación de datos.
...
Seleccione **[!UICONTROL Extensions]** en el panel de navegación izquierdo, seguido de la ficha **[!UICONTROL Catalog]**. Utilice la barra de búsqueda para reducir la lista de extensiones disponibles hasta que encuentre Privacidad de Adobe. Seleccione **[!UICONTROL Install]** para continuar.
...
Una vez que haya terminado de agregar parámetros para las soluciones seleccionadas, seleccione **[!UICONTROL Save]** para guardar la configuración.
...
* **[!UICONTROL Retrieve Identities]**: se ha recuperado la información de identidad almacenada del usuario.
* **[!UICONTROL Remove Identities]**: se ha quitado la información de identidad almacenada del usuario.
* **[!UICONTROL Retrieve Then Remove Identities]**: se recupera y se quita la información de identidad almacenada del usuario.
...
Inicie el proceso de creación de un nuevo elemento de datos seleccionando **[!UICONTROL Data Elements]** en la navegación izquierda, seguido de **[!UICONTROL Add Data Element]**. Una vez que esté en la pantalla de configuración, seleccione **[!UICONTROL Core]** para la extensión y **[!UICONTROL Custom Code]** para el tipo de elemento de datos. Aquí, seleccione **[!UICONTROL Open Editor]** en el panel derecho.
...
Después de instalar la extensión, puede desactivarla o eliminarla. Seleccione **[!UICONTROL Configure]** en la tarjeta de privacidad de Adobe de sus extensiones instaladas y, a continuación, seleccione **[!UICONTROL Disable]** o **[!UICONTROL Uninstall]**.

## Próximos pasos

En esta guía se explica el uso de la extensión de etiquetas Adobe Privacy en la interfaz de usuario. Para obtener más información sobre las funcionalidades proporcionadas por la extensión, incluidos ejemplos de cómo emplearla con código sin procesar, consulte la [descripción general de la biblioteca JavaScript de privacidad](../../../../privacy-service/js-library.md) en la documentación de Privacy Service.
