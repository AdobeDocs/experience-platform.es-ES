...
>[!IMPORTANT]
>
>La extensión está pensada para utilizarse con la extensión Adobe Experience Platform Web SDK. Para ver información sobre la versión que se usará con AppMeasurement, consulte la descripción general de la [extensión de complementos de Analytics comunes](../plugins/overview.md).

Este documento explica cómo configurar la extensión de etiquetas Web SDK Plugins y cómo utilizarla para aumentar la [extensión Adobe Experience Platform Web SDK](../web-sdk/overview.md).

## Configuración de la extensión Common Web SDK Plugins

Esta sección proporciona una referencia sobre las opciones disponibles al configurar la extensión de complementos de Web SDK.

>[!IMPORTANT]
>
>La extensión Common Web SDK Plugins está diseñada para aumentar la extensión de Adobe Experience Platform Web SDK, pero no es necesario tenerla instalada para que la extensión funcione según lo esperado.

## Añadir complementos a la extensión de Adobe Experience Platform Web SDK
