...
A continuación se muestra una lista de la documentación de las extensiones de reenvío de eventos del lado del servidor. Para obtener una lista de las extensiones de cliente disponibles, consulte [referencia de extensiones de etiqueta](../client/overview.md).
...
* [Conector de nube para Google Analytics](https://exchange.adobe.com/apps/ec/106542)*
...
* [API de conversión [!DNL LinkedIn]](./linkedin/overview.md)
* [[!DNL Mailchimp] Edge](./mailchimp/overview.md)
* [API de conversiones [!DNL Meta]](./meta/overview.md)
...
* [API de conversiones instantáneas](https://exchange.adobe.com/apps/ec/108550)*
* [Snowflake](./snowflake/overview.md)
* [[!DNL Splunk]](./splunk/overview.md)
* [[!DNL Twitter]](./twitter/overview.md)
* [API de eventos web [!DNL Tiktok]](./tiktok/overview.md)
* [API de eventos [!DNL Zendesk]](./zendesk/overview.md)
