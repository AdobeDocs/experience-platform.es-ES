...
>abstract="Para que el reenvío de eventos pueda utilizar un secreto, debe asignarse a un entorno existente. Si no ha creado ningún entorno para la propiedad de reenvío de eventos, debe configurarlo antes de continuar."
...
La siguiente pantalla le permite configurar los detalles del secreto. Para que el reenvío de eventos pueda utilizar un secreto, debe asignarse a un entorno existente. Si no ha creado ningún entorno para la propiedad de reenvío de eventos, consulte la guía de [entornos](../publishing/environments.md) para obtener instrucciones sobre cómo configurarlos antes de continuar.
