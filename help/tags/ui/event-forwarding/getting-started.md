...
1. Cree un esquema seleccionando **[!UICONTROL Schemas]** > **[!UICONTROL Create Schema]** y luego la opción **[!UICONTROL XDM ExperienceEvent]**.

1. Asigne al esquema un nombre y una descripción breve.

1. Puede agregar el grupo de campos Detalles web de ExperienceEvent seleccionando **[!UICONTROL Add]** junto a **[!UICONTROL Field Groups]**.
...
En el área de trabajo **[!UICONTROL Tags]**, cree una propiedad de tipo **[!UICONTROL Edge]**.
...
Después de crear la propiedad, vaya a la pestaña **[!UICONTROL Environments]** de la nueva propiedad y tome
...
1. Seleccione el entorno Desarrollo, Producción o Ensayo.
   ...
   O bien, para enviar datos a un entorno de reenvío de eventos fuera de la organización de Adobe, seleccione **[!UICONTROL Switch to Advanced Mode]** y pegue el valor en un ID. El ID se proporciona al crear un evento reenviado a una propiedad.
...
Cree su propiedad en el área de trabajo **[!UICONTROL Tags]**, luego vaya a **[!UICONTROL Extensions]** y seleccione la extensión Experience Platform Web SDK en el catálogo para configurarla e instalarla.
...
1. Seleccione **[!UICONTROL Events Add]**.

1. Seleccione una extensión y uno de los tipos de evento disponibles para dicha extensión para añadir un evento y, a continuación, especifique la configuración del evento. Por ejemplo, seleccione **[!UICONTROL Core - Window Loaded]**.

1. Añada una acción con la extensión Experience Platform Web SDK. Seleccione **[!UICONTROL Send Event]** de la lista **[!UICONTROL Action Type]**, seleccione la instancia deseada (instancia de Alloy configurada anteriormente) y, a continuación, seleccione un elemento de datos para añadirlo al bloque de datos XDM en la visita de Alloy.

1. Deje el resto de la configuración como predeterminada para este ejemplo y seleccione **[!UICONTROL Save]**.

Para otro ejemplo, puede crear una regla que envíe la capa de datos a Edge si el usuario coloca el puntero por encima de un botón determinado.
