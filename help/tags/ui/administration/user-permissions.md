...
>[!NOTE]
>
>Para obtener información sobre cómo configurar permisos para usuarios que usan Admin Console, consulte el tutorial sobre [administración de permisos para la recopilación de datos](../../../collection/permissions.md).
...
Esto es similar a la &quot;Separación de tareas&quot; anterior, pero se organiza por áreas geográficas. Por ejemplo, puede crear un perfil &quot;Desarrollar&quot; y un perfil &quot;Publicar&quot; para Norteamérica, así como crear grupos &quot;Desarrollar&quot; y &quot;Publicar&quot; independientes para Europa.
...
| Equipo de TI | No modifica ninguna etiqueta, pero tiene control total sobre los entornos de ensayo y producción y qué incluye cada uno. | Inclusión automática | (Ninguno) | <ul><li>Aprobar</li><li>Publicación</li><li>Administrar entornos</li></ul> |
...
| El superusuario | Lo hace todo. | Inclusión automática | <ul><li>Desarrollo</li><li>Aprobar</li><li>Publicación</li><li>Administración de extensiones</li><li>Administrar entornos</li></ul> | <ul><li>Administrar propiedades</li></ul> |
