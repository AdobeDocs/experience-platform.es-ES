...
Cuando haya instalado una extensión en su propiedad y en el catálogo aparezca una versión más reciente, en la tarjeta de la extensión aparece un botón [!UICONTROL Upgrade] al abrir la página Installed Extensions.
...
1. Seleccione **[!UICONTROL Upgrade]** para ir a la pantalla [!UICONTROL Extension Configuration].
1. Aplique cualquier cambio de configuración que desee.
1. Seleccione **[!UICONTROL Save]**.

La actualización no comienza hasta que pulse **[!UICONTROL Save]**. Antes de ello, puede seleccionar [!UICONTROL Cancel] y permanecer en la versión instalada. Cuando se selecciona **[!UICONTROL Save]** ya no hay vuelta atrás.
...
Desde la pantalla [!UICONTROL Edit Library], puede utilizar el botón “[!UICONTROL Add All Changed Resources]” o el botón “[!UICONTROL Add a Resource]” y seleccionar la extensión actualizada por su cuenta.

>[!TIP]
>
>Los desarrolladores de extensiones pueden añadir nuevos elementos de configuración a sus vistas de extensión para habilitar nuevas funciones.  Si ve errores de compilación después de actualizar a una nueva versión de la extensión (y ha aislado los errores en esa compilación), lo primero que debe hacer es ir a la página “Configure” de la extensión y asegurarse de usar Save (aunque no haya cambiado nada). A continuación, añada el nuevo cambio a la biblioteca e intente volver a compilarlo.
