...
Para que un usuario pueda acceder a las funciones de las etiquetas, un administrador debe añadir sus cuentas a un perfil de producto en Adobe Admin Console, que concede al usuario acceso a propiedades específicas y funciones de recopilación de datos. Para obtener más información sobre cómo conceder permisos para la recopilación de datos, consulte la [Guía de permisos de recopilación de datos](../../../collection/permissions.md).
