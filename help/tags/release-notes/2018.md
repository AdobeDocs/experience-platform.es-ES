...
Una extensión es un paquete de código (JavaScript, HTML y CSS) que amplía las funcionalidades de las etiquetas. &#x200B;Cree, gestione y actualice sus integraciones con una interfaz de autoservicio virtual. Podríamos equiparar una etiqueta con un sistema operativo y las extensiones con las aplicaciones que usa para realizar sus tareas.
