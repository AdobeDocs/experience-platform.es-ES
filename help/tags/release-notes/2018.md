...
* Las condiciones y las excepciones se han combinado en el Generador de reglas para tener en cuenta el orden. Esto refleja de forma más precisa cómo se tratan dentro del sistema y en el tiempo de ejecución. Para añadir una excepción, seleccione el botón **[!UICONTROL Add]** en [!UICONTROL Conditions] y seleccione **[!UICONTROL Exception]** en el selector de [!UICONTROL Logic Type].
...
El catálogo de extensiones ahora se ordena por nombre para mostrar en lugar de por nombre.
...
Se ha modificado el comportamiento del botón [!UICONTROL Add All Changes] en la página [!UICONTROL Edit Library]. Anteriormente, un recurso solo se consideraba “modificado” hasta que lo añadir a una biblioteca y lo guardaba. Ahora un recurso se considera “modificado” hasta que se ha publicado en el entorno de producción.
...
* Habilite o deshabilite las acciones si desea añadir elementos a la Biblioteca activa
...
* Activación de la ejecución asíncrona en los entornos,
  ...
  Al recuperar el código incrustado para un entorno, ahora puede pulsar un conmutador para obtener el código incrustado si desea que la biblioteca se cargue de forma asíncrona.
