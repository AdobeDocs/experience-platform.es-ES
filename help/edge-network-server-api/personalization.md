---
title: Recuperar contenido personalizado de otras soluciones de Adobe
...
keywords: personalización; api de servidor; Adobe Experience Platform Edge Network; recuperar personalización
...
# Recuperar contenido personalizado de soluciones de Adobe
...
* **Ámbito**: El alcance de la decisión.
   ...
   * Para [!DNL Offer Decisioning], son las cadenas codificadas Base64 de JSON que contienen los ID de actividad y ubicación que desea que utilice el servicio de offer decisioning para proponer ofertas.
...
| --- | --- | --- |
| `schemas` | `String[]` | *Opcional*. Lista de esquemas utilizados en la decisión, para seleccionar el tipo de ofertas devueltas. |
...
| `payload.scopeDetails.decisionProvider` | Cadena | Esto puede ser `TGT` si utiliza Adobe Target o `ODE` si utiliza [!DNL Offer Decisioning]. |
...
## Recuperar contenido {#retrieve-content}
