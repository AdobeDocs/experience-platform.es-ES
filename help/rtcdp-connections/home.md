...
title: Información general sobre las conexiones de Real-time Customer Data Platform
...
# Información general sobre conexiones de Real-time Customer Data Platform

Las conexiones de Real-time Customer Data Platform (RTCDP) proporcionan un conjunto de tecnologías que le permiten recopilar datos de experiencia del cliente de fuentes del lado del cliente y enviarlos a la red perimetral de Adobe Experience Platform, donde se pueden enriquecer, transformar y distribuir a destinos de Adobe o que no sean de Adobe en segundos.

Las conexiones RTCDP son compatibles con las siguientes fuentes del lado del cliente:

* Aplicaciones basadas en la Web
* Aplicaciones móviles nativas
* Aplicaciones OTT

Las conexiones RTCDP se centran en la capacidad de detección y accesibilidad de los conjuntos de datos ingestados, que abarcan lo siguiente:
...
Esta guía proporciona una introducción de alto nivel: Conexiones RTCDP y cómo funciona para enviar datos a productos de Adobe Experience Cloud y aplicaciones que no son de Adobe a través de la red perimetral de Platform.
...
Este documento proporciona información general de alto nivel sobre cómo funcionan las conexiones RTCDP para automatizar el proceso de envío de los datos de experiencia del cliente recopilados a productos de Adobe y destinos de terceros.
