...
description: Información general de alto nivel sobre cómo administrar permisos y controlar el acceso a las funciones en conexiones de Real-time Customer Data Platform (RTCDP).
