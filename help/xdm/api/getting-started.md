...
A través de las guías de la API verá referencias a un `TENANT_ID`. Este ID se utiliza para garantizar que los recursos que crea tengan un espacio de nombres correcto y estén contenidos en su organización IMS. Si no conoce su ID, puede acceder a él realizando la siguiente solicitud de GET:
