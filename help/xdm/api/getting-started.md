...
En todas las guías de API verá referencias a un `TENANT_ID`. Este ID se utiliza para garantizar que los recursos que crea tengan un espacio de nombres adecuado y estén contenidos dentro de su organización de IMS. Si no conoce su ID, puede acceder a él realizando la siguiente solicitud de GET:
