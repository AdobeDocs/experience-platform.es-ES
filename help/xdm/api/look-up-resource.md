...
description: Puede buscar recursos específicos en la API del Registro de Esquema realizando una solicitud de GET que incluya el $id (URI con codificación URL) del recurso en la ruta de la solicitud.
