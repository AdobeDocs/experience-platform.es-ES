...
![Estructura del grupo de campos](../../images/field-groups/healthcare-account/account.png)
...
| [!UICONTROL Estado de facturación] | `billingStatus` | [[!UICONTROL Concepto codificable]](../../data-types/healthcare/codeable-concept.md) | Rastrea el ciclo de vida de la cuenta a través del proceso de facturación. Indica cómo se tratan las transacciones cuando se asignan a la cuenta. |
...
| [!UICONTROL Moneda] | `currency` | [[!UICONTROL Concepto codificable]](../../data-types/healthcare/codeable-concept.md) | La moneda predeterminada de la cuenta. |
...
| [!UICONTROL Identificador] | `identifier` | Matriz de [[!UICONTROL identificador]](../../data-types/healthcare/identifier.md) | Un identificador único utilizado para hacer referencia a la cuenta. Puede o no estar destinado al uso humano (por ejemplo, número de tarjeta de crédito). |
| [!UICONTROL Propietario] | `owner` | [[!UICONTROL Referencia]](../../data-types/healthcare/reference.md) | Indica el área de servicio, el hospital, el departamento, etc. con responsabilidad en la administración de la cuenta. |
...
| [!UICONTROL Período de servicio] | `servicePeriod` | [[!UICONTROL Período]](../../data-types/healthcare/period.md) | El intervalo de fechas de los servicios asociados con esta cuenta. |
...
![estructura de cobertura](../../images/field-groups/healthcare-account/coverage.png)
