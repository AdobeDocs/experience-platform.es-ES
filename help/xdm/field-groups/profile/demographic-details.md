...
[!UICONTROL Demographic Details] es un grupo de campos de esquema estándar para la  [[!DNL XDM Individual Profile] clase](../../classes/individual-profile.md). El grupo de campos proporciona un objeto `person` de nivel raíz cuyos subcampos describen información sobre una persona individual.
