...
| `b2b.convertedDate` | Fecha/Hora | La fecha de conversión si el posible cliente se convirtió correctamente. |
...
| `b2b.personScore` | Duplicada | Una puntuación generada para la persona por un sistema CRM. |
...
| `extSourceSystemAudit` | [Atributos de auditoría del sistema Source externo](../../data-types/external-source-system-audit-attributes.md) | Si la relación de persona de negocios proviene de un sistema de origen externo, este objeto captura atributos de auditoría para ese sistema. |
