...
# [!UICONTROL Adobe Analytics ExperienceEvent Full Extension] grupo de campos de esquema
...
| Propiedad | Tipo de datos | Descripción |
| --- | --- | --- |
| `firstWeb` | [[!UICONTROL Web Information]](../../data-types/web-information.md) | La información relacionada con la página web, el vínculo y el referente del primer evento de experiencia de este usuario final. |
...
Cada objeto de evento utiliza el tipo de datos [[!UICONTROL Measure]](../../data-types/measure.md), proporcionando un identificador único y un valor cuantificable.
...
| Propiedad | Tipo de datos | Descripción |
| --- | --- | --- |
| `search` | [[!UICONTROL Search]](../../data-types/search.md) | Registra información relacionada con la búsqueda web o móvil de la entrada de sesión. |
| `web` | [[!UICONTROL Web Information]](../../data-types/web-information.md) | Registra información sobre los clics en vínculos, los detalles de página web, la información del referente y los detalles del explorador para la entrada de sesión. |
