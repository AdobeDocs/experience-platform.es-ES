...
description: Obtenga información acerca del grupo de campos de esquema Detalles de marketing de campaña.
...
| --- | --- | --- |
| `marketing` | [Marketing](../../data-types/marketing.md) | Un objeto que describe la información de la campaña de marketing, como el grupo, el nombre y el código de seguimiento de la campaña. |

{style="table-layout:auto"}

Para obtener más información sobre el grupo de campos, consulte el repositorio XDM público:

* [Ejemplo completado](https://github.com/adobe/xdm/blob/master/components/fieldgroups/experience-event/experienceevent-marketing.example.1.json)
