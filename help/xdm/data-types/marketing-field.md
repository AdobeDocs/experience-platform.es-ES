...
# [!UICONTROL Campo de preferencias de marketing genéricas] tipo de datos

[!UICONTROL Campo de preferencias de marketing genéricas] es un tipo de datos XDM estándar que describe la selección de un cliente para una preferencia de marketing determinada.
...
>
>Si necesita un `subscriptions` para un campo de preferencias de marketing concreto, se debe utilizar la variable [campo de marketing con tipo de datos de suscripciones](./marketing-field-subscriptions.md) en su lugar.
