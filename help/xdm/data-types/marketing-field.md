...
# [!UICONTROL Tipo de ] datos de campo de preferencia de marketing genérico

[!UICONTROL Los campos de preferencias de marketing genéricas ] son un tipo de datos XDM estándar que describe la selección de un cliente para una preferencia de marketing determinada.
