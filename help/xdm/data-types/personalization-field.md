...
title: Tipo de datos del campo de preferencias genéricas de Personalization
description: Obtenga información sobre el tipo de datos XDM del campo de preferencia de Personalization genérico.
...
# [!UICONTROL Campo de preferencias genéricas de Personalization] tipo de datos

El [!UICONTROL campo de preferencias genéricas de Personalization] es un tipo de datos XDM estándar que describe la selección de un cliente para una preferencia de personalización determinada.
