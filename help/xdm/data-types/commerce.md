...
description: Obtenga información sobre el tipo de datos del Modelo de datos de experiencia de Commerce (XDM).
...
# tipo de datos [!UICONTROL Commerce]

[!UICONTROL Commerce] es un tipo de datos estándar del Modelo de datos de experiencia (XDM) que describe los registros relacionados con la compra y venta.

![Un diagrama del tipo de datos [!UICONTROL Commerce].](../images/data-types/commerce.png)
...
| [!UICONTROL Abandones del carro de compras] | `cartAbandons` | [[!UICONTROL Medida]](./measure.md) | Describe cuándo se ha identificado una lista de productos como que el usuario ya no puede acceder a ella ni comprarla. |
...
| [!UICONTROL La lista de productos (carrito) agrega] | `productListAdds` | [[!UICONTROL Medida]](./measure.md) | Adición de un producto a la lista de productos; por ejemplo, un producto que se agrega a un carro de compras. |
| [!UICONTROL Se Abre La Lista De Productos (Carro De Compras)] | `productListOpens` | [[!UICONTROL Medida]](./measure.md) | Inicializaciones de una nueva lista de productos, como, por ejemplo, la creación de un carro de compras. |
| Eliminaciones De [!UICONTROL Lista De Productos (Carro De Compras)] | `productListRemovals` | [[!UICONTROL Medida]](./measure.md) | Eliminación o eliminaciones de una entrada de producto de una lista de productos; por ejemplo, un producto que se está eliminando de un carro de compras. |
...
| [!UICONTROL Carro] | `cart` | [[!UICONTROL carro]](./cart.md) | Las propiedades del carrito de compras que contiene uno o más productos. |
...
| [!UICONTROL Se Abre La Lista De Solicitudes] | `requisitionListOpens` | [[!UICONTROL Medida]](./measure.md) | Indica la inicialización de una nueva lista de solicitudes. |
...
| [!UICONTROL La lista de solicitudes agrega] | `requisitionListAdds` | [[!UICONTROL Medida]](./measure.md) | Indica la adición de un producto a una lista de solicitudes. |
| [!UICONTROL Eliminaciones de listas de solicitudes] | `requisitionListRemovals` | [[!UICONTROL Medida]](./measure.md) | Indica la eliminación de un producto de una lista de productos de solicitud. |
| [!UICONTROL Lista de solicitudes] | `requisitionList` | [[!UICONTROL lista de solicitudes]](./requisition-list.md) | Las propiedades de la lista de solicitudes creada por el cliente. |
...
## tipo de datos [!UICONTROL facturación] {#billing}
...
Para obtener más información sobre el tipo de datos [!UICONTROL Commerce], consulte el repositorio XDM público:
