...
* Cómo funcionan los destinos {#how-destinations-work}
   ...
   * [Ciclo de vida de audiencia en destinos de flujo](./how-destinations-work/audience-lifecycle-streaming-destinations.md)
...
* Guías de IU {#ui}
   ...
   * Activación de datos en destinos{#activate}
      ...
      * [Búsqueda de atributos de perfil en Edge en tiempo real](./ui/activate-edge-profile-lookup.md)
      ...
      * [Exportar archivos bajo demanda a destinos por lotes mediante la interfaz de usuario de Experience Platform](./ui/export-file-now.md)
      * [Exportación de conjuntos de datos mediante la IU de Experience Platform](./ui/export-datasets.md)
      * [Ampliar las programaciones de exportación de conjuntos de datos para flujos de datos creados antes de noviembre de 2024](./ui/dataset-expiration-update.md)
...
* Catálogo de destinos {#catalog}
   ...
   * Destinos de Adobe{#adobe}
      ...
      * [Conexión de Marketo Engage](./catalog/adobe/marketo-engage-connection.md)
      ...
      * [Uso compartido de audiencias en Experience Platform](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html?lang=es)
   ...
   * Destinos de Advertising{#advertising}
      ...
      * [Conexión de audiencia de Acxiom RealID](./catalog/advertising/acxiom-real-id-audience-connection.md)
      * [Información general sobre destinos Advertising](./catalog/advertising/overview.md)
      * [Conexión de Adobe Advertising DSP](./catalog/advertising/adobe-advertising-dsp-connection.md)
      * [Conexión heredada de Adobe Advertising DSP](./catalog/advertising/adobe-advertising-cloud-dsp-connection-legacy.md)
      * [Extensión de Adobe Advertising](./catalog/advertising/adobe-advertising-cloud.md)
      ...
      * [Conexión de Demandbase People](./catalog/advertising/demandbase-people.md)
      ...
      * {hide-from-toc}[(Beta) Conexión FreeWheel](./catalog/advertising/freewheel.md)
      ...
      * [(Disponibilidad limitada) Google Customer Match + conexión DV360](./catalog/advertising/google-customer-match-dv360.md)
      ...
      * [Conexión de Index Exchange](./catalog/advertising/index-exchange.md)
      * [Conexión de Kevel](./catalog/advertising/kevel.md)
      ...
      * [Conexión de Microsoft Ads Customer Match](./catalog/advertising/microsoft-ads-customer-match.md)
   ...
   * Destinos de Personalization {#personalization}
      ...
      * [Conexión con Algolia](./catalog/personalization/algolia.md)
   ...
   * Destinos de almacén {#warehouse}
      * [Conexión por lotes de Snowflake](./catalog/warehouses/snowflake-batch.md)
      * [Conexión de flujo Snowflake](./catalog/warehouses/snowflake.md)
