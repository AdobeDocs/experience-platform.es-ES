...
>
>El método `profileSelectors` descrito en esta sección funciona para la mayoría de los destinos de streaming. Sin embargo, algunos destinos de streaming, incluido **[!DNL Adobe Target]**, requieren el flujo de trabajo del conjunto de asignaciones de preparación de datos.
>
...
Ha aprendido a actualizar varios componentes de un flujo de datos de destino, como agregar o quitar audiencias o atributos de perfil, usando la API [!DNL Flow Service]. Para obtener más información sobre los destinos, consulte la [descripción general de los destinos](../home.md).
