...
Este tutorial muestra cómo utilizar las llamadas de API para conectarse a sus datos de Adobe Experience Platform, crear un destino [de marketing de](../catalog/email-marketing/overview.md)correo electrónico, crear un flujo de datos para el nuevo destino creado y activar los datos en el nuevo destino creado.
...
Si prefiere utilizar la interfaz de usuario en el CDP en tiempo real de Adobe para conectar un destino y activar datos, consulte [Conectar un destino](../ui/connect-destination.md) y [Activar perfiles y segmentos en los tutoriales de destino](../ui/activate-destinations.md) .
...
Las siguientes secciones proporcionan información adicional que debe conocer para activar datos en destinos de marketing por correo electrónico en CDP en tiempo real.
...
* `{S3 or SFTP}`:: rellene el tipo de conexión deseado para este destino. En el catálogo [de](../catalog/overview.md)destino, desplácese hasta el destino que prefiera para ver si se admiten los tipos de conexión S3 o SFTP.
