...
type: Tutorial
description: Obtenga información sobre cómo activar los datos de audiencia que tiene en Adobe Experience Platform en varios tipos de destinos.
...
Después de usted [configuración del destino](connect-destination.md)Además, los segmentos de audiencia se pueden activar de varias formas:
...
1. Busque la conexión de destino que desee utilizar para activar los segmentos, seleccione los tres puntos en la [!UICONTROL Nombre] y, a continuación, seleccione **[!UICONTROL Activar segmentos]**.
