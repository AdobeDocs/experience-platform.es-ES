...
[!DNL Adobe Experience Platform] admite una amplia gama de destinos. El flujo de trabajo de activación de audiencia varía según el destino, el tipo de datos de audiencia que admite y la frecuencia de exportación de datos.
...
### Activar audiencias desde el catálogo de destinos {#activate-from-catalog}
...
### Activar audiencias desde la página [!UICONTROL Browse] {#activate-from-browse}

Siga los pasos a continuación para activar los datos en sus destinos desde la página **[!UICONTROL Browse]**.

1. Vaya a **[!UICONTROL Connections > Destinations]** y seleccione la ficha **[!UICONTROL Browse]**.

   ![Ficha Examinar](../assets/ui/activation-overview/browse-tab.png)

1. Busque la conexión de destino que desee utilizar para activar los segmentos, seleccione los tres puntos de la columna [!UICONTROL Name] y, a continuación, seleccione **[!UICONTROL Activate audiences]**.
