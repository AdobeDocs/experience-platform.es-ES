...
>abstract="Seleccionar **Exportar archivos incrementales** para exportar solo los datos que se añadieron al conjunto de datos desde la última exportación. <br> La primera exportación de archivo incremental incluye todos los datos del conjunto de datos, y actúa como relleno. Los archivos incrementales futuros incluyen solo los datos que se añadieron al conjunto de datos desde la primera exportación."
