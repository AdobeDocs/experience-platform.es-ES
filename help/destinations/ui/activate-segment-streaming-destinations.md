...
Este artículo explica el flujo de trabajo necesario para activar audiencias en [!DNL Adobe Experience Platform] destinos de flujo continuo.
...
>[!IMPORTANT]
>
>Este paso solo se aplica a algunos destinos de flujo de audiencia. Si el destino no tiene un paso de **[!UICONTROL Mapping]**, vaya a [programación de audiencias](#scheduling).
>
...
>abstract="Marque esta opción cuando use campos de origen sin hash, para que [!DNL Adobe Experience Platform] los agregue automáticamente al activarlos."
...
1. En la página **[!UICONTROL Audience schedule]**, seleccione cada audiencia y, a continuación, utilice los selectores **[!UICONTROL Start date]** y **[!UICONTROL End date]** para configurar el intervalo de tiempo para enviar datos a su destino.
   ...
   * Algunos destinos requieren que escriba un **[!UICONTROL App ID]** al activar las audiencias [!DNL IDFA] o [!DNL GAID]. Si el destino no incluye este campo, omita este paso.
...
1. Seleccione **[!UICONTROL Next]** para ir a la página [!UICONTROL Review].
