...
En [!DNL Adobe Experience Platform], seleccione **[!UICONTROL Destinations]** en la barra de navegación izquierda para acceder al área de trabajo [!UICONTROL Destinations].
...
La ficha **[!UICONTROL System View]** muestra una representación gráfica de los flujos de activación que ha configurado en [!DNL Adobe Experience Platform].
