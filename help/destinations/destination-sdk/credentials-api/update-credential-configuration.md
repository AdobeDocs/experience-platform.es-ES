...
title: Actualizar la configuración de credenciales
...
# Actualizar la configuración de credenciales

>[!IMPORTANT]
>
>**Punto de conexión de API**: `platform.adobe.io/data/core/activation/authoring/credentials`

Esta página ejemplifica la solicitud de API y la carga útil que puede utilizar para actualizar una configuración de credenciales existente, utilizando la variable `/authoring/credentials` extremo de API.
...
## Actualizar la configuración de credenciales {#update}

Puede actualizar una [existente](create-credential-configuration.md) configuración de credenciales realizando una `PUT` solicitud al `/authoring/credentials` con la carga útil actualizada.

Para obtener una configuración de credencial existente y su correspondiente `{INSTANCE_ID}`, consulte el artículo sobre [recuperación de una configuración de credenciales](retrieve-credential-configuration.md).
...
| -------- | ----------- |
| `{INSTANCE_ID}` | El ID de la configuración de credenciales que desea actualizar. Para obtener una configuración de credencial existente y su correspondiente `{INSTANCE_ID}`, consulte [Recuperar una configuración de credenciales](retrieve-credential-configuration.md). |
...
**Actualizar la configuración de credenciales básica**
...
| -------- | ----------- | ----------- |
| `username` | Cadena | Credenciales configuración nombre de usuario inicio de sesión |
| `sshKey` | Cadena | [!DNL SSH] clave para [!DNL SFTP] con [!DNL SSH] autenticación |
