...
Adobe usa un lenguaje de creación de plantillas similar a [Jinja](https://jinja.palletsprojects.com/en/2.11.x/) para transformar los campos del esquema XDM en un formato compatible con el destino.
...
>[!TIP]
>
>Adobe ofrece [herramienta para desarrolladores](../../testing-api/streaming-destinations/create-template.md) que le ayudará a crear y probar una plantilla de transformación de mensajes.
