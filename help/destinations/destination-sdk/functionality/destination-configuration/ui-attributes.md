...
Para añadir un logotipo a la tarjeta de destino, debe compartir la imagen deseada con el equipo de Adobe cuando [enviar el destino para su revisión](../../guides/submit-destination.md#logo).
