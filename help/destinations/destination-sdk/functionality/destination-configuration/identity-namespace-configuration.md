...
* Al crear destinos basados en archivos mediante Destination SDK, la configuración de áreas de nombres de identidad es _opcional_.
...
Debe indicar qué identidades de [!DNL Platform] pueden exportar los clientes a su destino. Algunos ejemplos son [!DNL Experience Cloud ID], correo electrónico con hash, ID de dispositivo ([!DNL IDFA], [!DNL GAID]). Estos valores son [!DNL Platform] áreas de nombres de identidad que los clientes pueden asignar a áreas de nombres de identidad desde su destino.

Las áreas de nombres de identidad no requieren una correspondencia de 1 a 1 entre [!DNL Platform] y su destino.
Por ejemplo, los clientes podrían asignar un área de nombres [!DNL Platform] [!DNL IDFA] a un área de nombres [!DNL IDFA] desde su destino, o pueden asignar el mismo área de nombres [!DNL Platform] [!DNL IDFA] a un área de nombres [!DNL Customer ID] en su destino.
...
La configuración siguiente habilita la opción [Aplicar transformación](../../../ui/activate-segment-streaming-destinations.md#apply-transformation) opcional en la interfaz de usuario de Platform, en el paso Asignación.
...
Si el destino solo acepta datos con hash, puede configurar los atributos exportados para que Platform los aplique automáticamente. La configuración siguiente comprueba automáticamente la opción **Aplicar transformación** cuando se asignan las identidades `Email` y `Phone`.
