...
>[!IMPORTANT]
>
>Use los perfiles de muestra generados aquí al crear la plantilla, en el [paso de plantilla de procesamiento](render-template-api.md#configurable-aggregation).
