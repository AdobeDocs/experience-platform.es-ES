...
1. Si es ISV o SI, consulte la [obtención de acceso](#get-access) información en la sección anterior. [Paquete de Real-Time CDP Ultimate](https://helpx.adobe.com/legal/product-descriptions/real-time-customer-data-platform.html) Los clientes de pueden omitir este paso.
