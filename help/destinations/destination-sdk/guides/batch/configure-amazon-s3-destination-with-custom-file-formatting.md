...
# Configuración de un destino de Amazon S3 con opciones personalizadas de nombre de archivo y formato

## Información general {#overview}

En esta página se describe cómo utilizar Destination SDK para configurar un destino de Amazon S3 con funciones personalizadas [opciones de formato de archivo](/help/destinations/destination-sdk/server-and-file-configuration.md#file-configuration) y un personalizado [configuración de nombre de archivo](/help/destinations/destination-sdk/file-based-destination-configuration.md#file-name-configuration).
...
La carga útil siguiente incluye una configuración genérica de Amazon S3, con [Formato de archivo CSV](/help/destinations/destination-sdk/server-and-file-configuration.md#file-configuration) Parámetros de configuración que los usuarios pueden definir en la interfaz de usuario de Experience Platform.
...
* [Configuración de destino del lote](/help/destinations/destination-sdk/file-based-destination-configuration.md#batch-configuration)
...
Después de configurar el destino, utilice el [API de publicación de destino](/help/destinations/destination-sdk/destination-publish-api.md) para enviar la configuración al Adobe para su revisión.
...
Al leer este artículo, ahora sabe cómo crear un personalizado [!DNL Amazon S3] destino mediante Destination SDK. A continuación, su equipo puede utilizar el [flujo de trabajo de activación para destinos basados en archivos](/help/destinations/ui/activate-batch-profile-destinations.md) para exportar datos al destino.
