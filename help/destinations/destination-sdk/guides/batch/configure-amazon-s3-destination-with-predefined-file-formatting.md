...
La carga útil siguiente incluye una configuración [!DNL Amazon S3] genérica, con [parámetros de configuración predefinidos y predeterminados de formato de archivo CSV](../../functionality/destination-server/file-formatting.md) que los usuarios pueden definir en la interfaz de usuario de Experience Platform.
