...
title: (Beta) Configure un destino de zona de aterrizaje de datos (DLZ) con opciones de formato de archivo personalizadas y configuración de nombre de archivo personalizada.
...
# (Beta) Configure un [!DNL Data Landing Zone (DLZ)] destino con opciones de formato de archivo personalizadas y configuración de nombre de archivo personalizada
...
La carga útil siguiente incluye un [!DNL Data Landing Zone] configuración, con [Formato del archivo CSV](../../server-and-file-configuration.md#file-configuration) parámetros de configuración que los usuarios pueden definir en la interfaz de usuario del Experience Platform.
...
Al leer este artículo, ahora sabe cómo crear una [!DNL Data Landing Zone] destino mediante Destination SDK. A continuación, su equipo puede usar la variable [flujo de trabajo de activación para destinos basados en archivos](../../../ui/activate-batch-profile-destinations.md) para exportar datos al destino.
