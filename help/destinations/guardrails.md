...
| Número máximo de atributos asignados a un destino de personalización por simulador de pruebas | 20 | Grave | Se puede asignar un máximo de 20 atributos en un flujo de datos a un destino de personalización, por simulador de pruebas. |
