...
Para enviar datos de audiencia a [!DNL Oracle Responsys], primero debe [conectarse al destino](#connect-destination) en [!DNL Adobe Experience Platform] y luego [configurar una importación de datos](#import-data-into-responsys) desde su ubicación de almacenamiento en [!DNL Oracle Responsys].
