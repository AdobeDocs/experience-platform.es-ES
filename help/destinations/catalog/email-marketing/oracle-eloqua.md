...
Para enviar datos de audiencia a [!DNL Oracle Eloqua], primero debe [conectar el destino](#connect-destination) en [!DNL Adobe Experience Platform] y luego [configurar una importación de datos](#import-data-into-eloqua) desde su ubicación de almacenamiento en [!DNL Oracle Eloqua].
