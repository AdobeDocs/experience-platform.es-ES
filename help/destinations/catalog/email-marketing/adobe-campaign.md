...
# [!DNL Adobe Campaign] conexión

## Información general {#overview}

[!DNL Adobe Campaign] es un conjunto de soluciones que le ayudan a personalizar y entregar campañas en todos sus canales en línea y sin conexión. Consulte [Introducción a Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/about-adobe-campaign-classic.html) para obtener más información.

Para enviar datos de audiencia a [!DNL Adobe Campaign], primero debe [conectar el destino](#connect-destination) en [!DNL Adobe Experience Platform] y luego [configurar una importación de datos](#import-data-into-campaign) desde su ubicación de almacenamiento en [!DNL Adobe Campaign].
...
[!DNL Adobe Campaign] admite los siguientes tipos de conexión:
...
* Para **[!UICONTROL Amazon S3]** conexiones, debe proporcionar sus [!UICONTROL Access Key ID] y [!UICONTROL Secret Access Key].
* Para **[!UICONTROL SFTP with Password]** conexiones, debe proporcionar [!UICONTROL Domain], [!UICONTROL Port], [!UICONTROL Username] y [!UICONTROL Password].
* Para **[!UICONTROL SFTP with SSH Key]** conexiones, debe proporcionar [!UICONTROL Domain], [!UICONTROL Port], [!UICONTROL Username] y [!UICONTROL SSH Key].
...
* **[!UICONTROL Bucket Name]**: *Para conexiones S3*. Escriba la ubicación de su espacio de S3 donde [!DNL Experience Platform] depositará los datos de exportación como archivos CSV.
* **[!UICONTROL Folder Path]**: proporcione la ruta de acceso en su ubicación de almacenamiento donde [!DNL Experience Platform] depositará los datos de exportación como archivos CSV.
* **[!UICONTROL Container]**: *Para conexiones de blob*. El contenedor que contiene el blob en el que se encuentra la ruta de la carpeta.
...
## Configurar la importación de datos en [!DNL Adobe Campaign] {#import-data-into-campaign}
