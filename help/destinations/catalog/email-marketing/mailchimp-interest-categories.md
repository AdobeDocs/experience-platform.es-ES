...
Para ayudarle a comprender mejor cómo y cuándo debe utilizar el destino [!DNL Mailchimp Interest Categories], aquí tiene un ejemplo de caso de uso que los clientes de [!DNL Adobe Experience Platform] pueden resolver mediante este destino.
...
### [!DNL Mailchimp] códigos de estado y error {#mailchimp-status-error-codes}
