---
keywords: Controlador del reproductor Nielsen VideoJS;reproductor nielsen video js;reproductor nielsen videojs;Nielsen;nielsen;reproductor nielsen videojs;reproductor Nielsen Digital SDK;sdk digital nielsen
...
# Extensión [!DNL Nielsen VideoJS Player Handler] {#nielsen-vjs-extension}

## Información general {#overview}

La extensión de etiquetas [!DNL Nielsen Digital SDK] ofrece medición de audiencia mediante los siguientes productos de medición digital:
...
![Extensión del controlador del reproductor Nielsen VideoJS](../../assets/catalog/analytics/nielsen-videojs/catalog.png)
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página de [Nielsen Digital SDK en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).
