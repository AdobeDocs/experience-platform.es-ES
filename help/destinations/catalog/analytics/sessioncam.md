...
[!DNL SessionCam] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión sobre [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.100517.html).
...
Para instalar el [!DNL SessionCam] extensión:
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la [Página de SessionCam en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html).
