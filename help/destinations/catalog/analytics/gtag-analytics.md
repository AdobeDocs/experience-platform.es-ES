...
Envío de datos a [!DNL Google Analytics], [!DNL Google Ads], y el [!DNL Google Marketing Platform] mediante [!DNL Google's Global Site Tag]o gtag.js. Se pueden configurar varias cuentas por producto.

[!DNL Google Global Site Tag] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión sobre [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html).
...
Para instalar el [!DNL Google Global Site Tag] extensión:
...
Para obtener información sobre las opciones de configuración de la extensión, consulte las [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) página.
