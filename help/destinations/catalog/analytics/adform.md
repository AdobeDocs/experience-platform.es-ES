---
keywords: extensión de adform;adform
title: Extensión de seguimiento de sitio web de Adobe
description: La extensión de Adobe Forms es un destino de análisis en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de seguimiento de sitio web de Adobe {#adform-extension}

## Información general {#overview}

La extensión de seguimiento de sitios web de Adobe permite a los anunciantes implementar los puntos de seguimiento de Adobe sin esfuerzo en todos sus sitios.

[!DNL Adform] es una extensión de analytics en [!DNL Adobe Experience Platform]. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la [página de Adobe Form en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html).
