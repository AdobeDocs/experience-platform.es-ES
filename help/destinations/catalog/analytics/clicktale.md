---
keywords: clicktale;extensión clicktale;destino de clicktale
...
El [!DNL Clicktale] La extensión de etiquetas permite implementar código y asignar elementos de datos utilizando [!DNL Clicktale's] Editor visual.

[!DNL Clicktale] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión sobre [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.100082.html).
...
Para instalar el [!DNL Clicktale] extensión:
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la [Página de extensión de ClickTable](https://exchange.adobe.com/experiencecloud.details.100082.html) en Adobe Exchange.
