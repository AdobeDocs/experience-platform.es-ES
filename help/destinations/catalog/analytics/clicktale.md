...
La extensión de etiqueta [!DNL Clicktale] le permite implementar código y asignar elementos de datos mediante [!DNL Clicktale's] Visual Editor.

[!DNL Clicktale] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100082.html).
...
![Extensión de la tabla de clics](../../assets/catalog/analytics/clicktale/catalog.png)
...
Para obtener más información sobre las opciones de configuración de la extensión, consulte la [página de extensión ](https://exchange.adobe.com/experiencecloud.details.100082.html) en Adobe Exchange.
