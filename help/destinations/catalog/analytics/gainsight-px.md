...
Para que entienda mejor cómo y cuándo debe usar el destino *Gainsight PX*, aquí hay casos de uso de ejemplo que los clientes [!DNL Adobe Experience Platform] pueden resolver usando este destino.

### Segmentación de participaciones en la aplicación {#targeting-in-app-engagements}

Una empresa SaaS quiere atraer a sus clientes a través de una guía en la aplicación creada en Gainsight PX. Se ha creado una audiencia para recibir esta participación en [!DNL Adobe Experience Platform]. El destino PX de Gainsight recibe la audiencia y la pone a disposición del entorno PX de Gainsight.
...
|---|----|
| Identificar ID | Identificador de usuario común que identifica de manera única a un usuario en Gainsight PX y [!DNL Adobe Experience Platform] |
