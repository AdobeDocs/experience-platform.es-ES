...
Para obtener información sobre las opciones de configuración de la extensión, consulte la [página de extensión de Adobe Medium Analytics for Audio and Video](../../../tags/extensions/web/media-analytics/overview.md) en la documentación [!DNL Experience Launch].
