...
La extensión de etiqueta [!DNL Quantum Metric] facilita la implementación sin código de las capacidades de recopilación de datos [!DNL Quantum Metric's]. Además, esta extensión ofrece la capacidad de capturar elementos de datos que contengan información útil de la API [!DNL Quantum Metric].
