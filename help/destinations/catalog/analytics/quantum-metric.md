...
# Extensión [!DNL Quantum Metric] {#quantum-metric-extension}

## Información general {#overview}

La extensión de etiquetas [!DNL Quantum Metric] facilita la implementación sin código de las capacidades de recopilación de datos [!DNL Quantum Metric's]. Además, esta extensión ofrece la capacidad de capturar elementos de datos que contienen información útil de la API [!DNL Quantum Metric].
...
Para obtener información acerca de las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página [Métrica cuántica en el Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
