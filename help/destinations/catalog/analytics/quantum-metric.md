...
description: La extensión de métrica cuántica es un destino de análisis en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
[!DNL Quantum Metric's] integración con Adobe Launch facilita la implementación sin código de la etiqueta de recopilación de  [!DNL Quantum Metric's] datos. Además, esta extensión ofrece la capacidad de capturar elementos de datos de Launch que contengan información útil de la API [!DNL Quantum Metric].

[!DNL Quantum Metric] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
Para obtener información sobre las opciones de configuración de la extensión y el soporte de instalación, consulte la página [Métrica cuántica en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
