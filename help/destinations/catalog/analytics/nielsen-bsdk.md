...
title: Extensión de Nielsen BSDK
description: La extensión BSDK de Nielsen es un destino de análisis en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
[!DNL Nielsen Digital SDK] la extensión de lanzamiento ofrece mediciones de audiencia mediante los siguientes productos de medición digital:
...
[!DNL Nielsen BSDK] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).
