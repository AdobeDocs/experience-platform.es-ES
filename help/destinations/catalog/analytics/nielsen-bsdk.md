...
# Extensión [!DNL Nielsen BSDK] {#nielsen-bsdk-extension}
...
[!DNL Nielsen BSDK] es una extensión de analytics en [!DNL Adobe Experience Platform]. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página del SDK de [Nielsen en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).
