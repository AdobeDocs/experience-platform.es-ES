---
keywords: extensión de dialogtech;dialogtech;destino de dialogtech;DialogTech;DialogTech SourceTrack
...
# Extensión [!DNL DialogTech] {#dialogtech-extension}

## Información general {#overview}

[!DNL DialogTech] es una extensión de analytics en [!DNL Adobe Experience Platform]. Para obtener más información sobre la funcionalidad de la extensión, consulte el [sitio web de Dialogtech](https://www.dialogtech.com/).
