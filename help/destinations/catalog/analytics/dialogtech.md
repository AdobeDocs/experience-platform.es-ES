...
[!DNL DialogTech] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la [Sitio web de Dialogtech](https://www.dialogtech.com/).
...
Para instalar el [!DNL DialogTech] extensión:
