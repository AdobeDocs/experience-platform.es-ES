---
keywords: Seguimiento de conversión de texto;Yext;yext;yext;seguimiento de conversión de texto
title: Extensión de seguimiento de conversión de texto
description: La extensión de seguimiento de conversión de texto es un destino de análisis en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
El [!DNL Yext Conversion Tracking] La extensión le permite medir las conversiones que se pueden atribuir a su uso de productos Yext.

[!DNL Yext Conversion Tracking] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión sobre [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
Para instalar el [!DNL Yext Conversion Tracking] extensión:
