---
keywords: Seguimiento de conversión de texto siguiente;Yext;yext;seguimiento de conversión de texto
title: Extensión de seguimiento de conversión de contexto
description: La extensión de seguimiento de conversión de texto siguiente es un destino de análisis en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
# [!DNL Yext Conversion Tracking] Extensión {#yext-extension}
...
[!DNL Yext Conversion Tracking] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
![Extensión de seguimiento de conversión de contexto](../../assets/catalog/analytics/yext/catalog.png)
