...
title: Extensión Decibel
description: La extensión Decibel es un destino de análisis en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
Implemente [!DNL Decibel] de forma rápida y transparente en sus propiedades web. También se pueden implementar configuraciones avanzadas adicionales con reglas mediante acciones disponibles a través de la extensión de .

[!DNL Decibel] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html).
...
![Extensión Decibel](../../assets/catalog/analytics/decibel/catalog.png)
...
Para obtener más información sobre las opciones de configuración de la extensión, consulte la [página de extensión de Decibel](https://exchange.adobe.com/experiencecloud.details.100913.html) en Adobe Exchange.
