---
keywords: extensión de decibelios;decibelios;destino de decibelios
...
# Extensión [!DNL Decibel] {#decibel-extension}

## Información general {#overview}

Implemente [!DNL Decibel] de forma rápida y sin problemas en sus propiedades web. También se pueden implementar configuraciones avanzadas adicionales con reglas mediante acciones disponibles a través de la extensión.

[!DNL Decibel] es una extensión de analytics en [!DNL Adobe Experience Platform]. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html).
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la [página de extensión Decibel](https://exchange.adobe.com/experiencecloud.details.100913.html) en Adobe Exchange.
