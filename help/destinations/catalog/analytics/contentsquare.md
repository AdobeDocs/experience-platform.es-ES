...
description: La extensión Contentsquare es un destino de análisis en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
Visualice los comportamientos en la página, consulte POR QUÉ abandonan los clientes y CÓMO puede mejorar. Ingresos de atributos para UX y elementos de contenido para cada segmento de Analytics y prueba de Target. Instale la etiqueta [!DNL Contentsquare] , configure variables y eventos personalizados. Empiece a recopilar datos para su análisis de experiencia de usuario en unos pocos clics.

[!DNL Contentsquare] es una extensión de analytics en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100364.html).
...
Para instalar la extensión [!DNL Contentsquare]:
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la [página de extensión de Contentsquare](https://exchange.adobe.com/experiencecloud.details.100364.html) en Adobe Exchange.
