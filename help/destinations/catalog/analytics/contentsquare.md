...
# Extensión [!DNL Contentsquare] {#contentsquare-extension}

## Información general {#overview}

Visualice los comportamientos en la página, consulte POR QUÉ los clientes abandonan y CÓMO puede mejorar. Atribuya los ingresos a UX y a los elementos de contenido para cada audiencia de Analytics y prueba de Target. Instale la etiqueta [!DNL Contentsquare] y configure variables y eventos personalizados. Comience a recopilar datos para su análisis de experiencia de usuario en unos pocos clics.

[!DNL Contentsquare] es una extensión de analytics en [!DNL Adobe Experience Platform]. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100364.html).
