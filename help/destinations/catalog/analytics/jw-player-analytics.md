---
keywords: reproductor JW;reproductor JW;reproductor JW;extensión JW;extensión JW
...
# Extensión [!DNL JW Player Analytics] (Beta) {#jw-player-analytics-extension}

## Información general {#overview}

Esta extensión instala el adaptador [!DNL JW Player] para conectar los eventos [!DNL JW Player] a Adobe Video Analytics. Aproveche la potencia de Adobe Video Analytics para obtener perspectivas detalladas y comprender los hábitos de visualización de vídeo de sus clientes.
...
![Extensión de análisis JW](../../assets/catalog/analytics/jw-analytics/catalog.png)
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la [página de extensión de JW Player Analytics (Beta)](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) en Adobe Exchange.
