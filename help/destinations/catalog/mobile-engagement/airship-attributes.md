...
| Elemento | Tipo | Notas |
|---------|----------|---------|
| Tipo de exportación | **[!UICONTROL Profile-based]** | Va a exportar todos los miembros de un segmento, junto con los campos de esquema deseados (por ejemplo: dirección de correo electrónico, número de teléfono, apellidos) o identidades, según la asignación de campos. |
...
Proporcione un nombre descriptivo para el token, por ejemplo &quot;Adobe Attributes Destination&quot; y seleccione &quot;All Access&quot; para el rol.
