...
[!DNL Outreach] página de configuración de clientes potenciales que muestra campos personalizados con *fácil de usar* etiquetas que coinciden con los nombres de los segmentos. Puede ver el estado del segmento en la página de clientes potenciales en relación con estas etiquetas.
...
Leer [Activación de perfiles y segmentos en destinos de exportación de segmentos de flujo continuo](../../ui/activate-segment-streaming-destinations.md) para obtener instrucciones sobre cómo activar segmentos de audiencia en este destino.
...
* Al realizar la [Programar exportación de segmentos](../../ui/activate-segment-streaming-destinations.md) paso debe asignar manualmente segmentos de Platform al atributo de campo personalizado en [!DNL Outreach].
...
* Para ello, seleccione cada segmento e introduzca el valor numérico correspondiente que corresponda a *Campo personalizado `N` Etiqueta* campo de [!DNL Outreach] en el **[!UICONTROL ID de asignación]** field.
   ...
   * Por ejemplo:
      ...
      ![Captura de pantalla de la IU de Platform que muestra un ejemplo de ID de asignación durante la exportación del segmento de programación.](../../assets/catalog/crm/outreach/schedule-segment-export.png)
...
1. Inicie sesión en [!DNL Outreach] sitio web y, a continuación, vaya al [!DNL Apps] > [!DNL Contacts] y compruebe si se han añadido los perfiles del segmento. Puede ver que cada estado del segmento en [!DNL Outreach] se ha actualizado con el estado del segmento correspondiente de Platform, según el [!UICONTROL ID de asignación] valor proporcionado durante la [programación de segmentos](#schedule-segment-export-example) paso.

![Captura de pantalla de la interfaz de usuario de divulgación que muestra la página de perspectivas de divulgación con los estados de segmento actualizados.](../../assets/catalog/crm/outreach/outreach-prospect.png)
...
Para corregir este error, compruebe que la variable [!UICONTROL ID de asignación] ha proporcionado en Platform para su [!DNL Outreach] el segmento es válido y existe en [!DNL Outreach].
