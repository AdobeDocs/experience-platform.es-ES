...
>abstract="Esta opción determina en qué secuencia de datos de recopilación de datos se incluirán los segmentos. El menú desplegable solo muestra flujos de datos que tienen habilitada la configuración de Target. Para utilizar la segmentación de Edge, debe seleccionar un ID de secuencia de datos. Si selecciona Ninguno, se desactivan todos los casos de uso que utilizan segmentación de Edge."
