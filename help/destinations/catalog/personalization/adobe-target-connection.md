...
Al configurar la conexión de Adobe Target para [usar un conjunto de datos](#parameters), debe tener implementado [Adobe Experience Platform Web SDK](/help/web-sdk/home.md).
