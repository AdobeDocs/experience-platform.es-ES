...
description: La extensión de Inteligencia de Visitante de D&B es un destino de personalización en la plataforma de datos del cliente en tiempo real. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión de Inteligencia de Visitante de D&B es un destino de personalización en la plataforma de datos del cliente en tiempo real. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
[!DNL D&B Visitor Intelligence] es una extensión de personalización en la plataforma de datos del cliente en tiempo real. Para obtener más información sobre la funcionalidad de extensión, consulte el sitio web [](https://www.dnb.com/)D&amp;B.
...
![Extensión de inteligencia de Visitante D&amp;B](../../assets/catalog/personalization/dnb/catalog.png)
