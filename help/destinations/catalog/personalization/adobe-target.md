...
Para obtener información sobre las opciones de configuración de la extensión, consulte la [página de la extensión de Adobe Target](../../../tags/extensions/web/target/overview.md) en la documentación de etiquetas.
