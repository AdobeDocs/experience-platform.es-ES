...
### Cuenta [!DNL Google Ads] existente {#existing-google-ads-account}
...
* **[!UICONTROL Account ID]**: complete su ID de cuenta con [!DNL Google Ads]. El formato de ID suele ser 123-456-7890.
