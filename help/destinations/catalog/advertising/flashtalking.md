...
# Extensión [!DNL Flashtalking OneTag] {#flashtalking-extension}

## Información general {#overview}

La extensión de etiquetas [!DNL Flashtalking OneTag] facilita la atribución de acciones del sitio a la actividad de visualización, vídeo y publicidad móvil. Implemente [!DNL Flashtalking OneTag] en sus propiedades web mediante etiquetas.

[!DNL Flashtalking OneTag] es una extensión publicitaria en [!DNL Adobe Experience Platform]. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la [página OneTag de Flashtalk en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
