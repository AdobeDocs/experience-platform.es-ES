---
keywords: Extensiones de OneTag de Flashtalk;Extensión de OneTag de Flashtalk;Destinos de OneTag de Flashtalk;OneTag de Flashtalk;OneTag de flashtalk
title: Extensión OneTag de Flashtalk
description: La extensión OneTag de Flashtalk es un destino publicitario en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
El [!DNL Flashtalking OneTag] la extensión de etiquetas facilita la atribución de acciones del sitio a la visualización, el vídeo y la actividad de publicidad móvil. Implementar el [!DNL Flashtalking OneTag] a las propiedades web mediante etiquetas.

[!DNL Flashtalking OneTag] es una extensión de publicidad en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión sobre [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
![Extensión de Flashtalk](../../assets/catalog/advertising/flashtalking/catalog.png)
...
Para instalar el [!DNL Flashtalking OneTag] extensión:
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la [Página de OneTag que habla de forma llamativa en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
