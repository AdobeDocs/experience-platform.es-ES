...
Branch es una extensión de publicidad en Adobe Experience Platform. Para obtener más información acerca de la funcionalidad de extensión, consulte la [página de características](https://branch.io/features/) en el sitio Web de Branch.
