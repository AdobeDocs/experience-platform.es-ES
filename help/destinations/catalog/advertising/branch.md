...
description: La extensión Branch es un destino publicitario en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
Branch proporciona potentes vínculos y soluciones que le ayudan a adquirir, interactuar y medir en todos los dispositivos, canales y plataformas.

Branch es una extensión publicitaria de Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la [página de características](https://branch.io/features/) en el sitio web de Branch.
