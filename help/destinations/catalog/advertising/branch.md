---
keywords: rama;extensión de rama;destino de rama
title: Extensión de rama
description: La extensión de sucursal es un destino publicitario en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión [!DNL Branch] {#branch-extension}

## Información general {#overview}

Branch proporciona vínculos y soluciones potentes que le ayudan a adquirir, interactuar y medir en todos los dispositivos, canales y plataformas.

La rama es una extensión publicitaria en [!DNL Adobe Experience Platform]. Para obtener más información sobre la funcionalidad de la extensión, consulte la [página de características](https://branch.io/features/) en el sitio web de la sucursal.
...
![Extensión de rama](../../assets/catalog/advertising/branch/catalog.png)
...
Para instalar la extensión [!DNL Branch]:
