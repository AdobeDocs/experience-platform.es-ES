...
>[!IMPORTANT]
>
>Este destino está actualmente en versión beta y solo está disponible para un número limitado de clientes. Para solicitar acceso a la [!DNL Google Ad Manager 360] conexión, póngase en contacto con su representante de Adobe y proporcione su [!DNL organization ID].
...
* **[!UICONTROL Anexar ID de segmento al nombre del segmento]**: Seleccione esta opción para que el nombre del segmento en Google Ad Manager 360 incluya el ID del segmento del Experience Platform, de esta manera: `Segment Name (Segment ID)`.
