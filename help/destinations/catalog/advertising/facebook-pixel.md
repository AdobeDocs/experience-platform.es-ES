...
description: La extensión de píxel de Facebook es un destino publicitario en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
[!DNL Facebook Pixel] es una extensión publicitaria en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte el [sitio web de Pixel de Facebook](https://developers.facebook.com/docs/facebook-pixel/).
