...
>[!IMPORTANT]
>
>* Para activar los datos, necesita los **permisos de control de acceso**, **Activar destinos**, **Ver perfiles** y **Ver segmentos**![para ](https://experienceleague.adobe.com/es/docs/experience-platform/access-control/home#permissions). Lea la ![descripción general del control de acceso](https://experienceleague.adobe.com/es/docs/experience-platform/access-control/ui/overview) o póngase en contacto con el administrador del producto para obtener los permisos necesarios.
>* Para exportar identidades, necesita el **permiso de control de acceso** de ![Ver gráfico de identidad](https://experienceleague.adobe.com/es/docs/experience-platform/access-control/home#permissions).
