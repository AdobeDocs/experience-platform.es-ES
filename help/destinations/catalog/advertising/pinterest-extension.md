...
# Extensión [!DNL Pinterest Conversion Tracking] {#pinterest-extension}

## Información general {#overview}

Rastree las acciones de los visitantes en el sitio web después de ver el anclaje promocionado. Mida el retorno de la inversión en publicidad y cree audiencias segmentadas. Más información [aquí](https://ads.pinterest.com/).
