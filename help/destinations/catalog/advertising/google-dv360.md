...
* **[!UICONTROL Account ID]**: Rellene su ID de cuenta de **[!DNL Invite partner]** o **[!DNL Invite advertiser]** con Google. Normalmente, se trata de un ID de seis o siete dígitos.
