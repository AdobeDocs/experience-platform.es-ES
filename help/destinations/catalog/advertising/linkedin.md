...
Instale el [!DNL LinkedIn Insight Tag] para utilizar las características demográficas del sitio web, el seguimiento de conversiones y la reorientación.

[!DNL LinkedIn Insight Tag] es una extensión publicitaria en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte [LinkedIn Insight Tag](https://business.linkedin.com/marketing-solutions/insight-tag).
