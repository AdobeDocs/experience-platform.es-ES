...
>abstract="Introduzca el ID de segmento numérico de Bing al que desea asignar el segmento seleccionado. Si el proporcionado [!UICONTROL ID de asignación] no se corresponde con un ID de segmento en el destino de Bing, por lo que no verá los datos de audiencia esperados en su cuenta de Bing."
