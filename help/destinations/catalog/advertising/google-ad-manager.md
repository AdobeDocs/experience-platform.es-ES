...
La inclusión en la lista de permitidos es obligatoria antes de configurar su primer destino de [!DNL Google Ad Manager] en Platform. Asegúrese de completar el proceso de inclusión en la lista de permitidos que se describe a continuación antes de crear su destino.
...
* **[!UICONTROL Anexar ID de audiencia al nombre de audiencia]**: seleccione esta opción para que el nombre de audiencia en Google Ad Manager incluya el ID de audiencia del Experience Platform, así: `Audience Name (Audience ID)`.

>[!NOTE]
>
>Al configurar un destino de [!DNL Google Ad Manager], trabaje con su representante de [!DNL Google Account Manager] o de Adobe para saber qué tipo de cuenta tiene.
