...
| Elemento | Tipo | Notas |
---------|----------|---------|
| Tipo de exportación | **[!UICONTROL Exportación de segmentos]** | Va a exportar todos los miembros de un segmento (audiencia) con los identificadores (nombre, número de teléfono u otros) utilizados en el destino *YourDestination*. |
...
* **[!UICONTROL Nombre de cuenta]**: escriba un nombre de cuenta mediante el cual pueda identificar esta conexión de destino en el futuro.
* **[!UICONTROL ID de clave de acceso S3]**: complete la clave de acceso S3 proporcionada por Adform.
* **[!UICONTROL Clave de acceso secreto S3]**: Rellene la clave de acceso secreto S3 proporcionada por Adform.
...
* **[!UICONTROL Nombre de proveedor]**: El nombre de su cuenta de Adform proporcionado por Adform.
