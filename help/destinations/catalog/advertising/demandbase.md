...
Active perfiles para sus campañas de Demandbase para la segmentación, personalización y supresión de audiencias, en función de [audiencias de la cuenta](/help/segmentation/ui/account-audiences.md)

## Ejemplo de uso {#use-case}

Utilice este destino para activar las audiencias de su cuenta para los casos de uso de Account-Based Marketing (ABM). Anuncie a personalidades y roles relevantes en sus cuentas de destinatario a través del Demand Side Platform DSP B2B () de DemandBase. Las cuentas de Target también se pueden enriquecer con datos de terceros de Demandbase para otros casos de uso posteriores en marketing y ventas.

DSP Por ejemplo, aproveche la tecnología publicitaria de Demandbase para dirigirse a personas o funciones específicas dentro de cuentas clave para generar posibles clientes en la parte superior del canal o crear y aumentar grupos de compra. Utilice el destino de Demandbase para explorar otros casos de uso y dirigir las cuentas de forma eficaz.
...
>[!IMPORTANT]
> 
>Para conectarse al destino, necesita el **[!UICONTROL permiso de control de acceso](/help/access-control/home.md#permissions) de Ver destinos]** y **[!UICONTROL Administrar destinos]**[para obtener acceso. Lea la [descripción general del control de acceso](/help/access-control/ui/overview.md) o póngase en contacto con el administrador del producto para obtener los permisos necesarios.
