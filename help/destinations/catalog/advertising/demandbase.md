...
>[!AVAILABILITY]
>
>La funcionalidad para activar audiencias de cuenta en el destino de Demandbase está disponible para compañías que compren las ediciones de [empresa a empresa](/help/rtcdp/overview.md#rtcdp-b2b) y [empresa a persona](/help/rtcdp/overview.md#rtcdp-b2p) de [!DNL Real-Time Customer Data Platform].
