...
description: La extensión de confirmación de comentarios digitales es el destino de la voz del cliente en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión [!DNL Confirmit Digital Feedback]

## Información general {#overview}

La solución [!DNL Confirmit Digital Feedback] le ayuda a convertir el tráfico del sitio web en información en tiempo real. Con [!DNL Confirmit], las encuestas discretas y con un objetivo muy específico se pueden mostrar según sus necesidades, lo que anima a los visitantes a proporcionar comentarios, como:

* Comentarios del sitio web
* Satisfacción de transacciones
* Razón de intención de salida
* Información de abandono del carro
* Satisfacción general del cliente
* Y mucho más

Los comentarios digitales de [!DNL Confirmit] son una extensión de Voz del cliente en Adobe Experience Platform. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
...
![Confirmar extensión de comentarios digitales](../../assets/catalog/voice/confirmit-digital-feedback/catalog.png)
...
Para instalar la extensión de comentarios digitales [!DNL Confirmit]:
...
Para obtener información acerca de las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página [Confirmar comentarios digitales en el Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
