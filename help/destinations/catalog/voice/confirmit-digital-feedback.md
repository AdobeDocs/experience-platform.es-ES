...
description: La extensión Confirmar comentarios digitales es una Voz del destino del cliente en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
[!DNL Confirmit Digital Feedback] ayuda a convertir el tráfico de su sitio web en perspectivas en tiempo real. Con [!DNL Confirmit], se pueden mostrar estudios discretos y con objetivos muy precisos según sus necesidades, lo que anima a los visitantes a proporcionar información, como por ejemplo:

* Comentarios del sitio web
* Satisfacción de la transacción
* Motivo de intención de salida
* Información sobre el abandono del carro de compras
* Satisfacción general del cliente
* Y mucho más

[!DNL Confirmit] Digital Feedback es una voz de la extensión del cliente en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
...
Para instalar la extensión [!DNL Confirmit] Digital Feedback :
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página [Confirmmit Digital Feedback en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
