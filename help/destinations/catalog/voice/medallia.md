...
Implemente [!DNL Medallia] de forma rápida y sin problemas en sus propiedades web. La extensión también permite detectar eventos de encuestas, capturar los comentarios de los clientes en tiempo real mediante elementos de datos, utilizarlos en reglas para personalizar la experiencia del cliente y compartir datos con Adobe Analytics.

[!DNL Medallia] es la voz de la extensión del cliente en Adobe Experience Platform. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html).
...
Para obtener información acerca de las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página [Medallia en el Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html).
