...
[!DNL Invoca] incorpora perspectivas de voz y datos de llamada en el recorrido digital del cliente. Con la plataforma de inteligencia de llamadas [!DNL Invoca’s], los especialistas en marketing finalmente tienen analytics para medir los resultados de llamadas y enlazar las conversiones sin conexión con el gasto digital.

[!DNL Invoca Tags] es una voz de la extensión del cliente en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
...
![Extensión de Invoca](../../assets/catalog/voice/invoca/catalog.png)
