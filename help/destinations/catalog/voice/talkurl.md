...
[!DNL Talk URL Inbox] es la voz de la extensión del cliente en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión sobre [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
![Extensión de bandeja de entrada de URL Talk](../../assets/catalog/voice/talkurl/catalog.png)
...
Para instalar el [!DNL Talk URL Inbox] extensión:
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la [Página de bandeja de entrada de URL de conversación en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
