...
description: La extensión Talk URL Inbox es una voz del destino del cliente en la plataforma de datos del cliente en tiempo real. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Talk URL Inbox es una voz del destino del cliente en la plataforma de datos del cliente en tiempo real. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
[!DNL Talk URL Inbox] es una voz de la extensión del cliente en la plataforma de datos del cliente en tiempo real. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
![Extensión de bandeja de entrada de URL de Talk](../../assets/catalog/voice/talkurl/catalog.png)
