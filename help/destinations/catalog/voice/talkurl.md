---
keywords: Bandeja de entrada de URL de conversación;Bandeja de entrada de URL de conversación;Bandeja de entrada de URL de conversación;URL de conversación;URL de conversación;URL de conversación
title: Extensión de bandeja de entrada de URL Talk
description: La extensión de la bandeja de entrada de la URL de conversación es la voz del destino del cliente en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión [!DNL Talk URL Inbox] {#talk-url-extension}

Reciba mensajes de voz de los visitantes de su página web. Incluye IU alojada y aprendizaje automático basado en la nube para transcribir sus mensajes de voz en perspectivas de texto al instante.

[!DNL Talk URL Inbox] es una voz de la extensión de cliente en [!DNL Adobe Experience Platform]. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
![Extensión de bandeja de entrada de URL de conversación](../../assets/catalog/voice/talkurl/catalog.png)
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página [Bandeja de entrada de URL de conversación en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
