...
[!DNL Talk URL Inbox] es una voz de la extensión de cliente en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página [Bandeja de entrada de URL de Talk en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
