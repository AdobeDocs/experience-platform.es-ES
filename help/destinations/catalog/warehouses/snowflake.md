...
El destino de streaming [!DNL Snowflake] actualmente solo está disponible para los clientes [!DNL Real-Time CDP] aprovisionados en la región de Experience Platform VA7.
