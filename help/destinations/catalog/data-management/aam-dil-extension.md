...
seo-description: La extensión del DIL Audience Manager es un destino de la Plataforma de Gestión de datos (DMP) en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
