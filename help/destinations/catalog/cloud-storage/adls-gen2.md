...
* **[!UICONTROL Tenant]**: la información del inquilino que contiene su aplicación.
* **[!UICONTROL Service principal ID]**: el ID de cliente de la aplicación.
* **[!UICONTROL Service principal key]**: la clave de la aplicación.
