...
>[!IMPORTANT]
>
>El [!DNL Azure Event Hubs] destino de CDP en tiempo real está actualmente en fase beta. La documentación y las funciones están sujetas a cambios.
...
* Para conectarse a [!DNL Azure Event Hubs] través de llamadas de API, consulte el tutorial [de API de destinos de](../../api/streaming-destinations.md)flujo continuo.
* Para conectarse a [!DNL Azure Event Hubs] través de la interfaz de usuario de CDP en tiempo real, consulte las secciones a continuación.
...
Consulte Flujo de trabajo de destinos de almacenamiento [Cloud ](./workflow.md)para obtener instrucciones sobre cómo conectarse a los destinos de almacenamiento de nube, incluidos [!DNL Azure Event Hubs].
