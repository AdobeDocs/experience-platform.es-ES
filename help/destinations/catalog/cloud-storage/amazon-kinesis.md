...
El servicio [!DNL Kinesis Data Streams] de [!DNL Amazon Web Services] recopila y procesa grandes flujos de registros de datos en tiempo real.

Puede crear una conexión saliente en tiempo real a su almacenamiento de [!DNL Amazon Kinesis] para transmitir datos desde [!DNL Adobe Experience Platform].
...
Escriba los campos siguientes y seleccione **[!UICONTROL Connect to destination]**:
...
* **[!UICONTROL Region]**: indica a qué región de [!DNL Amazon Web Services] se transmitirán los datos.
...
* **[!UICONTROL Name]**: proporcione un nombre para la conexión con [!DNL Amazon Kinesis]
* **[!UICONTROL Description]**: proporcione una descripción para la conexión con [!DNL Amazon Kinesis].
* **[!UICONTROL Stream]**: proporcione el nombre de un flujo de datos existente en su cuenta de [!DNL Amazon Kinesis]. Experience Platform exportará datos a este flujo.
