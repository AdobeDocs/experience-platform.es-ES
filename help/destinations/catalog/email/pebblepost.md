---
keywords: PebblePost;pebblepost;Correo directo programático de PebblePost;correo directo programático de pebblepost
...
# Extensión [!DNL PebblePost] {#pebblepost-extension}
...
Para instalar el [!DNL PebblePost] extensión:
