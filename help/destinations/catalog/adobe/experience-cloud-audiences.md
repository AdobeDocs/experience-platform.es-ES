...
Para enviar audiencias a otras soluciones de Adobe, usa las conexiones directas de [!DNL Real-Time CDP] a [Adobe Target](../personalization/adobe-target-connection.md), [Adobe Advertising](../advertising/adobe-advertising-cloud-connection.md), [Adobe Campaign](../email-marketing/adobe-campaign.md) y [Marketo Engage](../adobe/marketo-engage.md).
