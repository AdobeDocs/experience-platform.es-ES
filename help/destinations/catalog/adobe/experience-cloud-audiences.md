...
> * Usted *no necesita* una licencia de Audience Manager para compartir audiencias de [!DNL Real-Time CDP] con [!DNL Adobe Advertising], [!DNL Adobe Target], Marketo y otras soluciones de Experience Cloud, mencionadas en la sección [anterior](#share-segments-with-other-solutions).
