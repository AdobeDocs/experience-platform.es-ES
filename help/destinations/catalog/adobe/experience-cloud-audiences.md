...
> * Necesita una licencia de Audience Manager para habilitar los casos de uso de la plataforma de gestión de datos mencionados en la sección anterior.
> * You *no es necesario* licencia de Audience Manager para compartir segmentos de Experience Platform con Adobe Advertising Cloud, Adobe Target, Marketo y otras soluciones de Experience Cloud a través de la integración de Audiencias de Experience Cloud.
