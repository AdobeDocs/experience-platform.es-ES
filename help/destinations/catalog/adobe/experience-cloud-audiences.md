...
> * Necesita una licencia de Audience Manager para habilitar los casos de uso de Data Management Platform que se mencionan en la sección anterior.
> * Usted *no necesita* una licencia de Audience Manager para compartir segmentos de Experience Platform con Adobe Advertising Cloud, Adobe Target, Marketo y otras soluciones de Experience Cloud a través de la integración de Audiencias de Experience Cloud.


### Para clientes que utilizan la solución heredada de uso compartido de segmentos

Si ya está compartiendo segmentos de Experience Platform a Audience Manager y otras soluciones de Experience Cloud a través de [integración heredada de uso compartido de segmentos](https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html?lang=en#aep-segments-in-aam)Por lo tanto, debe ponerse en contacto con el Servicio de atención al cliente o con el Customer Success Manager para deshabilitar la integración heredada. AAM Los equipos de Servicio de atención al cliente y Administración de la asistencia al cliente deben presentar un ticket de Jira (consulte ticket de plantilla-52354) para deshabilitar la integración.
