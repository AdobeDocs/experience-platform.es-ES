...
Adobe Livefyre es una extensión social de [!DNL Adobe Experience Platform]. Para obtener más información sobre Adobe Livefyre, lea la [Guía de implementación de Livefyre](https://experienceleague.adobe.com/docs/livefyre/implementation/home.html?lang=es).
