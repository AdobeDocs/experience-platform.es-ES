...
Para enviar segmentos a destinos sociales para sus campañas, Platform primero debe conectarse al destino. Consulte la [tutorial de creación de destino](../../ui/connect-destination.md) para obtener información detallada sobre la configuración de un nuevo destino.