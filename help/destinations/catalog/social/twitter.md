...
Oriente a sus seguidores y clientes existentes en Twitter y cree campañas de remarketing relevantes activando las audiencias creadas dentro de [!DNL Adobe Experience Platform].
...
| Elemento | Tipo | Notas |
|---------|----------|---------|
| Tipo de exportación | **[!UICONTROL Audience export]** | Va a exportar todos los miembros de una audiencia con los identificadores utilizados en el destino de Audiencias personalizadas de Twitter. |
...
Para ayudarle a comprender mejor cómo y cuándo debe utilizar el destino [!DNL Twitter Custom Audiences], aquí hay ejemplos de casos de uso que los clientes de [!DNL Adobe Experience Platform] pueden resolver mediante este destino.

### #1 de casos de uso {#use-case-1}

Oriente a sus seguidores y clientes existentes en Twitter y cree campañas de remarketing relevantes activando las audiencias creadas dentro de [!DNL Adobe Experience Platform] como [!DNL List Custom Audiences] en Twitter.
...
1. Busque el destino [!DNL Twitter Custom Audiences] en el catálogo de destino y seleccione **[!UICONTROL Set Up]**.
...
* **[!UICONTROL Account ID]**: su ID de cuenta de [!DNL Twitter Ads]. Se encuentra en la configuración de [!DNL Twitter Ads].
