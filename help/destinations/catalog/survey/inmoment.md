---
keywords: InMoment;intime;Intime;integración con launch
title: Extensión InMoment
description: La extensión InMoment es un destino de encuesta en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de la extensión en Adobe Exchange.
...
La extensión de la etiqueta [!DNL InMoment] le permite habilitar de forma rápida y sencilla los comentarios en línea mediante el producto Digital Intercept. En la aplicación, las interceptaciones se pueden configurar y administrar a través del administrador de CXI Cloud, lo que permite a los administradores de CX tener más control sobre su programa.
...
![Extensión in-time](../../assets/catalog/survey/inmoment/catalog.png)
