---
keywords: InMoment;inmoment;Inmoment;integración de lanzamiento
title: Extensión InMoment
description: La extensión InMoment es un destino de encuesta en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
El [!DNL InMoment] La extensión de etiquetas permite activar rápida y fácilmente los comentarios en línea mediante el producto Digital Intercept. En la aplicación, las interceptaciones se pueden configurar y administrar a través del administrador de CXI Cloud, lo que permite a los administradores de CX tener un mayor control sobre su programa.

[!DNL InMoment] es una extensión de encuesta en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión sobre [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.100847.html).
...
![Extensión de momento](../../assets/catalog/survey/inmoment/catalog.png)
...
Para instalar el [!DNL InMoment] extensión:
