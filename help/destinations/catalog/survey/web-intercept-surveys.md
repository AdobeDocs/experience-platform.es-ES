---
keywords: QuestionPro Intercept Encuestas;cuestionarios de intercepción de QuestionPro;QuestionPro;cuestionpro
...
# Extensión [!DNL QuestionPro Intercept Surveys] {#questionpro-extension}
...
[!DNL QuestionPro Intercept Surveys] es una extensión de encuesta en [!DNL Adobe Experience Platform]. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
