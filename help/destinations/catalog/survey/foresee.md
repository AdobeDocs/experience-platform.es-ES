...
# Extensión [!DNL Foresee] {#foresee-extension}

## Información general {#overview}

Configurar [!DNL ForeSee] implementaciones de productos mediante etiquetas.

[!DNL Foresee] es una extensión de encuesta en [!DNL Adobe Experience Platform]. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html).
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la [página Foresee extension](https://exchange.adobe.com/experiencecloud.details.100164.html) en Adobe Exchange.
