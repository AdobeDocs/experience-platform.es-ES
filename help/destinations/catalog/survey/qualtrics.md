---
keywords: Qualtrics;qualtrics;Comentarios del sitio web de Qualtrics;comentarios del sitio web de Qualtrics;Comentarios del sitio web de Qualtrics
title: Extensión de comentarios del sitio web Qualtrics
description: La extensión de comentarios del sitio web de Qualtrics es un destino de encuestas en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión [!DNL Qualtrics Website Feedback] {#qualtrics-extension}

## Información general {#overview}

[!DNL Qualtrics Website Feedback] le permite atraer a los visitantes de su sitio web con el mensaje correcto y en el momento adecuado. Si desea mejorar la experiencia del visitante con las encuestas de comentarios del sitio web o aumentar la conversión, [!DNL Qualtrics Website Feedback] le tiene cubierto.

Cree e implemente mensajes web de marca y de destino rápido en cuestión de minutos mediante una interfaz intuitiva de apuntar y hacer clic. Los datos y las perspectivas que recopila de su sitio web se muestran junto con los datos de comentarios de los clientes en todos los canales, lo que ofrece una vista completa de su experiencia del cliente, todo en una plataforma.

[!DNL Qualtrics Website Feedback] es una extensión de encuesta en Adobe Experience Platform. Para obtener más información acerca de la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
![Extensión de comentarios del sitio web de Qualtrics](../../assets/catalog/survey/qualtrics/catalog.png)
...
Para obtener información acerca de las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página [Comentarios del sitio web de Qualtrics en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
