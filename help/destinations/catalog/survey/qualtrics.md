---
keywords: Qualtrics;qualtrics;Qualtrics Website Comentarios;Qualtrics website Comentarios;comentarios de sitios web;Qualtricks comentarios de sitios web
title: Qualtrics Website, extensión de comentarios
seo-title: Qualtrics Website, extensión de comentarios
description: La extensión Qualtrics Website Feedback es un destino de encuestas en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Qualtrics Website Feedback es un destino de encuestas en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de [!DNL Qualtrics Website Feedback] {#qualtrics-extension}

## Información general {#overview}

[!DNL Qualtrics Website Feedback] le permite interactuar con los visitantes del sitio web con el mensaje correcto, en el momento adecuado. Ya sea que desee mejorar la experiencia de visitante con encuestas de comentarios del sitio web o aumentar la conversión, [!DNL Qualtrics Website Feedback] le ha dado cobertura.

Cree e implemente mensajes web de marca con un objetivo muy preciso en cuestión de minutos mediante una interfaz intuitiva de apuntar y hacer clic. Los datos y perspectivas que recopila en su sitio web se muestran junto con los datos de comentarios de los clientes en todos los canales, lo que ofrece una vista completa de la experiencia de los clientes, todo en una sola plataforma.

[!DNL Qualtrics Website Feedback] es una extensión de encuesta en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
![Extensión de comentarios del sitio web Qualtrics](../../assets/catalog/survey/qualtrics/catalog.png)
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la [página de comentarios del sitio Web de Qualtrics en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
