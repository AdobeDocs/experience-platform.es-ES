...
[!DNL Qualtrics Website Feedback] le permite atraer a los visitantes de su sitio web con el mensaje correcto, en el momento adecuado. Si desea mejorar la experiencia del visitante con encuestas de comentarios del sitio web o aumentar la conversión, [!DNL Qualtrics Website Feedback] te tiene cubierto.
...
[!DNL Qualtrics Website Feedback] es una extensión de encuesta en Adobe Experience Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión sobre [Intercambio de Adobe](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
Para instalar el [!DNL Qualtrics Website Feedback] extensión:
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la [Página de comentarios del sitio web de Qualtrics sobre Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
