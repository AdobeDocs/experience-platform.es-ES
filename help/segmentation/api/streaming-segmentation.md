...
Puede recuperar una lista de todos los segmentos que están habilitados para la segmentación de flujo continuo dentro de su organización realizando una solicitud de GET al `/segment/definitions` punto final.
...
Una respuesta correcta devuelve una matriz de segmentos de su organización que están habilitados para la segmentación de flujo continuo.
