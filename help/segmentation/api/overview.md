...
Las audiencias son una colección de personas que comparten comportamientos y/o características similares. Pueden generarse mediante Platform o desde fuentes externas. Puede usar la variable `/audiences` punto final para recuperar todas las audiencias, crear una audiencia nueva, recuperar detalles de una audiencia específica, actualizar una audiencia específica o eliminar una audiencia específica.

Para obtener más información sobre el uso de este punto final, lea la [guía de extremo de audiencias](./audiences.md).
