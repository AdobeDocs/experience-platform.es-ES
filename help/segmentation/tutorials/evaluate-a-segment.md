...
topic: tutorial
type: Tutorial
description: Siga este tutorial para aprender a evaluar los segmentos y acceder a los resultados de los mismos mediante la API de servicio de segmentación de Adobe Experience Platform.
