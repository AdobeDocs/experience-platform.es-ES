...
- La definición del segmento coincide con los siguientes conjuntos de reglas:
   - Un solo evento con un intervalo de tiempo superior a 24 horas
      - Por ejemplo, &quot;Activar una audiencia con todos los perfiles que vieron una página web en los últimos 3 días&quot;.
   - Un solo evento sin ventana de tiempo
      - Por ejemplo, &quot;Activar una audiencia con todos los perfiles que vieron una página web&quot;.
...
En el Generador de segmentos, cree una definición de segmento que coincida con uno de los [conjuntos de reglas aptos](#eligible-rulesets). Si la definición del segmento cumple los requisitos para la segmentación de transmisión, podrá seleccionar **[!UICONTROL Streaming]** como **[!UICONTROL Evaluation method]**.
...
Dentro de los filtros disponibles, vaya a **[!UICONTROL Update frequency]** y seleccione &quot;[!UICONTROL Streaming]&quot;. Uso de este filtro muestra todas las audiencias de su organización que se evalúan mediante la segmentación de flujo continuo.
...
Para audiencias habilitadas para streaming, se muestra la tarjeta **[!UICONTROL Profiles over time]**, que muestra el total de métricas calificadas y la nueva audiencia actualizada.

La métrica **[!UICONTROL Total qualified]** representa el número total de audiencias calificadas, según las evaluaciones por lotes y de flujo continuo para esta audiencia.

La métrica **[!UICONTROL New audience updated]** está representada por un gráfico de líneas que muestra el cambio en el tamaño de la audiencia mediante la segmentación de flujo continuo. Puede ajustar el menú desplegable para mostrar las últimas 24 horas, la semana pasada o los últimos 30 días.
...
Esta sección proporciona información complementaria sobre la segmentación de flujo continuo.

### Actualización de idoneidad del 20 de mayo de 2025 {#may-20-eligibility-update}

En la siguiente sección se describen, para la posteridad, los detalles completos de la actualización de idoneidad para la segmentación de streaming que se produjo durante la versión de mayo de 2025 de Experience Platform.
