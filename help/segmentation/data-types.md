...
| Cualquiera/todos | Ayuda a determinar el número de segmentos aptos. |
...
Las audiencias externas también se pueden utilizar como componentes de una nueva definición de segmento y añadir sus reglas de atributos al nuevo segmento.
