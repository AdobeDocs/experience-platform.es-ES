...
El Generador de segmentos analiza y valida automáticamente su definición de audiencia para garantizar que se adhiere a las prácticas recomendadas de definición de audiencia. Estas prácticas recomendadas se pueden clasificar en dos categorías: validación crítica y optimización del rendimiento.
...
Para obtener más información sobre cómo funciona la validación de audiencias, lea la [guía de validación de audiencias](/help/segmentation/validation.md).
