...
En la interfaz de usuario de Experience Platform, seleccione **[!UICONTROL Audiences]** en el panel de navegación izquierdo para abrir la pestaña **[!UICONTROL Overview]** que muestra el panel [!UICONTROL Audiences].

>[!NOTE]
>
>Si su organización es nueva en Experience Platform y aún no ha creado conjuntos de datos de perfil o políticas de combinación activos, el panel [!UICONTROL Audiences] no estará visible. En su lugar, la pestaña [!UICONTROL Overview] muestra vínculos y documentación para ayudarle a empezar a usar las audiencias.

### [!UICONTROL Audiences] panel {#segments-dashboard}

El panel **[!UICONTROL Audiences]** describe las métricas clave relacionadas con los datos de audiencia de su organización.
...
Seleccione la pestaña **[!UICONTROL Compositions]** para ver una lista de todas las audiencias generadas a través de Composición de audiencias para su organización.
...
| [!UICONTROL Status] | El estado de la audiencia. Los valores posibles de este campo incluyen `Draft`, `Inactive` y `Published`. |
| [!UICONTROL Created] | La hora y la fecha de creación de la audiencia. |
| [!UICONTROL Created by] | El nombre de la persona que creó la audiencia. |
| [!UICONTROL Updated] | Fecha y hora en la que se actualizó la audiencia por última vez. |
| [!UICONTROL Updated by] | El nombre de la persona que actualizó la audiencia por última vez. |

Para ver la composición de la audiencia, seleccione un nombre de audiencia en la ficha [!UICONTROL Audiences].
