...
La configuración de consentimiento predeterminada para [!DNL Segment Match] se establece en `opt-out`. Para aplicar un modelo de inclusión en sus datos, envíe una solicitud por correo electrónico al administrador de cuentas de Adobe.
...
| Permiso | Descripción |
| --- | --- |
| Administrar conexiones de Audience Share | Este permiso le permite completar el proceso de identificación del socio, que conecta dos organizaciones IMS para habilitar [!DNL Segment Match] flujos. |
...
>title="Casos de uso de marketing restringido"
>abstract="Los casos de uso de marketing restringido ayudan a proporcionar directrices a los socios para garantizar que los segmentos compartidos se utilicen correctamente según las restricciones de control de datos."
