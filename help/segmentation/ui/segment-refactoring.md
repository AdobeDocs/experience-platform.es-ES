...
![Se resalta la restricción de tiempo a nivel de regla. El error que se produce posteriormente también se resalta.](../images/ui/segment-refactoring/rule-time-constraint.png)
...
Para aplicar una restricción de tiempo en el nivel de tarjeta, seleccione la tarjeta específica a la que desee aplicar la restricción de tiempo. Aparece el contenedor **[!UICONTROL Event Rules]**. Ahora puede seleccionar la restricción de tiempo que desee aplicar a la tarjeta.
