...
![Evolucione paso a paso un valor único a un valor de duración información general visual de alto nivel.](../evolve-one-time-value-lifetime-value/images/diagram-business-use-case.png){width="500" zoomable="yes"}
