...
* Real-time Customer Data Platform {#intro}
   ...
   * [Información general sobre las métricas](home-page-dashboards.md)
...
* Destinos {#destinations}
   ...
   * Catálogo de destinos {#destinations-cat}
      ...
      * Destinos de almacenamiento en la nube{#cloud-storage}
         * [Información general sobre los destinos de almacenamiento en la nube](destinations/cloud-storage-destinations.md)
...
* Privacidad y administración de datos {#privacy}
   * [Información general sobre la privacidad](privacy/privacy-overview.md)
   * [Información general sobre la administración de datos](privacy/data-governance-overview.md)
* Perfil del cliente en tiempo real {#profile}
   * [Descripción general del perfil](profile/profile-overview.md)
