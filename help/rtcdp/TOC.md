...
* Conjuntos de datos {#datasets}
   ...
   * [Calidad de los datos en Experience Platform](datasets/data-quality.md)
...
* Casos de uso {#use-cases}
   ...
   * Adquisición de cliente {#customer-acquisition}
      ...
      * [Retargeting fuera del sitio de usuarios no autenticados](./partner-data/unauthenticated-retargeting.md)
