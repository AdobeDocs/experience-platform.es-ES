...
| Barrera | Límite | Tipo de límite | Descripción |
| --------- | ----- | ---------- | ----------- |
| No hay relaciones heredadas anidadas | 0 | Protección de rendimiento | No debe crear una relación entre dos esquemas que no sean [!DNL XDM Individual Profile]. No se recomienda **crear relaciones** para ningún esquema que no forme parte del esquema de unión [!DNL Profile]. |
...
![Infografía que describe las diferencias entre los datos de los registros y los datos de las series temporales.](../profile/images/guardrails/profile-entity.png)
