...
Use [!DNL Real-Time Customer Data Platform] para introducir nuevas fuentes de datos en Experience Platform. Real-Time CDP incluye un catálogo de fuentes de datos que se pueden añadir rápida y fácilmente al perfil.
...
1. Elija lo que desea importar de una lista recomendada de tablas preasignadas de XDM.
   ...
   Por ejemplo, seleccione **[!UICONTROL Contacts]**. Se carga automáticamente una previsualización de los datos de los contactos para que pueda asegurarse de que todo tiene el aspecto esperado.
...
Seleccione **[!UICONTROL Send to destinations]**.

En Real-Time CDP, Luma puede actuar sin problemas en sus audiencias para la personalización.\
Aquí vemos todos los destinos disponibles para que Luma envíe este destino a, tanto soluciones de Adobe como que no sean de Adobe:
...
Seleccione **[!UICONTROL Save]** para ir a la página siguiente.
