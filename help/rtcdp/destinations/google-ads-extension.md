...
description: La extensión Google Ads es un destino publicitario en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Google Ads es un destino publicitario en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
Esta extensión rastrea las conversiones de los usuarios que hacen clic en su [!DNL Google Ads]. También deberá instalar la extensión gtag.js y agregarla a su biblioteca, según [!DNL Google Ads] dependa de ella.

[!DNL Google Ads] es una extensión de publicidad en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html).
...
![Extensión Google Ads](/help/rtcdp/destinations/assets/google-ads-extension.png)
...
Para instalar la [!DNL Google Ads] extensión:
