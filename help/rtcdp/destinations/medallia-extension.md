...
description: La extensión Media es una voz del destino del cliente en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Medallia es una voz del destino del cliente en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión Medallia {#medallia-extension}

## Información general {#overview}

Implemente Medallia de forma rápida y transparente en sus propiedades web. La extensión también le permite detectar eventos de encuesta, capturar comentarios de clientes en tiempo real mediante elementos de datos, utilizarlos en reglas para personalizar la experiencia de sus clientes y compartir datos con Adobe Analytics.

Medallia es una voz de la extensión del cliente en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103279.medallia-for-adobe-launch.html).
...
Para instalar la extensión Medallia:
