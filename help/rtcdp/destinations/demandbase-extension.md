...
description: La extensión Demandbase es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Demandbase es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión Demandbase {#demandbase-extension}

## Información general {#overview}

Obtenga perspectivas de cuenta B2B de Demandbase directamente en Adobe Analytics, donde puede segmentar el tráfico y el comportamiento por sector, ingresos y cuentas de destinatario. Esta vista basada en la cuenta ofrece perspectivas únicas sobre la participación, la conversión y la fuente de sus visitantes más valiosos.

Demandbase es una extensión de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
Para instalar la extensión Demandbase:
