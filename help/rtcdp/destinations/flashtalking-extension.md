...
description: La extensión Flashtalk OneTag es un destino publicitario de la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión Flashtalk OneTag {#flashtalking-extension}

## Información general {#overview}

La extensión Flashtalk OneTag para Experience Platform Launch facilita la atribución de acciones del sitio a visualización, vídeo y actividad de publicidad móvil. Implemente Flashtalk OneTag en las propiedades web mediante Launch.

Flashtalk OneTag es una extensión de publicidad en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
Para instalar la extensión Flashtalk OneTag:
