---
title: Extensión DIL del Administrador de Audiencias
seo-title: Extensión DIL del Administrador de Audiencias
description: La extensión DIL del Administrador de Audiencias es un destino de plataforma de Gestión de datos (DMP) en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión DIL del Administrador de Audiencias es un destino de plataforma de Gestión de datos (DMP) en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión DIL del Administrador de Audiencias {#aam-dil-extension}

## Información general {#overview}

Esta es la extensión de la biblioteca de integración de datos de Adobe Audiencia Manager (implementación en el lado del cliente). Nota: Esta extensión no está pensada para utilizarse para el reenvío de servidor (SSF) de datos de Adobe Analytics. Para SSF, utilice la extensión Adobe Analytics. Importante: A partir de la versión 8.0, DIL tiene una dependencia del servicio de ID de Experience Cloud, versión 3.3 o superior. Implemente tanto el servicio Experience Cloud ID como el DIL para las funciones completas de integración de datos del Administrador de Audiencias.

DIL del Administrador de Audiencias es una extensión de plataforma de Gestión de datos (DMP) en la plataforma de datos del cliente de Adobe en tiempo real. Para obtener más información sobre la funcionalidad de la extensión, consulte la página [de extensión del Administrador de](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) Audiencias en la documentación del Experience Platform Launch.
...
![Extensión DIL del Administrador de Audiencias](/help/rtcdp/destinations/assets/aam-dil-extension.png)
...
Para instalar la extensión DIL del Administrador de Audiencias:
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la página [de extensión del Administrador de](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) Audiencias en la documentación de Experience Launch.
