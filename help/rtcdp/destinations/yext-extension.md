...
description: La extensión Seguimiento de conversión de texto siguiente es un destino de análisis en Platform de datos de cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Seguimiento de conversión de texto siguiente es un destino de análisis en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
La [!DNL Yext Conversion Tracking] extensión permite medir las conversiones que se pueden atribuir al uso de productos de texto.

[!DNL Yext Conversion Tracking] es una extensión de análisis en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
![Extensión de seguimiento de conversión de texto](assets/yext-extension.png)
...
Para instalar la [!DNL Yext Conversion Tracking] extensión:
...
Para obtener información sobre las opciones de configuración de extensión y la compatibilidad con la instalación, consulte la página Seguimiento de conversión [siguiente en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
