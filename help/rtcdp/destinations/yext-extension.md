...
description: La extensión Seguimiento de conversión de texto siguiente es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Seguimiento de conversión de texto siguiente es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de seguimiento de conversión de texto {#yext-extension}

## Información general {#overview}

La extensión de seguimiento de conversión siguiente le permite medir las conversiones que se pueden atribuir al uso de productos de texto.

El seguimiento de conversión de texto es una extensión de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
Para instalar la extensión Seguimiento de conversión de texto siguiente:
