...
title: Extensión de decibelios
seo-title: Extensión de decibelios
description: La extensión Decibel es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Decibel es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
# [!DNL Decibel] Extensión {#decibel-extension}

## Información general {#overview}

Implemente [!DNL Decibel] en forma rápida y transparente sus propiedades web. También se pueden implementar configuraciones avanzadas adicionales con reglas mediante acciones disponibles a través de la extensión.

[!DNL Decibel] es una extensión de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html).
...
![Extensión de decibelios](assets/decibel-extension.png)
...
Para instalar la [!DNL Decibel] extensión:
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la página [de extensión](https://exchange.adobe.com/experiencecloud.details.100913.html) Decibel en Adobe Exchange.
