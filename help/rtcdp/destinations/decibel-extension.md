...
description: La extensión Decibel es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Decibel es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de decibelios {#decibel-extension}

## Información general {#overview}

Implemente Decibel de forma rápida y transparente en sus propiedades web. También se pueden implementar configuraciones avanzadas adicionales con reglas mediante acciones disponibles a través de la extensión.

Decibel es una extensión de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100913.html).
...
Para instalar la extensión Decibel:
