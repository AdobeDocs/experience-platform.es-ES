...
# Confirmar extensión de comentarios digitales

## Información general {#overview}

Confirmar comentarios digitales ayuda a convertir el tráfico del sitio web en perspectivas en tiempo real. Con Confirmit, se pueden mostrar encuestas discretas y con un alto objetivo según sus necesidades, lo que anima a los visitantes a proporcionar comentarios, como por ejemplo:
...
Para instalar la extensión Confirmit Digital Feedback:
