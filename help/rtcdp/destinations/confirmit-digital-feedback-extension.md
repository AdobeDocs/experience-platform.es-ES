...
description: La extensión Confirmar comentarios digitales es una Voz del destino del cliente en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
