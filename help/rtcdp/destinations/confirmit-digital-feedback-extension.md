...
description: La extensión Confirmar comentarios digitales es una Voz del destino del cliente en Adobe Datos del cliente en tiempo real Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
