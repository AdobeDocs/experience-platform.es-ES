...
seo-title: Extensión de etiqueta de sitio web universal de Twitter
description: La extensión de etiqueta de sitio web universal de Twitter es un destino publicitario en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión de etiqueta de sitio web universal de Twitter es un destino publicitario en la plataforma de datos de clientes en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de etiqueta de sitio web universal de Twitter {#twitter-uwt-extension}

## Información general {#overview}

La etiqueta de sitio web universal de Twitter proporciona acciones para enviar señalizaciones a la etiqueta UWT de Twitter.

La etiqueta de sitio web universal de Twitter es una extensión de publicidad en la plataforma de datos de clientes en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte Seguimiento de conversión [avanzado](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html).
...
![Extensión de etiqueta de sitio web universal de Twitter](assets/twitter-uwt-extension.png)
...
Para instalar la extensión de etiqueta universal del sitio web de Twitter:
