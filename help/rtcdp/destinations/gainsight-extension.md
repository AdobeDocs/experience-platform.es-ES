---
title: Extensión Gainsight
seo-title: Extensión Gainsight
description: La extensión Gainsight es un destino de personalización en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Gainsight es un destino de personalización en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión Gainsight {#gainsight-extension}

## Información general {#overview}

Gainsight proporciona a los propietarios de productos las herramientas necesarias para comprender a fondo el comportamiento de los usuarios, impulsar la adopción de productos y recopilar comentarios de los usuarios.

Gainsight es una extensión de personalización en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
![Extensión Gainsight](assets/gainsight-extension.png)
...
Para instalar la extensión de Gainsight:
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página [de Gainsight en Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
