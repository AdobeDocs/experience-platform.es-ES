...
description: La extensión Qualtrics Website Feedback es un destino de encuestas en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Qualtrics Website Feedback es un destino de encuestas en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de comentarios del sitio web Qualtrics {#qualtrics-extension}

## Información general {#overview}

Qualtrics Website Feedback le permite interactuar con los visitantes de su sitio web con el mensaje correcto, en el momento adecuado. Tanto si desea mejorar la experiencia de visitante con las encuestas de comentarios del sitio web como si desea aumentar la conversión, Qualtrics Website Feedback le ha dado cobertura.
...
Qualtrics Website Feedback es una extensión de encuesta de la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
Para instalar la extensión Qualtrics Website Feedback:
