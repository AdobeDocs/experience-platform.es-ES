...
description: La extensión Google Global Site Tag es un destino de análisis en la plataforma de datos de clientes en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Google Global Site Tag es un destino de análisis en la plataforma de datos de clientes en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de etiquetas de sitio global de Google {#gtag-analytics-extension}

## Información general {#overview}

Envíe datos a Google Analytics, Google Ads y Google Marketing Platform a través de la etiqueta de sitio global de Google o gtag.js. Se pueden configurar varias cuentas por producto.

Google Global Site Tag es una extensión de análisis en la plataforma de datos de clientes en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html).
...
Para instalar la extensión Google Global Site Tag:
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la página de [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) de la extensión.
