...
description: La extensión de Encuestas de Intercept de QuestionPro es un destino de encuesta en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Encuestas de Intercept de QuestionPro es un destino de encuesta en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de Encuestas de intercepción de QuestionPro {#questionpro-extension}

## Información general {#overview}

Encuestas de intersección de QuestionPro es una plataforma para implementar encuestas y recopilar datos actitudinales en el punto de transacción o cuando los usuarios entran o salen del sitio web.

Las Encuestas de Intercept de QuestionPro es una extensión de encuesta en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
Para instalar la extensión de Encuestas de Intercept de QuestionPro:
