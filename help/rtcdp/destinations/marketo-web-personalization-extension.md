...
description: La extensión Personalización web de marketing es un destino de personalización en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Personalización web de marketing es un destino de personalización en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de personalización web de marketing {#marketo-web-personalization-extension}

## Información general {#overview}

Esta extensión implementa la secuencia de comandos para las aplicaciones de Personalización web y ContentAI de Marketing. La personalización de la Web de Marketing identifica y personaliza de forma exclusiva el contenido según las características del visitante Web, como las firmografías para visitantes anónimos y una amplia variedad de atributos de comportamiento dentro de la plataforma de participación de Marketing to para visitantes conocidos. Marketing ContentAI contiene funciones para recomendaciones y personalización con tecnología AI para campañas de correo electrónico y web que son únicas para clientes B2B.

Personalización web de marketing es una extensión de personalización en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html).
...
![Extensión de personalización web de marketing](assets/marketo-web-personalization-extension.png)
...
Para instalar la extensión Personalización web de marketing:
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página Personalización web de [marketing en Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101232.marketo-web-personalization.html).
