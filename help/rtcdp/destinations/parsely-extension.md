...
seo-title: Extensión de Analytics de Parse.ly
description: La extensión Analytics de Parse.ly es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Analytics de Parse.ly es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de Analytics de Parse.ly {#parsely-analytics-extension}

## Información general {#overview}

Analytics de Parse.ly ayuda a más de 2.500 compañías a utilizar datos para comprender su audiencia en línea. Esta extensión instala un fragmento de código JavaScript que rastrea la forma en que los visitantes interactúan con el contenido del sitio.

Parse.ly es una extensión de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte [Análisis](https://www.parse.ly/)de Parse.ly.
...
![Extensión de Analytics de Parse.ly](assets/parsely-extension.png)
...
Para instalar la extensión Parse.ly:
