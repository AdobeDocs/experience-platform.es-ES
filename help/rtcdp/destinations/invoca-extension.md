...
description: La extensión Etiquetas de Invoca es una voz del destino del cliente en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión Etiquetas de Invoca {#invoca-extension}

## Información general {#overview}

Invoca aporta datos de llamadas y perspectivas de voz en el viaje digital del cliente. Con la plataforma de inteligencia de llamadas de Invoca, los especialistas en mercadotecnia finalmente tienen análisis para medir los resultados de las llamadas y enlazar las conversiones sin conexión con el gasto digital.

Invoca Tags es una voz de la extensión de cliente en la plataforma de datos de clientes en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
...
Para instalar la extensión Etiquetas de Invoca:
