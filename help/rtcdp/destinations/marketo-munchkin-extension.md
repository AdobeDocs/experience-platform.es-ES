...
description: La extensión Marketo Munchkin es un destino de personalización en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Marketo Munchkin es un destino de personalización en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de Marketo Munchkin {#marketo-munchkin-extension}

## Información general {#overview}

Desde la administración de posibles clientes hasta la mercadotecnia basada en cuentas, la plataforma de compromiso de marketing simplifica la forma en que planifica, organiza y mide la participación con clientes y clientes potenciales en cada etapa de su experiencia.

El código JavaScript Munchkin de Marketing permite el seguimiento de las visitas a la página del usuario final y los clics a las páginas de aterrizaje de Marketing y a las páginas Web externas.

Marketo Munchkin es una extensión de correo electrónico en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html).
...
Para instalar la extensión Marketo Munchkin:
