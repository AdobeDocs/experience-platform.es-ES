...
description: La extensión Pixel de Facebook es un destino publicitario en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
[!DNL Facebook Pixel] es una extensión de publicidad en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de extensión, consulte el sitio web [Facebook Pixel](https://developers.facebook.com/docs/facebook-pixel/).
