...
description: La extensión JW Player Analytics (BETA) es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión JW Player Analytics (BETA) es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de JW Player Analytics (BETA) {#jw-player-analytics-extension}

## Información general {#overview}

Esta extensión instala el adaptador de JW Player para conectar los eventos de JW Player a Adobe Video Analytics. Aproveche el poder de Adobe Video Analytics para obtener perspectivas detalladas a fin de comprender los hábitos de visualización de vídeo de sus clientes.

JW Player Analytics (BETA) es una extensión de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html).
...
Para instalar la extensión JW Player Analytics (BETA):
