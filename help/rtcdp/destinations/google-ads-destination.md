...
Google ha pausado todas las integraciones nuevas de Google Ads con proveedores de terceros. Debe tener una integración existente con Google Ads para poder realizar los pasos de lista permitidos en la sección siguiente y crear un destino de Google Ads en Adobe Real-time CDP.

### Permitir lista

>[!NOTE]
>
>La lista allow es obligatoria antes de configurar el primer destino de Google Ads en Adobe Real-time CDP. Asegúrese de que Google haya completado el proceso de permitir lista que se describe a continuación antes de crear un destino.

Antes de crear el destino Google Ads en Adobe Real-time CDP, debe ponerse en contacto con Google para que Adobe se ponga en lista de proveedores de datos permitidos y para que su cuenta se agregue a la lista allow. Póngase en contacto con Google y proporcione la siguiente información:
