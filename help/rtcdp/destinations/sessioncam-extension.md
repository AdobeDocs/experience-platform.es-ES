...
seo-title: Extensión SessionCam
description: La extensión SessionCam es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión SessionCam es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión SessionCam {#sessioncam-extension}

## Información general {#overview}

SessionCam proporciona un conjunto esencial de herramientas que revelan el comportamiento del usuario y le muestran los problemas más importantes que solucionar.

SessionCam es una extensión de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html).
...
![Extensión SessionCam](assets/sessioncam-extension.png)
...
Para instalar la extensión SessionCam:
