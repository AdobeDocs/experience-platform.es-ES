...
![Seleccionar paso de segmentos](./assets/select-segments-icon.png)
...
![Paso de asignación de identidades](./assets/identity-mapping-icon.png)
...
![Configurar paso](./assets/configure-icon.png)

En el paso **[!UICONTROL Configurar]** , puede configurar los nombres de archivo para cada segmento que esté exportando. La configuración del nombre del archivo es opcional.
...
![configurar nombre de archivo](./assets/activate-destinations/configure-name.png)
...
![paso de programación de segmentos](./assets/segment-schedule-icon.png)
...
![seleccionar paso de atributos](./assets/select-attributes-icon.png)
...
>
> 
Por ejemplo, si el campo `person.name.firstName` tiene ciertas etiquetas de uso de datos que entran en conflicto con el caso de uso de marketing del destino, se le mostrará una infracción de directiva de uso de datos en el paso de revisión. Para obtener más información, consulte Administración [de datos en CDP](/help/rtcdp/privacy/data-governance-overview.md#destinations)en tiempo real.

### **[!UICONTROL Paso de revisión]** {#review}

Se aplica a: todos los destinos

![paso de revisión](./assets/review-icon.png)
