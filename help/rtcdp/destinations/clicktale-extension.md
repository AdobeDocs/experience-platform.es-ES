...
# Extensión Clicktale {#clicktale-extension}

## Información general {#overview}

La integración de Clicktale con Experience Platform Launch permite la implementación del código Clicktale y la capacidad de asignar elementos de datos dentro de Launch, mediante el Editor visual de Clicktale.
...
Para instalar la extensión Clicktale:
