...
seo-title: Extensión de métrica cuántica
description: La extensión de métrica cuántica es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión de métrica cuántica es un destino de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
# Extensión de métrica cuántica {#quantum-metric-extension}

## Información general {#overview}

La integración de Quantum Metric con Adobe Launch facilita la implementación sin código de la etiqueta de recopilación de datos de Quantum Metric. Además, esta extensión oferta la capacidad de capturar elementos de datos de inicio que contengan información útil de la API de métricas cuánticas.

La métrica cuántica es una extensión de análisis en la plataforma de datos del cliente en tiempo real de Adobe. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
![Extensión de métrica cuántica](assets/quantum-metric-extension.png)
...
Para instalar la extensión de métrica cuántica:
...
Para obtener información sobre las opciones de configuración de la extensión y la compatibilidad con la instalación, consulte la página Métrica cuántica de Adobe Exchange [](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
