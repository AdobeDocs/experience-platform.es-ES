---
title: Extensión Analytics universal de Google
seo-title: Extensión Analytics universal de Google
description: La extensión de Google Universal Analytics es un destino de análisis en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión de Google Universal Analytics es un destino de análisis en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de extensión, consulte la página de extensión en Adobe Exchange.
...
[!DNL Google Universal Analytics] le permite medir el ROI de la publicidad, así como también rastrear sus aplicaciones y sitios Flash, video y redes sociales.
...
![Extensión Analytics universal de Google](/help/rtcdp/destinations/assets/google-universal-analytics-extension.png)
...
Para instalar la [!DNL Google Universal Analytics] extensión:
...
Para obtener información sobre las opciones de configuración de la extensión, consulte la página [de extensión Universal Analytics de](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html) Google en Adobe Exchange.
