...
description: La extensión de Google Universal Analytics es un destino de análisis en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión de Google Universal Analytics es un destino de análisis en Adobe Real-time Customer Data Platform. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
[!DNL Google Universal Analytics] le permite medir el ROI de la publicidad, así como también rastrear sus aplicaciones y sitios de Flash, vídeo y redes sociales.
