...
description: La extensión Adobe Media Analytics para audio y vídeo es un destino de análisis en la plataforma de datos del cliente en tiempo real. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
seo-description: La extensión Adobe Media Analytics para vídeo es un destino de análisis en la plataforma de datos del cliente en tiempo real. Para obtener más información sobre la funcionalidad de la extensión, consulte la página de extensión en Adobe Exchange.
...
![Extensión de Adobe Media Analytics for Audio and Video](/help/rtcdp/destinations/assets/adobe-video-analytics-extension.png)
