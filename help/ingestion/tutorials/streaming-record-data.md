...
Con el conjunto de datos y la conexión de flujo continuo en su lugar, puede ingerir registros JSON con formato XDM para ingerir datos de registro en [!DNL Platform].
