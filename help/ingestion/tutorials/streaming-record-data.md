...
# Transmitir datos de registro al Adobe Experience Platform
...
>[!NOTE]
>
>Este conjunto de datos se habilitará para el Perfil **del cliente en tiempo** real y el servicio **de identidad**.
...
Con el conjunto de datos y la conexión de flujo en su lugar, puede ingestar registros JSON con formato XDM para ingestar datos de registro en Platform.
