...
## Redactar un esquema basado en la clase de Perfil individual XDM

Para crear un conjunto de datos, primero deberá crear un nuevo esquema que implemente la clase de Perfil XDM Individual. Para obtener más información sobre cómo crear esquemas, consulte la guía [para desarrolladores de la API de registro de](../../xdm/api/getting-started.md)Esquema.
...
>[!NOTE] Este conjunto de datos se habilitará para el Perfil **del cliente en tiempo** real y el servicio **de identidad**.
...
Con el conjunto de datos y la conexión de flujo en su lugar, puede ingestar registros JSON con formato XDM para ingestar datos de registro en la plataforma.
...
>[!NOTE] La siguiente llamada de API **no requiere** encabezados de autenticación.
...
Para validar los registros ingestados anteriormente, puede utilizar la API [de acceso a](../../profile/api/entities.md) Perfil para recuperar los datos del registro.
