...
Para volver a la pantalla de Actividad **[!UICONTROL del]** conjunto de datos, haga clic en el nombre del conjunto de datos (Detalles de _[!UICONTROL lealtad]_) en la ruta de exploración.
