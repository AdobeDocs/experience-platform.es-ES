...
>[!IMPORTANT]
>
>Este extremo representa la funcionalidad beta para eliminaciones de registros. Para obtener las últimas funciones, utilice el [`/workorder` extremo](./workorder.md) en su lugar.
