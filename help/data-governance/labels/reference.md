...
# Etiquetas de uso de datos admitidas

Adobe Experience Platform incluye una infraestructura para la gestión de datos con el etiquetado y la aplicación del uso de datos (DULE) en su núcleo.  Las funciones DULE permiten la aplicación de etiquetas de uso de datos a conjuntos de datos y campos para clasificar los datos según el tipo de políticas de uso que se aplican a esos datos.

La siguiente lista describe todas las etiquetas de uso de datos admitidas actualmente por la plataforma de experiencia.

Puede encontrar más información acerca de la Administración de datos y el DULE en la descripción general [de la Administración de](../home.md)datos.
...
En la siguiente sección se proporciona información detallada sobre la implementación de etiquetas específicas.
...
Algunos proveedores de datos tienen cláusulas en sus contratos que prohíben la exportación de datos desde donde se recopilaron originalmente. Por ejemplo, los contratos de redes sociales suelen restringir la transferencia de datos que recibe de ellos. La etiqueta C2 es más restrictiva que la [C1](#c1), que solo requiere agregación y datos anónimos.
...
C4 es la etiqueta más restrictiva: incluye las etiquetas [C5](#c5), [C6](#c6)y [C7](#c7).
