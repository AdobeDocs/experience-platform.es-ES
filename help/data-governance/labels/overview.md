...
El área de trabajo **[!UICONTROL Policies]** de la interfaz de usuario [!DNL Experience Platform] le permite ver y administrar las etiquetas principales y personalizadas de su organización. Puede usar el área de trabajo **[!UICONTROL Schemas]** para [aplicar etiquetas a los esquemas XDM (Experience Data Model)](../../xdm/tutorials/labels.md), o aprender a [crear y administrar etiquetas personalizadas en la interfaz de usuario **[!UICONTROL Policies]**](./user-guide.md) leyendo la guía del usuario de etiquetas de uso de datos en su lugar.
