...
* [Servicio de segmentación de Adobe Experience Platform](../../segmentation/home.md): el motor de segmentación dentro de [!DNL Platform] se utiliza para crear audiencias a partir de los perfiles de clientes en función de los comportamientos y atributos de los clientes.
...
![Ilustración de cómo la aplicación de directivas está integrada en el flujo de datos de activación de audiencia.](../images/enforcement/enforcement-flow.png)
...
1. Los grupos de perfiles se dividen en **audiencias** en función de atributos comunes.
1. Las audiencias se activan en la fase descendente **destinos**.
...
![El conmutador de audiencias en el cuadro de diálogo de comprobación de directivas.](../images/enforcement/audience-switcher.png)

Utilice el carril izquierdo para cambiar entre las políticas de consentimiento aplicables a la audiencia seleccionada. Las políticas que no están seleccionadas se representan en la sección &quot;[!UICONTROL Otras políticas]&quot; del diagrama.
...
1. Perfiles que cumplen los requisitos de las demás políticas de consentimiento aplicables a la audiencia (denominadas &quot;[!UICONTROL Otras políticas]&quot; en el diagrama)
