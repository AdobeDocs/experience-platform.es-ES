...
Mejora de la aplicación de las políticas de consentimiento en [batch](../../destinations/destination-types.md#file-based) y [streaming](../../destinations/destination-types.md#streaming-destinations) se han realizado destinos que incluyen activaciones de medios de pago. Esta mejora está disponible para los clientes de Privacy and Security Shield o Healthcare Shield, y elimina de forma proactiva los perfiles de los destinos de agrupamiento y transmisión a medida que cambia el estado de consentimiento. También garantiza que los cambios de consentimiento se propaguen inmediatamente para que la audiencia correcta esté siempre segmentada.
