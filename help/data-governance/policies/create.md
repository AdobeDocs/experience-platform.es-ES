...
La siguiente solicitud utiliza la variable `marketingActions/custom` , que obtiene una lista de todas las acciones de marketing definidas por su organización.
...
## Creación de una directiva {#create-policy}
