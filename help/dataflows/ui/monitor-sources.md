...
# Monitorización de flujos de datos para fuentes en la IU
...
>abstract="La vista Ingesta de fuente contiene información sobre el estado de la actividad de datos y las métricas en el servicio del lago de datos, incluidos los registros ingeridos y los registros con errores. Consulte la guía de definición de métricas para obtener más información sobre las métricas y los gráficos."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_monitoring_dataflow_run_details_ingestion"
>title="Detalles de ejecución del flujo de datos"
>abstract="El procesamiento de fuentes contiene información sobre el estado de la actividad de datos y las métricas del servicio del lago de datos, incluidos los registros introducidos y los registros con errores. Consulte la guía de definición de métricas para obtener más información sobre las métricas y los gráficos."
>text="Learn more in documentation"
