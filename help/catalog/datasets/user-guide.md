...
Puede [!UICONTROL Delete] o [!UICONTROL Enable a dataset for Profile] desde la vista de detalles de [!UICONTROL Dataset]. Para ver las acciones disponibles, seleccione **[!UICONTROL ... More]** en la parte superior derecha de la interfaz de usuario. Aparecerá el menú desplegable.

![Se ha resaltado el área de trabajo Conjuntos de datos con el menú desplegable [!UICONTROL ... More].](../images/datasets/user-guide/more-actions.png)

Si selecciona **[!UICONTROL Enable a dataset for Profile]**, aparecerá un cuadro de diálogo de confirmación. Seleccione **[!UICONTROL Enable]** para confirmar su elección.
...
Si selecciona **[!UICONTROL Delete]**, aparecerá el cuadro de diálogo de confirmación [!UICONTROL Delete dataset]. Seleccione **[!UICONTROL Delete]** para confirmar su elección.

>[!NOTE]
>
>No puede eliminar conjuntos de datos del sistema.

También puede eliminar un conjunto de datos o agregar uno para utilizarlo con el Perfil del cliente en tiempo real desde las acciones en línea encontradas en la pestaña [!UICONTROL Browse]. Consulte la [sección de acciones en línea](#inline-actions) para obtener más información.
...
En la ficha [!UICONTROL Browse], seleccione los puntos suspensivos (...) junto al nombre del conjunto de datos y elija [!UICONTROL Preview dataset]. Si el conjunto de datos está vacío, la opción de previsualización está desactivada. En la pantalla **[!UICONTROL Dataset activity]**, también puede seleccionar **[!UICONTROL Preview dataset]** cerca de la esquina superior derecha de la pantalla.
...
Como alternativa, en la pantalla **[!UICONTROL Dataset activity]**, seleccione **[!UICONTROL Preview dataset]** para abrir la ventana de vista previa y revisar una muestra de la estructura y los valores del conjunto de datos.

![El botón Vista previa del conjunto de datos está resaltado.](../images/datasets/user-guide/select-preview.png)

La ventana de vista previa del conjunto de datos proporciona una forma rápida de explorar y validar la estructura y los datos del conjunto de datos.
...
>[!AVAILABILITY]
>
>El acceso a [!UICONTROL Advanced Query Editor] está limitado a las organizaciones con una licencia de SKU de Data Distiller. Si su organización no tiene la licencia necesaria, esta opción no aparece en la ventana de vista previa del conjunto de datos.

Seleccione [!UICONTROL Advanced Query Editor] en la parte superior derecha de la ventana de vista previa para abrir el servicio de consultas con la consulta SQL actual precargada y ejecutada. Puede seguir analizando o modificando SQL sin volver a introducir la consulta.
...
Puede administrar las etiquetas de control de datos de un conjunto de datos seleccionando las opciones en línea de la pestaña [!UICONTROL Browse]. Seleccione los puntos suspensivos (...) junto al nombre del conjunto de datos que desea administrar, seguido de **[!UICONTROL Manage data and access labels]** en el menú desplegable.
...
Puede habilitar un conjunto de datos para el perfil desde las opciones en línea de la ficha [!UICONTROL Browse] y también desde la vista [!UICONTROL Dataset activity]. En la ficha [!UICONTROL Browse] del área de trabajo [!UICONTROL Datasets], seleccione los puntos suspensivos de un conjunto de datos que desee habilitar para el perfil. Aparecerá una lista de opciones de menú. A continuación, seleccione **[!UICONTROL Enable unified profile]** de la lista de opciones disponibles.
...
Como alternativa, en la pantalla **[!UICONTROL Dataset activity]** del conjunto de datos, seleccione la opción **[!UICONTROL Profile]** dentro de la columna **[!UICONTROL Properties]**. Una vez habilitados, los datos que se incorporen al conjunto de datos también se utilizarán para rellenar perfiles de clientes.
...
Añada etiquetas personalizadas creadas para organizar conjuntos de datos y mejorar las capacidades de búsqueda, filtrado y ordenación. En la ficha [!UICONTROL Browse] del área de trabajo [!UICONTROL Datasets], seleccione los puntos suspensivos de un conjunto de datos que desee administrar, seguidos de **[!UICONTROL Manage tags]** en el menú desplegable.
...
Aparecerá el cuadro de diálogo [!UICONTROL Manage tags]. Escriba una breve descripción para crear una etiqueta personalizada o elija una etiqueta preexistente para etiquetar el conjunto de datos. Seleccione **[!UICONTROL Save]** para confirmar la configuración.
...
Administre la configuración de caducidad y retención del conjunto de datos mediante el menú de acciones en línea de la pestaña [!UICONTROL Browse] del área de trabajo [!UICONTROL Datasets]. Puede utilizar esta función para configurar cuánto tiempo se retienen los datos en el lago de datos y en el almacén de perfiles. La fecha de caducidad se basa en el momento en que se incorporaron los datos en Experience Platform y en el periodo de retención configurado.

>[!IMPORTANT]
>
>Para aplicar o actualizar reglas de retención para un conjunto de datos de ExperienceEvent, la función de usuario debe incluir el permiso **[!UICONTROL Manage datasets]**. Este control de acceso basado en funciones garantiza que solo los usuarios autorizados puedan modificar la configuración de retención del conjunto de datos.
>
...
Para configurar el período de retención, seleccione los puntos suspensivos junto al conjunto de datos seguido de **[!UICONTROL Set data retention policy]** en el menú desplegable.
...
Para abrir una previsión visual del impacto del almacenamiento de distintas directivas de retención, seleccione **[!UICONTROL View Experience Event Data distribution]**.
...
Cuando esté satisfecho con la configuración, seleccione **[!UICONTROL Save]** para confirmar la configuración.
...
|---|---|
| [!UICONTROL Data Lake Retention] | El período de retención actual para cada conjunto de datos en el lago de datos. Este valor es configurable y determina cuánto tiempo se retienen los datos antes de la eliminación. |
| [!UICONTROL Data Lake Storage] | El uso de almacenamiento actual para cada conjunto de datos en el lago de datos. Utilice esta métrica para administrar los límites de almacenamiento y optimizar el uso. |
| [!UICONTROL Profile Storage] | El uso de almacenamiento actual para cada conjunto de datos dentro del servicio de perfil. Ayuda a monitorizar el consumo de almacenamiento y admite las decisiones de administración de datos. |
| [!UICONTROL Profile Retention] | Período de retención actual para conjuntos de datos de perfil. Puede actualizar este valor para controlar cuánto tiempo se retienen los datos de perfil. |
...
Puede colocar conjuntos de datos en carpetas para administrar mejor los conjuntos de datos. Para mover un conjunto de datos a una carpeta, seleccione los puntos suspensivos (...) junto al nombre del conjunto de datos que desea administrar, seguido de **[!UICONTROL Move to folder]** en el menú desplegable.
...
>
>![Se resaltó el cuadro de diálogo del conjunto de datos [!UICONTROL Move] con el icono de crear carpeta.](/help/catalog/images/datasets/user-guide/create-folder.png)
...
![Paneles de [!UICONTROL Datasets] con la estructura de carpetas de conjuntos de datos mostrada, el icono de mostrar carpetas y una carpeta seleccionada resaltada.](../images/datasets/user-guide/folder-structure.png)

### Eliminar un conjunto de datos {#delete}

Puede eliminar un conjunto de datos de las acciones en línea del conjunto de datos en la pestaña [!UICONTROL Browse] o en la parte superior derecha de la vista [!UICONTROL Dataset activity]. En la vista [!UICONTROL Browse], seleccione los puntos suspensivos (...) junto al nombre del conjunto de datos que desea eliminar. Aparecerá una lista de opciones de menú. A continuación, seleccione **[!UICONTROL Delete]** en el menú desplegable.
...
Aparecerá un cuadro de diálogo de confirmación. Seleccione **[!UICONTROL Delete]** para confirmar.

Como alternativa, seleccione **[!UICONTROL Delete dataset]** de la pantalla **[!UICONTROL Dataset activity]**.
...
Aparecerá un cuadro de confirmación. Seleccione **[!UICONTROL Delete]** para confirmar la eliminación del conjunto de datos.
...
Para buscar o filtrar la lista de conjuntos de datos disponibles, seleccione el icono de filtro (![El icono de filtro.](/help/images/icons/filter.png)) en la parte superior izquierda del área de trabajo. Aparecerá un conjunto de opciones de filtro en el carril izquierdo. Existen varios métodos para filtrar los conjuntos de datos disponibles. Estos incluyen: [[!UICONTROL Show System Datasets]](#show-system-datasets), [[!UICONTROL Included in profile]](#filter-profile-enabled-datasets), [[!UICONTROL Tags]](#filter-by-tag), [[!UICONTROL Creation date]](#filter-by-creation-date), [[!UICONTROL Modified date], [!UICONTROL Created by]](#filter-by-creation-date) y [[!UICONTROL Schema]](#filter-by-schema).
...
De forma predeterminada, solo se muestran los conjuntos de datos en los que ha introducido datos. Si desea ver los conjuntos de datos generados por el sistema, active la casilla de verificación **[!UICONTROL Yes]** en la sección [!UICONTROL Show system datasets]. Los conjuntos de datos generados por el sistema solo se utilizan para procesar otros componentes. Por ejemplo, el conjunto de datos de exportación de perfiles generado por el sistema se utiliza para procesar el panel de perfiles.
...
Escriba su nombre de etiqueta personalizado en la entrada [!UICONTROL Tags] y, a continuación, seleccione su etiqueta de la lista de opciones disponibles para buscar y filtrar conjuntos de datos que correspondan a esa etiqueta.

![Las opciones de filtro del área de trabajo Conjuntos de datos con el icono de entrada y filtro [!UICONTROL Tags] resaltado.](../images/datasets/user-guide/filter-tags.png)

### Filtrar conjuntos de datos por fecha de creación {#filter-by-creation-date}

Los conjuntos de datos se pueden filtrar por fecha de creación durante un período de tiempo personalizado. Esto se puede utilizar para excluir datos históricos o para generar perspectivas e informes de datos cronológicos específicos. Elija un [!UICONTROL Start date] y un [!UICONTROL End date] seleccionando el icono de calendario para cada campo. Después de lo cual, solo los conjuntos de datos que se ajusten a ese criterio aparecerán en la pestaña Examinar.

### Filtrar conjuntos de datos por fecha de modificación {#filter-by-modified-date}

De forma similar al filtro para la fecha de creación, puede filtrar los conjuntos de datos en función de la fecha en la que se modificaron por última vez. En la sección [!UICONTROL Modified date], seleccione un [!UICONTROL Start date] y un [!UICONTROL End date] seleccionando el icono de calendario para cada campo. Después de lo cual, solo los conjuntos de datos modificados durante ese período aparecerán en la pestaña Examinar.
...
En la pantalla **[!UICONTROL Create dataset]**, seleccione **[!UICONTROL Create dataset from schema]** para crear un nuevo conjunto de datos vacío.
...
Aparecerá el paso **[!UICONTROL Select schema]**. Examine la lista de esquemas y seleccione el esquema al que se adherirá el conjunto de datos antes de seleccionar **[!UICONTROL Next]**.
...
Aparecerá el paso **[!UICONTROL Configure dataset]**. Proporcione al conjunto de datos un nombre y una descripción opcional, luego seleccione **[!UICONTROL Finish]** para crear el conjunto de datos.
...
Cuando se crea un conjunto de datos con un archivo CSV, se crea un esquema ad hoc para proporcionar al conjunto de datos una estructura que coincida con el archivo CSV proporcionado. En la pantalla **[!UICONTROL Create dataset]**, seleccione **[!UICONTROL Create dataset from CSV file]**.
...
Aparecerá el paso **[!UICONTROL Configure]**. Proporcione al conjunto de datos un nombre y una descripción opcional, y luego seleccione **[!UICONTROL Next]**.
...
Aparecerá el paso **[!UICONTROL Add data]**. Cargue el archivo CSV arrastrándolo y soltándolo en el centro de la pantalla, o seleccione **[!UICONTROL Browse]** para explorar el directorio de archivos. El archivo puede tener un tamaño de hasta diez gigabytes. Una vez cargado el archivo CSV, seleccione **[!UICONTROL Save]** para crear el conjunto de datos.
...
Puede seleccionar un(a) **[!UICONTROL Batch ID]** individual(a) para acceder al tablero **[!UICONTROL Batch overview]** y ver los detalles del lote, incluidos los registros de errores en caso de que el lote no se pueda ingerir.
...
Si desea eliminar el lote, seleccione **[!UICONTROL Delete batch]** cerca de la parte superior derecha del tablero. Al eliminar un lote también se eliminan sus registros del conjunto de datos en el que se ingirió originalmente el lote.
