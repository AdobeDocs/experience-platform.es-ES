...
![Adobe Experience Cloud resalta el producto Permisos.](assets/permissions/permissions-product.png)
...
![Imagen que muestra la tarjeta de producto de recopilación de datos en Admin Console](assets/permissions/platform-permission-card.png)
...
![Imagen que muestra la tarjeta de producto de recopilación de datos en Admin Console](assets/permissions/data-collection-card.png)

#### Seleccione o cree un perfil de producto

La siguiente pantalla muestra una lista de perfiles de producto disponibles para la recopilación de datos en su organización, siendo el perfil predeterminado **[!DNL Default Data Collection All Access]**. Puede elegir editar el perfil de producto predeterminado si lo desea, o bien seleccionar **[!UICONTROL New Profile]** para crear uno. Si tiene varias funciones o grupos de usuarios en su organización que requieren diferentes niveles de acceso, debe crear un perfil de producto independiente para cada uno de ellos.

![Imagen que muestra los perfiles de producto para la recopilación de datos en Admin Console](assets/permissions/new-profile.png)

Después de seleccionar o crear un perfil de producto, puede usar los iconos de **[!UICONTROL Edit]** para iniciar [permisos de edición](#edit-permissions) para el perfil, o bien seleccionar la pestaña **[!UICONTROL Users]** para iniciar [la asignación de usuarios](#assign-users) al perfil.

![Imagen que muestra la pestaña de permisos de un Admin Console de perfil de producto](assets/permissions/edit-permission-categories.png)
...
![Imagen que muestra los permisos agregados en la columna incluida](assets/permissions/added-permissions.png)
...
![Imagen que muestra la sección de derechos de compañía en permisos](assets/permissions/switch-category.png)

Seleccione **[!UICONTROL Save]** una vez que haya terminado de configurar los permisos.

![Imagen que muestra la configuración de permisos que se está guardando para el perfil del producto](assets/permissions/save-permissions.png)

La vista de perfil de producto vuelve a aparecer con los permisos añadidos reflejados.

![Imagen que muestra los permisos añadidos para el perfil del producto](assets/permissions/permissions-added.png)
...
![Imagen que muestra la pestaña de usuarios de un perfil de producto en Admin Console](assets/permissions/manage-users.png)
