...
Los permisos bajo Adobe Experience Platform incluyen acceso a flujos de datos, identidades, esquemas y entornos aislados. Para conocer los pasos sobre cómo configurar los permisos de Adobe Experience Platform, consulte la [control de acceso guía usuario](../access-control/ui/overview.md).
...
| Identity Management | Administrar espacios de nombres de identidad | Concede la capacidad de vista, crear y editar [espacios](../identity-service/features/namespaces.md) de nombres de identidad. |
| Identity Management | Ver áreas de nombres de identidad | Otorga acceso de solo lectura a las áreas de nombres de identidad. |
| Recopilación de datos | Administrar flujos de datos | Concede la capacidad de vista, crear y editar [flujos](../datastreams/overview.md) de datos. |
...
| Derechos de propiedad | Editar propiedad | Concede la posibilidad de editar la configuración básica de las propiedades a las que tiene acceso un usuario. |
| Derechos de propiedad | Administrar entornos | Concede la capacidad de administrar los [entornos](../tags/ui/publishing/environments.md) de las propiedades a las que una usuario tiene acceso. |
| Derechos de propiedad | Administrar extensiones | Concede la capacidad de administrar las [extensiones](../tags/ui/managing-resources/extensions/overview.md) para las propiedades a las que un usuario tiene acceso. |
| Derechos de propiedad | Publicación | Concede la capacidad de publicar una versión de biblioteca como parte del [flujo](../tags/ui/publishing/publishing-flow.md) de publicación. |
...
Consulte las subsecciones siguientes para conocer los pasos sobre cómo administrar los permisos correspondientes en cada producto en Admin Console:

* [Adobe Experience Platform permisos](#manage-platform)
* [Adobe Experience Platform permisos de recopilación de datos](#manage-collection)
...
La sección **[!UICONTROL Permissions]** de Experience Cloud le permite definir roles de usuario y directivas para administrar el acceso a funciones y objetos dentro de una aplicación de producto.

A través de [!UICONTROL Permissions], puede crear y administrar roles y asignar los permisos de recursos deseados para estos roles.

![Adobe Experience Cloud resalta el producto Permisos.](./images/permissions/permissions-product.png)

Para tener acceso a las características de recopilación de datos, debe habilitar todos los permisos en las categorías **[!UICONTROL Sandboxes]**, **[!UICONTROL Data Modeling]**, **[!UICONTROL Identity Management]** y **[!UICONTROL Data Collection]**.
...
Para administrar estos permisos, inicie sesión en Admin Console, seleccione **[!UICONTROL Products]** en la barra de navegación superior y, a continuación, seleccione **[!UICONTROL Adobe Experience Platform Data Collection]**.
...
La siguiente pantalla muestra una lista de perfiles de producto disponibles para la recopilación de datos en su organización, siendo la perfil **[!DNL Default Data Collection All Access]** predeterminada . Si lo desea, puede elegir editar el perfil de producto predeterminado o puede seleccionar **[!UICONTROL New Profile]** crear uno. Si tiene varias funciones o grupos de usuarios en su organización que requieren diferentes niveles de acceso, debe crear un perfil de producto independiente para cada uno de ellos.

![Imagen muestra los perfiles de producto para la Recopilación de datos en Admin Console](./images/permissions/new-profile.png)

Después de seleccionar o crear un perfil de producto, puede usar los **[!UICONTROL Edit]** iconos para inicio [permisos](#edit-permissions) de edición para el perfil, o seleccionar el **[!UICONTROL Users]** pestaña para inicio [asignar usuarios](#assign-users) al perfil.
...
![Imagen que muestra la sección Derechos de compañía en Permisos](./images/permissions/switch-category.png)

Seleccione **[!UICONTROL Save]** una vez que haya terminado de configurar los permisos.
...
Para asignar usuarios al perfil de producto (y concederles los permisos configurados del perfil), seleccione la ficha **[!UICONTROL Users]**, seguida de **[!UICONTROL Add user]**.
