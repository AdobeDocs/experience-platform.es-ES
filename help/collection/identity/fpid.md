...
| Visita | Descripción |
| --- | --- |
| Primera visita | Supongamos que aún no ha empezado a configurar la cookie FPID. El ECID contenido en la [cookie AMCV](https://experienceleague.adobe.com/docs/id-service/using/intro/cookies.html?lang=es#section-c55af54828dc4cce89f6118655d694c8) es el identificador usado para identificar al visitante. |
