...
Platform Web SDK y Platform Mobile SDK contraen y comprimen todas las bibliotecas de productos de Adobe en un único kit de desarrollo para plataformas web y móviles, respectivamente. Pueden implementarse con código sin procesar o con [tags](../tags/home.md) a través de la IU de recopilación de datos o la IU de Adobe Experience Platform.
