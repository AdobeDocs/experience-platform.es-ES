...
| `xdm.eventType` | Objeto | No | El tipo de evento de medios. Si no se proporciona, este campo se establece automáticamente en `media.sessionStart`. |
| `xdm.mediaCollection.sessionDetails` | Objeto | Sí | Contiene propiedades de detalles de la sesión. Consulte [Esquema de recopilación de medios](/help/xdm/data-types/media-collection-details.md) para obtener más información. |
...
| `xdm.mediaCollection.qoeDataDetails` | Objeto | No | La calidad de los detalles de los datos de experiencia. Consulte la documentación del [esquema de recopilación de medios](/help/xdm/data-types/media-collection-details.md) para obtener más información. |

## Creación de una sesión de medios con la extensión de etiquetas Web SDK

La extensión de etiquetas Web SDK equivalente a este comando es el tipo de evento [**[!UICONTROL Session start]**](/help/tags/extensions/client/web-sdk/actions/send-media-event.md#session-start) dentro de la acción &#39;[!UICONTROL Send media event]&#39;.
