...
| `StreamType` | Tipo de emisión | `VOD`, `Live`, `Linear`, `Podcast`, `Audiobook`, `AOD` |
...
## Obtener el rastreador de Media Analytics mediante la extensión de etiquetas de Web SDK

La extensión de etiquetas Web SDK equivalente a este comando es la acción [**[!UICONTROL Get Media Analytics tracker]**](/help/tags/extensions/client/web-sdk/actions/get-media-analytics-tracker.md).
