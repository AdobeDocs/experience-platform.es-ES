...
| Zona horaria de IANA | La zona horaria IANA del usuario final. Incluido en la versión de biblioteca 2.32.0 o superior. | `xdm.placeContext.ianaTimezone` | `America/Denver` |
