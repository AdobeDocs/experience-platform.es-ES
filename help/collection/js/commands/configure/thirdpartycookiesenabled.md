...
La propiedad `thirdPartyCookiesEnabled` también controla si se puede solicitar un [`CORE ID`](/help/collection/identity/overview.md#core-id-and-third-party-identity) en las llamadas a [`getIdentity`](../getidentity.md).
