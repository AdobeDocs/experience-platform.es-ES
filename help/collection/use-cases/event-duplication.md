...
Para la recopilación de datos en tiempo real, [los eventos de experiencia](/help/xdm/classes/experienceevent.md) se recopilan mediante Edge Network, a partir de fuentes del lado del cliente, como Web SDK o [SDK móvil](https://developer.adobe.com/client-sdks/home/), y se entregan a las capas de procesamiento y almacenamiento de Experience Platform. Estas capas componen soluciones como Experience Platform, [Real-Time CDP](/help/rtcdp/home.md), [Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-overview.html?lang=es) y [Adobe Journey Optimizer](https://experienceleague.adobe.com/docs/journey-optimizer/using/ajo-home.html?lang=es).
...
* El almacén de perfiles de Real-Time CDP descarta eventos si ya existe un evento con el mismo `_id` en [!DNL Profile store]. Consulte la documentación de [XDM ExperienceEvent class](/help/xdm/classes/experienceevent.md) para obtener más información.
