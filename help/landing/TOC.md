...
* [Documentación técnica para empresas de varias regiones y marcas](./multi-region-multi-brand-whitepaper.md)
...
* Uso de licencias y protecciones {#license}
   ...
   * [Panel de control de uso de licencias](./license-usage-and-guardrails/license-usage-dashboard.md)
