...
title: Guía de la interfaz de usuario de Adobe Experience Platform
topic: ui guide
...
El último elemento de la barra de navegación superior es la configuración **del** usuario, que se representa mediante el icono de configuración del ![usuario/Perfil](images/user-guide/profile-icon.png) del usuario. Seleccione este icono para editar sus preferencias o cerrar sesión.
...
La sección **[!UICONTROL Flujos de trabajo]** muestra una lista de flujos de trabajo de varios pasos para realizar operaciones dentro de la plataforma.
